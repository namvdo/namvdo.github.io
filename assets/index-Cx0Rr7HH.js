 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var __;function hy(){return __||(__=1,(function(o){function t(z,nt){var K=z.length;z.push(nt);t:for(;0<K;){var Tt=K-1>>>1,O=z[Tt];if(0<l(O,nt))z[Tt]=nt,z[K]=O,K=Tt;else break t}}function i(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var nt=z[0],K=z.pop();if(K!==nt){z[0]=K;t:for(var Tt=0,O=z.length,at=O>>>1;Tt<at;){var Et=2*(Tt+1)-1,At=z[Et],It=Et+1,Wt=z[It];if(0>l(At,K))It<O&&0>l(Wt,At)?(z[Tt]=Wt,z[It]=K,Tt=It):(z[Tt]=At,z[Et]=K,Tt=Et);else if(It<O&&0>l(Wt,K))z[Tt]=Wt,z[It]=K,Tt=It;else break t}}return nt}function l(z,nt){var K=z.sortIndex-nt.sortIndex;return K!==0?K:z.id-nt.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var d=Date,h=d.now();o.unstable_now=function(){return d.now()-h}}var g=[],p=[],v=1,x=null,y=3,_=!1,A=!1,E=!1,b=!1,m=typeof setTimeout=="function"?setTimeout:null,I=typeof clearTimeout=="function"?clearTimeout:null,B=typeof setImmediate<"u"?setImmediate:null;function N(z){for(var nt=i(p);nt!==null;){if(nt.callback===null)r(p);else if(nt.startTime<=z)r(p),nt.sortIndex=nt.expirationTime,t(g,nt);else break;nt=i(p)}}function D(z){if(E=!1,N(z),!A)if(i(g)!==null)A=!0,V||(V=!0,ct());else{var nt=i(p);nt!==null&&lt(D,nt.startTime-z)}}var V=!1,F=-1,$=5,w=-1;function L(){return b?!0:!(o.unstable_now()-w<$)}function q(){if(b=!1,V){var z=o.unstable_now();w=z;var nt=!0;try{t:{A=!1,E&&(E=!1,I(F),F=-1),_=!0;var K=y;try{e:{for(N(z),x=i(g);x!==null&&!(x.expirationTime>z&&L());){var Tt=x.callback;if(typeof Tt=="function"){x.callback=null,y=x.priorityLevel;var O=Tt(x.expirationTime<=z);if(z=o.unstable_now(),typeof O=="function"){x.callback=O,N(z),nt=!0;break e}x===i(g)&&r(g),N(z)}else r(g);x=i(g)}if(x!==null)nt=!0;else{var at=i(p);at!==null&&lt(D,at.startTime-z),nt=!1}}break t}finally{x=null,y=K,_=!1}nt=void 0}}finally{nt?ct():V=!1}}}var ct;if(typeof B=="function")ct=function(){B(q)};else if(typeof MessageChannel<"u"){var mt=new MessageChannel,vt=mt.port2;mt.port1.onmessage=q,ct=function(){vt.postMessage(null)}}else ct=function(){m(q,0)};function lt(z,nt){F=m(function(){z(o.unstable_now())},nt)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(z){z.callback=null},o.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<z?Math.floor(1e3/z):5},o.unstable_getCurrentPriorityLevel=function(){return y},o.unstable_next=function(z){switch(y){case 1:case 2:case 3:var nt=3;break;default:nt=y}var K=y;y=nt;try{return z()}finally{y=K}},o.unstable_requestPaint=function(){b=!0},o.unstable_runWithPriority=function(z,nt){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var K=y;y=z;try{return nt()}finally{y=K}},o.unstable_scheduleCallback=function(z,nt,K){var Tt=o.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?Tt+K:Tt):K=Tt,z){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=K+O,z={id:v++,callback:nt,priorityLevel:z,startTime:K,expirationTime:O,sortIndex:-1},K>Tt?(z.sortIndex=K,t(p,z),i(g)===null&&z===i(p)&&(E?(I(F),F=-1):E=!0,lt(D,K-Tt))):(z.sortIndex=O,t(g,z),A||_||(A=!0,V||(V=!0,ct()))),z},o.unstable_shouldYield=L,o.unstable_wrapCallback=function(z){var nt=y;return function(){var K=y;y=nt;try{return z.apply(this,arguments)}finally{y=K}}}})(nd)),nd}var v_;function py(){return v_||(v_=1,ed.exports=hy()),ed.exports}var id={exports:{}},Dn={};/**
 * @license React
...
`)+`
`+m);const B=I+b+d,N=I+m+h,D=v0(l,l.VERTEX_SHADER,B),V=v0(l,l.FRAGMENT_SHADER,N);l.attachShader(E,D),l.attachShader(E,V),i.index0AttributeName!==void 0?l.bindAttribLocation(E,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(E,0,"position"),l.linkProgram(E);function F(q){if(o.debug.checkShaderErrors){const ct=l.getProgramInfoLog(E)||"",mt=l.getShaderInfoLog(D)||"",vt=l.getShaderInfoLog(V)||"",lt=ct.trim(),z=mt.trim(),nt=vt.trim();let K=!0,Tt=!0;if(l.getProgramParameter(E,l.LINK_STATUS)===!1)if(K=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,E,D,V);else{const O=y0(l,D,"vertex"),at=y0(l,V,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(E,l.VALIDATE_STATUS)+`
