 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var m_;function dy(){if(m_)return pe;m_=1;var o=Symbol.for("react.transitional.element"),t=Symbol.for("react.portal"),i=Symbol.for("react.fragment"),r=Symbol.for("react.strict_mode"),l=Symbol.for("react.profiler"),u=Symbol.for("react.consumer"),d=Symbol.for("react.context"),h=Symbol.for("react.forward_ref"),m=Symbol.for("react.suspense"),p=Symbol.for("react.memo"),_=Symbol.for("react.lazy"),x=Symbol.iterator;function y(O){return O===null||typeof O!="object"?null:(O=x&&O[x]||O["@@iterator"],typeof O=="function"?O:null)}var v={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},T=Object.assign,b={};function M(O,rt,Tt){this.props=O,this.context=rt,this.refs=b,this.updater=Tt||v}M.prototype.isReactComponent={},M.prototype.setState=function(O,rt){if(typeof O!="object"&&typeof O!="function"&&O!=null)throw Error("takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,O,rt,"setState")},M.prototype.forceUpdate=function(O){this.updater.enqueueForceUpdate(this,O,"forceUpdate")};function g(){}g.prototype=M.prototype;function z(O,rt,Tt){this.props=O,this.context=rt,this.refs=b,this.updater=Tt||v}var P=z.prototype=new g;P.constructor=z,T(P,M.prototype),P.isPureReactComponent=!0;var L=Array.isArray,w={H:null,A:null,T:null,S:null,V:null},H=Object.prototype.hasOwnProperty;function B(O,rt,Tt,Ct,zt,qt){return Tt=qt.ref,{$$typeof:o,type:O,key:rt,ref:Tt!==void 0?Tt:null,props:qt}}function J(O,rt){return B(O.type,rt,void 0,void 0,void 0,O.props)}function D(O){return typeof O=="object"&&O!==null&&O.$$typeof===o}function U(O){var rt={"=":"=0",":":"=2"};return"$"+O.replace(/[=:]/g,function(Tt){return rt[Tt]})}var X=/\/+/g;function ot(O,rt){return typeof O=="object"&&O!==null&&O.key!=null?U(""+O.key):rt.toString(36)}function mt(){}function ct(O){switch(O.status){case"fulfilled":return O.value;case"rejected":throw O.reason;default:switch(typeof O.status=="string"?O.then(mt,mt):(O.status="pending",O.then(function(rt){O.status==="pending"&&(O.status="fulfilled",O.value=rt)},function(rt){O.status==="pending"&&(O.status="rejected",O.reason=rt)})),O.status){case"fulfilled":return O.value;case"rejected":throw O.reason}}throw O}function gt(O,rt,Tt,Ct,zt){var qt=typeof O;(qt==="undefined"||qt==="boolean")&&(O=null);var st=!1;if(O===null)st=!0;else switch(qt){case"bigint":case"string":case"number":st=!0;break;case"object":switch(O.$$typeof){case o:case t:st=!0;break;case _:return st=O._init,gt(st(O._payload),rt,Tt,Ct,zt)}}if(st)return zt=zt(O),st=Ct===""?"."+ot(O,0):Ct,L(zt)?(Tt="",st!=null&&(Tt=st.replace(X,"$&/")+"/"),gt(zt,rt,Tt,"",function(ne){return ne})):zt!=null&&(D(zt)&&(zt=J(zt,Tt+(zt.key==null||O&&O.key===zt.key?"":(""+zt.key).replace(X,"$&/")+"/")+st)),rt.push(zt)),1;st=0;var St=Ct===""?".":Ct+":";if(L(O))for(var Ot=0;Ot<O.length;Ot++)Ct=O[Ot],qt=St+ot(Ct,Ot),st+=gt(Ct,rt,Tt,qt,zt);else if(Ot=y(O),typeof Ot=="function")for(O=Ot.call(O),Ot=0;!(Ct=O.next()).done;)Ct=Ct.value,qt=St+ot(Ct,Ot++),st+=gt(Ct,rt,Tt,qt,zt);else if(qt==="object"){if(typeof O.then=="function")return gt(ct(O),rt,Tt,Ct,zt);throw rt=String(O),Error("Objects are not valid as a React child (found: "+(rt==="[object Object]"?"object with keys {"+Object.keys(O).join(", ")+"}":rt)+"). If you meant to render a collection of children, use an array instead.")}return st}function I(O,rt,Tt){if(O==null)return O;var Ct=[],zt=0;return gt(O,Ct,"","",function(qt){return rt.call(Tt,qt,zt++)}),Ct}function it(O){if(O._status===-1){var rt=O._result;rt=rt(),rt.then(function(Tt){(O._status===0||O._status===-1)&&(O._status=1,O._result=Tt)},function(Tt){(O._status===0||O._status===-1)&&(O._status=2,O._result=Tt)}),O._status===-1&&(O._status=0,O._result=rt)}if(O._status===1)return O._result.default;throw O._result}var K=typeof reportError=="function"?reportError:function(O){if(typeof window=="object"&&typeof window.ErrorEvent=="function"){var rt=new window.ErrorEvent("error",{bubbles:!0,cancelable:!0,message:typeof O=="object"&&O!==null&&typeof O.message=="string"?String(O.message):String(O),error:O});if(!window.dispatchEvent(rt))return}else if(typeof process=="object"&&typeof process.emit=="function"){process.emit("uncaughtException",O);return}console.error(O)};function bt(){}return pe.Children={map:I,forEach:function(O,rt,Tt){I(O,function(){rt.apply(this,arguments)},Tt)},count:function(O){var rt=0;return I(O,function(){rt++}),rt},toArray:function(O){return I(O,function(rt){return rt})||[]},only:function(O){if(!D(O))throw Error("React.Children.only expected to receive a single React element child.");return O}},pe.Component=M,pe.Fragment=i,pe.Profiler=l,pe.PureComponent=z,pe.StrictMode=r,pe.Suspense=m,pe.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE=w,pe.__COMPILER_RUNTIME={__proto__:null,c:function(O){return w.H.useMemoCache(O)}},pe.cache=function(O){return function(){return O.apply(null,arguments)}},pe.cloneElement=function(O,rt,Tt){if(O==null)throw Error("The argument must be a React element, but you passed "+O+".");var Ct=T({},O.props),zt=O.key,qt=void 0;if(rt!=null)for(st in rt.ref!==void 0&&(qt=void 0),rt.key!==void 0&&(zt=""+rt.key),rt)!H.call(rt,st)||st==="key"||st==="__self"||st==="__source"||st==="ref"&&rt.ref===void 0||(Ct[st]=rt[st]);var st=arguments.length-2;if(st===1)Ct.children=Tt;else if(1<st){for(var St=Array(st),Ot=0;Ot<st;Ot++)St[Ot]=arguments[Ot+2];Ct.children=St}return B(O.type,zt,void 0,void 0,qt,Ct)},pe.createContext=function(O){return O={$$typeof:d,_currentValue:O,_currentValue2:O,_threadCount:0,Provider:null,Consumer:null},O.Provider=O,O.Consumer={$$typeof:u,_context:O},O},pe.createElement=function(O,rt,Tt){var Ct,zt={},qt=null;if(rt!=null)for(Ct in rt.key!==void 0&&(qt=""+rt.key),rt)H.call(rt,Ct)&&Ct!=="key"&&Ct!=="__self"&&Ct!=="__source"&&(zt[Ct]=rt[Ct]);var st=arguments.length-2;if(st===1)zt.children=Tt;else if(1<st){for(var St=Array(st),Ot=0;Ot<st;Ot++)St[Ot]=arguments[Ot+2];zt.children=St}if(O&&O.defaultProps)for(Ct in st=O.defaultProps,st)zt[Ct]===void 0&&(zt[Ct]=st[Ct]);return B(O,qt,void 0,void 0,null,zt)},pe.createRef=function(){return{current:null}},pe.forwardRef=function(O){return{$$typeof:h,render:O}},pe.isValidElement=D,pe.lazy=function(O){return{$$typeof:_,_payload:{_status:-1,_result:O},_init:it}},pe.memo=function(O,rt){return{$$typeof:p,type:O,compare:rt===void 0?null:rt}},pe.startTransition=function(O){var rt=w.T,Tt={};w.T=Tt;try{var Ct=O(),zt=w.S;zt!==null&&zt(Tt,Ct),typeof Ct=="object"&&Ct!==null&&typeof Ct.then=="function"&&Ct.then(bt,K)}catch(qt){K(qt)}finally{w.T=rt}},pe.unstable_useCacheRefresh=function(){return w.H.useCacheRefresh()},pe.use=function(O){return w.H.use(O)},pe.useActionState=function(O,rt,Tt){return w.H.useActionState(O,rt,Tt)},pe.useCallback=function(O,rt){return w.H.useCallback(O,rt)},pe.useContext=function(O){return w.H.useContext(O)},pe.useDebugValue=function(){},pe.useDeferredValue=function(O,rt){return w.H.useDeferredValue(O,rt)},pe.useEffect=function(O,rt,Tt){var Ct=w.H;if(typeof Tt=="function")throw Error("useEffect CRUD overload is not enabled in this build of React.");return Ct.useEffect(O,rt)},pe.useId=function(){return w.H.useId()},pe.useImperativeHandle=function(O,rt,Tt){return w.H.useImperativeHandle(O,rt,Tt)},pe.useInsertionEffect=function(O,rt){return w.H.useInsertionEffect(O,rt)},pe.useLayoutEffect=function(O,rt){return w.H.useLayoutEffect(O,rt)},pe.useMemo=function(O,rt){return w.H.useMemo(O,rt)},pe.useOptimistic=function(O,rt){return w.H.useOptimistic(O,rt)},pe.useReducer=function(O,rt,Tt){return w.H.useReducer(O,rt,Tt)},pe.useRef=function(O){return w.H.useRef(O)},pe.useState=function(O){return w.H.useState(O)},pe.useSyncExternalStore=function(O,rt,Tt){return w.H.useSyncExternalStore(O,rt,Tt)},pe.useTransition=function(){return w.H.useTransition()},pe.version="19.1.1",pe}var g_;function Ch(){return g_||(g_=1,$f.exports=dy()),$f.exports}var ee=Ch(),td={exports:{}},Lo={},ed={exports:{}},nd={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var __;function hy(){return __||(__=1,(function(o){function t(I,it){var K=I.length;I.push(it);t:for(;0<K;){var bt=K-1>>>1,O=I[bt];if(0<l(O,it))I[bt]=it,I[K]=O,K=bt;else break t}}function i(I){return I.length===0?null:I[0]}function r(I){if(I.length===0)return null;var it=I[0],K=I.pop();if(K!==it){I[0]=K;t:for(var bt=0,O=I.length,rt=O>>>1;bt<rt;){var Tt=2*(bt+1)-1,Ct=I[Tt],zt=Tt+1,qt=I[zt];if(0>l(Ct,K))zt<O&&0>l(qt,Ct)?(I[bt]=qt,I[zt]=K,bt=zt):(I[bt]=Ct,I[Tt]=K,bt=Tt);else if(zt<O&&0>l(qt,K))I[bt]=qt,I[zt]=K,bt=zt;else break t}}return it}function l(I,it){var K=I.sortIndex-it.sortIndex;return K!==0?K:I.id-it.id}if(o.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var u=performance;o.unstable_now=function(){return u.now()}}else{var d=Date,h=d.now();o.unstable_now=function(){return d.now()-h}}var m=[],p=[],_=1,x=null,y=3,v=!1,T=!1,b=!1,M=!1,g=typeof setTimeout=="function"?setTimeout:null,z=typeof clearTimeout=="function"?clearTimeout:null,P=typeof setImmediate<"u"?setImmediate:null;function L(I){for(var it=i(p);it!==null;){if(it.callback===null)r(p);else if(it.startTime<=I)r(p),it.sortIndex=it.expirationTime,t(m,it);else break;it=i(p)}}function w(I){if(b=!1,L(I),!T)if(i(m)!==null)T=!0,H||(H=!0,ot());else{var it=i(p);it!==null&&gt(w,it.startTime-I)}}var H=!1,B=-1,J=5,D=-1;function U(){return M?!0:!(o.unstable_now()-D<J)}function X(){if(M=!1,H){var I=o.unstable_now();D=I;var it=!0;try{t:{T=!1,b&&(b=!1,z(B),B=-1),v=!0;var K=y;try{e:{for(L(I),x=i(m);x!==null&&!(x.expirationTime>I&&U());){var bt=x.callback;if(typeof bt=="function"){x.callback=null,y=x.priorityLevel;var O=bt(x.expirationTime<=I);if(I=o.unstable_now(),typeof O=="function"){x.callback=O,L(I),it=!0;break e}x===i(m)&&r(m),L(I)}else r(m);x=i(m)}if(x!==null)it=!0;else{var rt=i(p);rt!==null&&gt(w,rt.startTime-I),it=!1}}break t}finally{x=null,y=K,v=!1}it=void 0}}finally{it?ot():H=!1}}}var ot;if(typeof P=="function")ot=function(){P(X)};else if(typeof MessageChannel<"u"){var mt=new MessageChannel,ct=mt.port2;mt.port1.onmessage=X,ot=function(){ct.postMessage(null)}}else ot=function(){g(X,0)};function gt(I,it){B=g(function(){I(o.unstable_now())},it)}o.unstable_IdlePriority=5,o.unstable_ImmediatePriority=1,o.unstable_LowPriority=4,o.unstable_NormalPriority=3,o.unstable_Profiling=null,o.unstable_UserBlockingPriority=2,o.unstable_cancelCallback=function(I){I.callback=null},o.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):J=0<I?Math.floor(1e3/I):5},o.unstable_getCurrentPriorityLevel=function(){return y},o.unstable_next=function(I){switch(y){case 1:case 2:case 3:var it=3;break;default:it=y}var K=y;y=it;try{return I()}finally{y=K}},o.unstable_requestPaint=function(){M=!0},o.unstable_runWithPriority=function(I,it){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var K=y;y=I;try{return it()}finally{y=K}},o.unstable_scheduleCallback=function(I,it,K){var bt=o.unstable_now();switch(typeof K=="object"&&K!==null?(K=K.delay,K=typeof K=="number"&&0<K?bt+K:bt):K=bt,I){case 1:var O=-1;break;case 2:O=250;break;case 5:O=1073741823;break;case 4:O=1e4;break;default:O=5e3}return O=K+O,I={id:_++,callback:it,priorityLevel:I,startTime:K,expirationTime:O,sortIndex:-1},K>bt?(I.sortIndex=K,t(p,I),i(m)===null&&I===i(p)&&(b?(z(B),B=-1):b=!0,gt(w,K-bt))):(I.sortIndex=O,t(m,I),T||v||(T=!0,H||(H=!0,ot()))),I},o.unstable_shouldYield=U,o.unstable_wrapCallback=function(I){var it=y;return function(){var K=y;y=it;try{return I.apply(this,arguments)}finally{y=K}}}})(nd)),nd}var v_;function py(){return v_||(v_=1,ed.exports=hy()),ed.exports}var id={exports:{}},Cn={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var S_;function _y(){if(S_)return Lo;S_=1;var o=py(),t=Ch(),i=gy();function r(e){var n="https://react.dev/errors/"+e;if(1<arguments.length){n+="?args[]="+encodeURIComponent(arguments[1]);for(var a=2;a<arguments.length;a++)n+="&args[]="+encodeURIComponent(arguments[a])}return"Minified React error #"+e+"; visit "+n+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}function l(e){return!(!e||e.nodeType!==1&&e.nodeType!==9&&e.nodeType!==11)}function u(e){var n=e,a=e;if(e.alternate)for(;n.return;)n=n.return;else{e=n;do n=e,(n.flags&4098)!==0&&(a=n.return),e=n.return;while(e)}return n.tag===3?a:null}function d(e){if(e.tag===13){var n=e.memoizedState;if(n===null&&(e=e.alternate,e!==null&&(n=e.memoizedState)),n!==null)return n.dehydrated}return null}function h(e){if(u(e)!==e)throw Error(r(188))}function m(e){var n=e.alternate;if(!n){if(n=u(e),n===null)throw Error(r(188));return n!==e?null:e}for(var a=e,s=n;;){var c=a.return;if(c===null)break;var f=c.alternate;if(f===null){if(s=c.return,s!==null){a=s;continue}break}if(c.child===f.child){for(f=c.child;f;){if(f===a)return h(c),e;if(f===s)return h(c),n;f=f.sibling}throw Error(r(188))}if(a.return!==s.return)a=c,s=f;else{for(var S=!1,A=c.child;A;){if(A===a){S=!0,a=c,s=f;break}if(A===s){S=!0,s=c,a=f;break}A=A.sibling}if(!S){for(A=f.child;A;){if(A===a){S=!0,a=f,s=c;break}if(A===s){S=!0,s=f,a=c;break}A=A.sibling}if(!S)throw Error(r(189))}}if(a.alternate!==s)throw Error(r(190))}if(a.tag!==3)throw Error(r(188));return a.stateNode.current===a?e:n}function p(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e;for(e=e.child;e!==null;){if(n=p(e),n!==null)return n;e=e.sibling}return null}var _=Object.assign,x=Symbol.for("react.element"),y=Symbol.for("react.transitional.element"),v=Symbol.for("react.portal"),T=Symbol.for("react.fragment"),b=Symbol.for("react.strict_mode"),M=Symbol.for("react.profiler"),g=Symbol.for("react.provider"),z=Symbol.for("react.consumer"),P=Symbol.for("react.context"),L=Symbol.for("react.forward_ref"),w=Symbol.for("react.suspense"),H=Symbol.for("react.suspense_list"),B=Symbol.for("react.memo"),J=Symbol.for("react.lazy"),D=Symbol.for("react.activity"),U=Symbol.for("react.memo_cache_sentinel"),X=Symbol.iterator;function ot(e){return e===null||typeof e!="object"?null:(e=X&&e[X]||e["@@iterator"],typeof e=="function"?e:null)}var mt=Symbol.for("react.client.reference");function ct(e){if(e==null)return null;if(typeof e=="function")return e.$$typeof===mt?null:e.displayName||e.name||null;if(typeof e=="string")return e;switch(e){case T:return"Fragment";case M:return"Profiler";case b:return"StrictMode";case w:return"Suspense";case H:return"SuspenseList";case D:return"Activity"}if(typeof e=="object")switch(e.$$typeof){case v:return"Portal";case P:return(e.displayName||"Context")+".Provider";case z:return(e._context.displayName||"Context")+".Consumer";case L:var n=e.render;return e=e.displayName,e||(e=n.displayName||n.name||"",e=e!==""?"ForwardRef("+e+")":"ForwardRef"),e;case B:return n=e.displayName||null,n!==null?n:ct(e.type)||"Memo";case J:n=e._payload,e=e._init;try{return ct(e(n))}catch{}}return null}var gt=Array.isArray,I=t.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,it=i.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE,K={pending:!1,data:null,method:null,action:null},bt=[],O=-1;function rt(e){return{current:e}}function Tt(e){0>O||(e.current=bt[O],bt[O]=null,O--)}function Ct(e,n){O++,bt[O]=e.current,e.current=n}var zt=rt(null),qt=rt(null),st=rt(null),St=rt(null);function Ot(e,n){switch(Ct(st,n),Ct(qt,e),Ct(zt,null),n.nodeType){case 9:case 11:e=(e=n.documentElement)&&(e=e.namespaceURI)?Gg(e):0;break;default:if(e=n.tagName,n=n.namespaceURI)n=Gg(n),e=Vg(n,e);else switch(e){case"svg":e=1;break;case"math":e=2;break;default:e=0}}Tt(zt),Ct(zt,e)}function ne(){Tt(zt),Tt(qt),Tt(st)}function Zt(e){e.memoizedState!==null&&Ct(St,e);var n=zt.current,a=Vg(n,e.type);n!==a&&(Ct(qt,e),Ct(zt,a))}function he(e){qt.current===e&&(Tt(zt),Tt(qt)),St.current===e&&(Tt(St),Ao._currentValue=K)}var Qe=Object.prototype.hasOwnProperty,G=o.unstable_scheduleCallback,Ne=o.unstable_cancelCallback,fe=o.unstable_shouldYield,ae=o.unstable_requestPaint,N=o.unstable_now,_t=o.unstable_getCurrentPriorityLevel,j=o.unstable_ImmediatePriority,vt=o.unstable_UserBlockingPriority,ft=o.unstable_NormalPriority,Pt=o.unstable_LowPriority,C=o.unstable_IdlePriority,E=o.log,V=o.unstable_setDisableYieldValue,Y=null,dt=null;function tt(e){if(typeof E=="function"&&V(e),dt&&typeof dt.setStrictMode=="function")try{dt.setStrictMode(Y,e)}catch{}}var wt=Math.clz32?Math.clz32:Xt,At=Math.log,kt=Math.LN2;function Xt(e){return e>>>=0,e===0?32:31-(At(e)/kt|0)|0}var Rt=256,Ft=4194304;function $t(e){var n=e&42;if(n!==0)return n;switch(e&-e){case 1:return 1;case 2:return 2;case 4:return 4;case 8:return 8;case 16:return 16;case 32:return 32;case 64:return 64;case 128:return 128;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return e&4194048;case 4194304:case 8388608:case 16777216:case 33554432:return e&62914560;case 67108864:return 67108864;case 134217728:return 134217728;case 268435456:return 268435456;case 536870912:return 536870912;case 1073741824:return 0;default:return e}}function Yt(e,n,a){var s=e.pendingLanes;if(s===0)return 0;var c=0,f=e.suspendedLanes,S=e.pingedLanes;e=e.warmLanes;var A=s&134217727;return A!==0?(s=A&~f,s!==0?c=$t(s):(S&=A,S!==0?c=$t(S):a||(a=A&~e,a!==0&&(c=$t(a))))):(A=s&~f,A!==0?c=$t(A):S!==0?c=$t(S):a||(a=s&~e,a!==0&&(c=$t(a)))),c===0?0:n!==0&&n!==c&&(n&f)===0&&(f=c&-c,a=n&-n,f>=a||f===32&&(a&4194048)!==0)?n:c}function It(e,n){return(e.pendingLanes&~(e.suspendedLanes&~e.pingedLanes)&n)===0}function de(e,n){switch(e){case 1:case 2:case 4:case 8:case 64:return n+250;case 16:case 32:case 128:case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:return n+5e3;case 4194304:case 8388608:case 16777216:case 33554432:return-1;case 67108864:case 134217728:case 268435456:case 536870912:case 1073741824:return-1;default:return-1}}function q(){var e=Rt;return Rt<<=1,(Rt&4194048)===0&&(Rt=256),e}function Nt(){var e=Ft;return Ft<<=1,(Ft&62914560)===0&&(Ft=4194304),e}function Bt(e){for(var n=[],a=0;31>a;a++)n.push(e);return n}function Wt(e,n){e.pendingLanes|=n,n!==268435456&&(e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0)}function Dt(e,n,a,s,c,f){var S=e.pendingLanes;e.pendingLanes=a,e.suspendedLanes=0,e.pingedLanes=0,e.warmLanes=0,e.expiredLanes&=a,e.entangledLanes&=a,e.errorRecoveryDisabledLanes&=a,e.shellSuspendCounter=0;var A=e.entanglements,F=e.expirationTimes,at=e.hiddenUpdates;for(a=S&~a;0<a;){var xt=31-wt(a),Mt=1<<xt;A[xt]=0,F[xt]=-1;var lt=at[xt];if(lt!==null)for(at[xt]=null,xt=0;xt<lt.length;xt++){var ut=lt[xt];ut!==null&&(ut.lane&=-536870913)}a&=~Mt}s!==0&&Et(e,s,0),f!==0&&c===0&&e.tag!==0&&(e.suspendedLanes|=f&~(S&~n))}function Et(e,n,a){e.pendingLanes|=n,e.suspendedLanes&=~n;var s=31-wt(n);e.entangledLanes|=n,e.entanglements[s]=e.entanglements[s]|1073741824|a&4194090}function Qt(e,n){var a=e.entangledLanes|=n;for(e=e.entanglements;a;){var s=31-wt(a),c=1<<s;c&n|e[s]&n&&(e[s]|=n),a&=~c}}function ue(e){switch(e){case 2:e=1;break;case 8:e=4;break;case 32:e=16;break;case 256:case 512:case 1024:case 2048:case 4096:case 8192:case 16384:case 32768:case 65536:case 131072:case 262144:case 524288:case 1048576:case 2097152:case 4194304:case 8388608:case 16777216:case 33554432:e=128;break;case 268435456:e=134217728;break;default:e=0}return e}function Oe(e){return e&=-e,2<e?8<e?(e&134217727)!==0?32:268435456:8:2}function Ce(){var e=it.p;return e!==0?e:(e=window.event,e===void 0?32:o_(e.type))}function hi(e,n){var a=it.p;try{return it.p=e,n()}finally{it.p=a}}var un=Math.random().toString(36).slice(2),fn="__reactFiber$"+un,Je="__reactProps$"+un,Ti="__reactContainer$"+un,br="__reactEvents$"+un,tl="__reactListeners$"+un,Tr="__reactHandles$"+un,Is="__reactResources$"+un,Ai="__reactMarker$"+un;function Ar(e){delete e[fn],delete e[Je],delete e[br],delete e[tl],delete e[Tr]}function zi(e){var n=e[fn];if(n)return n;for(var a=e.parentNode;a;){if(n=a[Ti]||a[fn]){if(a=n.alternate,n.child!==null||a!==null&&a.child!==null)for(e=qg(e);e!==null;){if(a=e[fn])return a;e=qg(e)}return n}e=a,a=e.parentNode}return null}function la(e){if(e=e[fn]||e[Ti]){var n=e.tag;if(n===5||n===6||n===13||n===26||n===27||n===3)return e}return null}function Wa(e){var n=e.tag;if(n===5||n===26||n===27||n===6)return e.stateNode;throw Error(r(33))}function ca(e){var n=e[Is];return n||(n=e[Is]={hoistableStyles:new Map,hoistableScripts:new Map}),n}function sn(e){e[Ai]=!0}var el=new Set,nl={};function R(e,n){Z(e,n),Z(e+"Capture",n)}function Z(e,n){for(nl[e]=n,e=0;e<n.length;e++)el.add(n[e])}var ht=RegExp("^[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$"),pt={},$={};function Ut(e){return Qe.call($,e)?!0:Qe.call(pt,e)?!1:ht.test(e)?$[e]=!0:(pt[e]=!0,!1)}function Ht(e,n,a){if(Ut(n))if(a===null)e.removeAttribute(n);else{switch(typeof a){case"undefined":case"function":case"symbol":e.removeAttribute(n);return;case"boolean":var s=n.toLowerCase().slice(0,5);if(s!=="data-"&&s!=="aria-"){e.removeAttribute(n);return}}e.setAttribute(n,""+a)}}function jt(e,n,a){if(a===null)e.removeAttribute(n);else{switch(typeof a){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(n);return}e.setAttribute(n,""+a)}}function Gt(e,n,a,s){if(s===null)e.removeAttribute(a);else{switch(typeof s){case"undefined":case"function":case"symbol":case"boolean":e.removeAttribute(a);return}e.setAttributeNS(n,a,""+s)}}var re,oe;function Jt(e){if(re===void 0)try{throw Error()}catch(a){var n=a.stack.trim().match(/\n( *(at )?)/);re=n&&n[1]||"",oe=-1<a.stack.indexOf(`
...
`),at=A.split(`
`);for(c=s=0;s<F.length&&!F[s].includes("DetermineComponentFrameRoot");)s++;for(;c<at.length&&!at[c].includes("DetermineComponentFrameRoot");)c++;if(s===F.length||c===at.length)for(s=F.length-1,c=at.length-1;1<=s&&0<=c&&F[s]!==at[c];)c--;for(;1<=s&&0<=c;s--,c--)if(F[s]!==at[c]){if(s!==1||c!==1)do if(s--,c--,0>c||F[s]!==at[c]){var xt=`
...
`].filter(Xo).join(`
`)),d=Rh(d),d=S0(d,i),d=M0(d,i),h=Rh(h),h=S0(h,i),h=M0(h,i),d=E0(d),h=E0(h),i.isRawShaderMaterial!==!0&&(z=`#version 300 es
...
`)+`
`+g);const P=z+M+d,L=z+g+h,w=v0(l,l.VERTEX_SHADER,P),H=v0(l,l.FRAGMENT_SHADER,L);l.attachShader(b,w),l.attachShader(b,H),i.index0AttributeName!==void 0?l.bindAttribLocation(b,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(b,0,"position"),l.linkProgram(b);function B(X){if(o.debug.checkShaderErrors){const ot=l.getProgramInfoLog(b)||"",mt=l.getShaderInfoLog(w)||"",ct=l.getShaderInfoLog(H)||"",gt=ot.trim(),I=mt.trim(),it=ct.trim();let K=!0,bt=!0;if(l.getProgramParameter(b,l.LINK_STATUS)===!1)if(K=!1,typeof o.debug.onShaderError=="function")o.debug.onShaderError(l,b,w,H);else{const O=y0(l,w,"vertex"),rt=y0(l,H,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(b,l.VALIDATE_STATUS)+`
...
}`;function M1(o,t,i){let r=new Q0;const l=new Te,u=new Te,d=new rn,h=new jS({depthPacking:eS}),m=new ZS,p={},_=i.maxTextureSize,x={[ka]:qn,[qn]:ka,[Oi]:Oi},y=new Xa({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Te},radius:{value:4}},vertexShader:y1,fragmentShader:S1}),v=y.clone();v.defines.HORIZONTAL_PASS=1;const T=new Hn;T.setAttribute("position",new Fn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const b=new Un(T,y),M=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=D0;let g=this.type;this.render=function(H,B,J){if(M.enabled===!1||M.autoUpdate===!1&&M.needsUpdate===!1||H.length===0)return;const D=o.getRenderTarget(),U=o.getActiveCubeFace(),X=o.getActiveMipmapLevel(),ot=o.state;ot.setBlending(Ha),ot.buffers.depth.getReversed()===!0?ot.buffers.color.setClear(0,0,0,0):ot.buffers.color.setClear(1,1,1,1),ot.buffers.depth.setTest(!0),ot.setScissorTest(!1);const mt=g!==aa&&this.type===aa,ct=g===aa&&this.type!==aa;for(let gt=0,I=H.length;gt<I;gt++){const it=H[gt],K=it.shadow;if(K===void 0){console.warn("THREE.WebGLShadowMap:",it,"has no shadow.");continue}if(K.autoUpdate===!1&&K.needsUpdate===!1)continue;l.copy(K.mapSize);const bt=K.getFrameExtents();if(l.multiply(bt),u.copy(K.mapSize),(l.x>_||l.y>_)&&(l.x>_&&(u.x=Math.floor(_/bt.x),l.x=u.x*bt.x,K.mapSize.x=u.x),l.y>_&&(u.y=Math.floor(_/bt.y),l.y=u.y*bt.y,K.mapSize.y=u.y)),K.map===null||mt===!0||ct===!0){const rt=this.type!==aa?{minFilter:ni,magFilter:ni}:{};K.map!==null&&K.map.dispose(),K.map=new Mr(l.x,l.y,rt),K.map.texture.name=it.name+".shadowMap",K.camera.updateProjectionMatrix()}o.setRenderTarget(K.map),o.clear();const O=K.getViewportCount();for(let rt=0;rt<O;rt++){const Tt=K.getViewport(rt);d.set(u.x*Tt.x,u.y*Tt.y,u.x*Tt.z,u.y*Tt.w),ot.viewport(d),K.updateMatrices(it,rt),r=K.getFrustum(),L(B,J,K.camera,it,this.type)}K.isPointLightShadow!==!0&&this.type===aa&&z(K,J),K.needsUpdate=!1}g=this.type,M.needsUpdate=!1,o.setRenderTarget(D,U,X)};function z(H,B){const J=t.update(b);y.defines.VSM_SAMPLES!==H.blurSamples&&(y.defines.VSM_SAMPLES=H.blurSamples,v.defines.VSM_SAMPLES=H.blurSamples,y.needsUpdate=!0,v.needsUpdate=!0),H.mapPass===null&&(H.mapPass=new Mr(l.x,l.y)),y.uniforms.shadow_pass.value=H.map.texture,y.uniforms.resolution.value=H.mapSize,y.uniforms.radius.value=H.radius,o.setRenderTarget(H.mapPass),o.clear(),o.renderBufferDirect(B,null,J,y,b,null),v.uniforms.shadow_pass.value=H.mapPass.texture,v.uniforms.resolution.value=H.mapSize,v.uniforms.radius.value=H.radius,o.setRenderTarget(H.map),o.clear(),o.renderBufferDirect(B,null,J,v,b,null)}function P(H,B,J,D){let U=null;const X=J.isPointLight===!0?H.customDistanceMaterial:H.customDepthMaterial;if(X!==void 0)U=X;else if(U=J.isPointLight===!0?m:h,o.localClippingEnabled&&B.clipShadows===!0&&Array.isArray(B.clippingPlanes)&&B.clippingPlanes.length!==0||B.displacementMap&&B.displacementScale!==0||B.alphaMap&&B.alphaTest>0||B.map&&B.alphaTest>0||B.alphaToCoverage===!0){const ot=U.uuid,mt=B.uuid;let ct=p[ot];ct===void 0&&(ct={},p[ot]=ct);let gt=ct[mt];gt===void 0&&(gt=U.clone(),ct[mt]=gt,B.addEventListener("dispose",w)),U=gt}if(U.visible=B.visible,U.wireframe=B.wireframe,D===aa?U.side=B.shadowSide!==null?B.shadowSide:B.side:U.side=B.shadowSide!==null?B.shadowSide:x[B.side],U.alphaMap=B.alphaMap,U.alphaTest=B.alphaToCoverage===!0?.5:B.alphaTest,U.map=B.map,U.clipShadows=B.clipShadows,U.clippingPlanes=B.clippingPlanes,U.clipIntersection=B.clipIntersection,U.displacementMap=B.displacementMap,U.displacementScale=B.displacementScale,U.displacementBias=B.displacementBias,U.wireframeLinewidth=B.wireframeLinewidth,U.linewidth=B.linewidth,J.isPointLight===!0&&U.isMeshDistanceMaterial===!0){const ot=o.properties.get(U);ot.light=J}return U}function L(H,B,J,D,U){if(H.visible===!1)return;if(H.layers.test(B.layers)&&(H.isMesh||H.isLine||H.isPoints)&&(H.castShadow||H.receiveShadow&&U===aa)&&(!H.frustumCulled||r.intersectsObject(H))){H.modelViewMatrix.multiplyMatrices(J.matrixWorldInverse,H.matrixWorld);const mt=t.update(H),ct=H.material;if(Array.isArray(ct)){const gt=mt.groups;for(let I=0,it=gt.length;I<it;I++){const K=gt[I],bt=ct[K.materialIndex];if(bt&&bt.visible){const O=P(H,bt,D,U);H.onBeforeShadow(o,H,B,J,mt,O,K),o.renderBufferDirect(J,null,mt,O,H,K),H.onAfterShadow(o,H,B,J,mt,O,K)}}}else if(ct.visible){const gt=P(H,ct,D,U);H.onBeforeShadow(o,H,B,J,mt,gt,null),o.renderBufferDirect(J,null,mt,gt,H,null),H.onAfterShadow(o,H,B,J,mt,gt,null)}}const ot=H.children;for(let mt=0,ct=ot.length;mt<ct;mt++)L(ot[mt],B,J,D,U)}function w(H){H.target.removeEventListener("dispose",w);for(const J in p){const D=p[J],U=H.target.uuid;U in D&&(D[U].dispose(),delete D[U])}}}const E1={[Fd]:Hd,[Gd]:Xd,[Vd]:Wd,[Cs]:kd,[Hd]:Fd,[Xd]:Gd,[Wd]:Vd,[kd]:Cs};function b1(o,t){function i(){let q=!1;const Nt=new rn;let Bt=null;const Wt=new rn(0,0,0,0);return{setMask:function(Dt){Bt!==Dt&&!q&&(o.colorMask(Dt,Dt,Dt,Dt),Bt=Dt)},setLocked:function(Dt){q=Dt},setClear:function(Dt,Et,Qt,ue,Oe){Oe===!0&&(Dt*=ue,Et*=ue,Qt*=ue),Nt.set(Dt,Et,Qt,ue),Wt.equals(Nt)===!1&&(o.clearColor(Dt,Et,Qt,ue),Wt.copy(Nt))},reset:function(){q=!1,Bt=null,Wt.set(-1,0,0,0)}}}function r(){let q=!1,Nt=!1,Bt=null,Wt=null,Dt=null;return{setReversed:function(Et){if(Nt!==Et){const Qt=t.get("EXT_clip_control");Et?Qt.clipControlEXT(Qt.LOWER_LEFT_EXT,Qt.ZERO_TO_ONE_EXT):Qt.clipControlEXT(Qt.LOWER_LEFT_EXT,Qt.NEGATIVE_ONE_TO_ONE_EXT),Nt=Et;const ue=Dt;Dt=null,this.setClear(ue)}},getReversed:function(){return Nt},setTest:function(Et){Et?St(o.DEPTH_TEST):Ot(o.DEPTH_TEST)},setMask:function(Et){Bt!==Et&&!q&&(o.depthMask(Et),Bt=Et)},setFunc:function(Et){if(Nt&&(Et=E1[Et]),Wt!==Et){switch(Et){case Fd:o.depthFunc(o.NEVER);break;case Hd:o.depthFunc(o.ALWAYS);break;case Gd:o.depthFunc(o.LESS);break;case Cs:o.depthFunc(o.LEQUAL);break;case Vd:o.depthFunc(o.EQUAL);break;case kd:o.depthFunc(o.GEQUAL);break;case Xd:o.depthFunc(o.GREATER);break;case Wd:o.depthFunc(o.NOTEQUAL);break;default:o.depthFunc(o.LEQUAL)}Wt=Et}},setLocked:function(Et){q=Et},setClear:function(Et){Dt!==Et&&(Nt&&(Et=1-Et),o.clearDepth(Et),Dt=Et)},reset:function(){q=!1,Bt=null,Wt=null,Dt=null,Nt=!1}}}function l(){let q=!1,Nt=null,Bt=null,Wt=null,Dt=null,Et=null,Qt=null,ue=null,Oe=null;return{setTest:function(Ce){q||(Ce?St(o.STENCIL_TEST):Ot(o.STENCIL_TEST))},setMask:function(Ce){Nt!==Ce&&!q&&(o.stencilMask(Ce),Nt=Ce)},setFunc:function(Ce,hi,un){(Bt!==Ce||Wt!==hi||Dt!==un)&&(o.stencilFunc(Ce,hi,un),Bt=Ce,Wt=hi,Dt=un)},setOp:function(Ce,hi,un){(Et!==Ce||Qt!==hi||ue!==un)&&(o.stencilOp(Ce,hi,un),Et=Ce,Qt=hi,ue=un)},setLocked:function(Ce){q=Ce},setClear:function(Ce){Oe!==Ce&&(o.clearStencil(Ce),Oe=Ce)},reset:function(){q=!1,Nt=null,Bt=null,Wt=null,Dt=null,Et=null,Qt=null,ue=null,Oe=null}}}const u=new i,d=new r,h=new l,m=new WeakMap,p=new WeakMap;let _={},x={},y=new WeakMap,v=[],T=null,b=!1,M=null,g=null,z=null,P=null,L=null,w=null,H=null,B=new xe(0,0,0),J=0,D=!1,U=null,X=null,ot=null,mt=null,ct=null;const gt=o.getParameter(o.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let I=!1,it=0;const K=o.getParameter(o.VERSION);K.indexOf("WebGL")!==-1?(it=parseFloat(/^WebGL (\d)/.exec(K)[1]),I=it>=1):K.indexOf("OpenGL ES")!==-1&&(it=parseFloat(/^OpenGL ES (\d)/.exec(K)[1]),I=it>=2);let bt=null,O={};const rt=o.getParameter(o.SCISSOR_BOX),Tt=o.getParameter(o.VIEWPORT),Ct=new rn().fromArray(rt),zt=new rn().fromArray(Tt);function qt(q,Nt,Bt,Wt){const Dt=new Uint8Array(4),Et=o.createTexture();o.bindTexture(q,Et),o.texParameteri(q,o.TEXTURE_MIN_FILTER,o.NEAREST),o.texParameteri(q,o.TEXTURE_MAG_FILTER,o.NEAREST);for(let Qt=0;Qt<Bt;Qt++)q===o.TEXTURE_3D||q===o.TEXTURE_2D_ARRAY?o.texImage3D(Nt,0,o.RGBA,1,1,Wt,0,o.RGBA,o.UNSIGNED_BYTE,Dt):o.texImage2D(Nt+Qt,0,o.RGBA,1,1,0,o.RGBA,o.UNSIGNED_BYTE,Dt);return Et}const st={};st[o.TEXTURE_2D]=qt(o.TEXTURE_2D,o.TEXTURE_2D,1),st[o.TEXTURE_CUBE_MAP]=qt(o.TEXTURE_CUBE_MAP,o.TEXTURE_CUBE_MAP_POSITIVE_X,6),st[o.TEXTURE_2D_ARRAY]=qt(o.TEXTURE_2D_ARRAY,o.TEXTURE_2D_ARRAY,1,1),st[o.TEXTURE_3D]=qt(o.TEXTURE_3D,o.TEXTURE_3D,1,1),u.setClear(0,0,0,1),d.setClear(1),h.setClear(0),St(o.DEPTH_TEST),d.setFunc(Cs),ae(!1),N(b_),St(o.CULL_FACE),Ne(Ha);function St(q){_[q]!==!0&&(o.enable(q),_[q]=!0)}function Ot(q){_[q]!==!1&&(o.disable(q),_[q]=!1)}function ne(q,Nt){return x[q]!==Nt?(o.bindFramebuffer(q,Nt),x[q]=Nt,q===o.DRAW_FRAMEBUFFER&&(x[o.FRAMEBUFFER]=Nt),q===o.FRAMEBUFFER&&(x[o.DRAW_FRAMEBUFFER]=Nt),!0):!1}function Zt(q,Nt){let Bt=v,Wt=!1;if(q){Bt=y.get(Nt),Bt===void 0&&(Bt=[],y.set(Nt,Bt));const Dt=q.textures;if(Bt.length!==Dt.length||Bt[0]!==o.COLOR_ATTACHMENT0){for(let Et=0,Qt=Dt.length;Et<Qt;Et++)Bt[Et]=o.COLOR_ATTACHMENT0+Et;Bt.length=Dt.length,Wt=!0}}else Bt[0]!==o.BACK&&(Bt[0]=o.BACK,Wt=!0);Wt&&o.drawBuffers(Bt)}function he(q){return T!==q?(o.useProgram(q),T=q,!0):!1}const Qe={[gr]:o.FUNC_ADD,[Ry]:o.FUNC_SUBTRACT,[Cy]:o.FUNC_REVERSE_SUBTRACT};Qe[wy]=o.MIN,Qe[Dy]=o.MAX;const G={[Uy]:o.ZERO,[Ly]:o.ONE,[Ny]:o.SRC_COLOR,[Id]:o.SRC_ALPHA,[Fy]:o.SRC_ALPHA_SATURATE,[Iy]:o.DST_COLOR,[Py]:o.DST_ALPHA,[Oy]:o.ONE_MINUS_SRC_COLOR,[zd]:o.ONE_MINUS_SRC_ALPHA,[zy]:o.ONE_MINUS_DST_COLOR,[By]:o.ONE_MINUS_DST_ALPHA,[Hy]:o.CONSTANT_COLOR,[Gy]:o.ONE_MINUS_CONSTANT_COLOR,[Vy]:o.CONSTANT_ALPHA,[ky]:o.ONE_MINUS_CONSTANT_ALPHA};function Ne(q,Nt,Bt,Wt,Dt,Et,Qt,ue,Oe,Ce){if(q===Ha){b===!0&&(Ot(o.BLEND),b=!1);return}if(b===!1&&(St(o.BLEND),b=!0),q!==Ay){if(q!==M||Ce!==D){if((g!==gr||L!==gr)&&(o.blendEquation(o.FUNC_ADD),g=gr,L=gr),Ce)switch(q){case Ts:o.blendFuncSeparate(o.ONE,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case T_:o.blendFunc(o.ONE,o.ONE);break;case A_:o.blendFuncSeparate(o.ZERO,o.ONE_MINUS_SRC_COLOR,o.ZERO,o.ONE);break;case R_:o.blendFuncSeparate(o.DST_COLOR,o.ONE_MINUS_SRC_ALPHA,o.ZERO,o.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",q);break}else switch(q){case Ts:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE_MINUS_SRC_ALPHA,o.ONE,o.ONE_MINUS_SRC_ALPHA);break;case T_:o.blendFuncSeparate(o.SRC_ALPHA,o.ONE,o.ONE,o.ONE);break;case A_:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case R_:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",q);break}z=null,P=null,w=null,H=null,B.set(0,0,0),J=0,M=q,D=Ce}return}Dt=Dt||Nt,Et=Et||Bt,Qt=Qt||Wt,(Nt!==g||Dt!==L)&&(o.blendEquationSeparate(Qe[Nt],Qe[Dt]),g=Nt,L=Dt),(Bt!==z||Wt!==P||Et!==w||Qt!==H)&&(o.blendFuncSeparate(G[Bt],G[Wt],G[Et],G[Qt]),z=Bt,P=Wt,w=Et,H=Qt),(ue.equals(B)===!1||Oe!==J)&&(o.blendColor(ue.r,ue.g,ue.b,Oe),B.copy(ue),J=Oe),M=q,D=!1}function fe(q,Nt){q.side===Oi?Ot(o.CULL_FACE):St(o.CULL_FACE);let Bt=q.side===qn;Nt&&(Bt=!Bt),ae(Bt),q.blending===Ts&&q.transparent===!1?Ne(Ha):Ne(q.blending,q.blendEquation,q.blendSrc,q.blendDst,q.blendEquationAlpha,q.blendSrcAlpha,q.blendDstAlpha,q.blendColor,q.blendAlpha,q.premultipliedAlpha),d.setFunc(q.depthFunc),d.setTest(q.depthTest),d.setMask(q.depthWrite),u.setMask(q.colorWrite);const Wt=q.stencilWrite;h.setTest(Wt),Wt&&(h.setMask(q.stencilWriteMask),h.setFunc(q.stencilFunc,q.stencilRef,q.stencilFuncMask),h.setOp(q.stencilFail,q.stencilZFail,q.stencilZPass)),j(q.polygonOffset,q.polygonOffsetFactor,q.polygonOffsetUnits),q.alphaToCoverage===!0?St(o.SAMPLE_ALPHA_TO_COVERAGE):Ot(o.SAMPLE_ALPHA_TO_COVERAGE)}function ae(q){U!==q&&(q?o.frontFace(o.CW):o.frontFace(o.CCW),U=q)}function N(q){q!==Ey?(St(o.CULL_FACE),q!==X&&(q===b_?o.cullFace(o.BACK):q===by?o.cullFace(o.FRONT):o.cullFace(o.FRONT_AND_BACK))):Ot(o.CULL_FACE),X=q}function _t(q){q!==ot&&(I&&o.lineWidth(q),ot=q)}function j(q,Nt,Bt){q?(St(o.POLYGON_OFFSET_FILL),(mt!==Nt||ct!==Bt)&&(o.polygonOffset(Nt,Bt),mt=Nt,ct=Bt)):Ot(o.POLYGON_OFFSET_FILL)}function vt(q){q?St(o.SCISSOR_TEST):Ot(o.SCISSOR_TEST)}function ft(q){q===void 0&&(q=o.TEXTURE0+gt-1),bt!==q&&(o.activeTexture(q),bt=q)}function Pt(q,Nt,Bt){Bt===void 0&&(bt===null?Bt=o.TEXTURE0+gt-1:Bt=bt);let Wt=O[Bt];Wt===void 0&&(Wt={type:void 0,texture:void 0},O[Bt]=Wt),(Wt.type!==q||Wt.texture!==Nt)&&(bt!==Bt&&(o.activeTexture(Bt),bt=Bt),o.bindTexture(q,Nt||st[q]),Wt.type=q,Wt.texture=Nt)}function C(){const q=O[bt];q!==void 0&&q.type!==void 0&&(o.bindTexture(q.type,null),q.type=void 0,q.texture=void 0)}function E(){try{o.compressedTexImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function V(){try{o.compressedTexImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Y(){try{o.texSubImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function dt(){try{o.texSubImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function tt(){try{o.compressedTexSubImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function wt(){try{o.compressedTexSubImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function At(){try{o.texStorage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function kt(){try{o.texStorage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Xt(){try{o.texImage2D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Rt(){try{o.texImage3D(...arguments)}catch(q){console.error("THREE.WebGLState:",q)}}function Ft(q){Ct.equals(q)===!1&&(o.scissor(q.x,q.y,q.z,q.w),Ct.copy(q))}function $t(q){zt.equals(q)===!1&&(o.viewport(q.x,q.y,q.z,q.w),zt.copy(q))}function Yt(q,Nt){let Bt=p.get(Nt);Bt===void 0&&(Bt=new WeakMap,p.set(Nt,Bt));let Wt=Bt.get(q);Wt===void 0&&(Wt=o.getUniformBlockIndex(Nt,q.name),Bt.set(q,Wt))}function It(q,Nt){const Wt=p.get(Nt).get(q);m.get(Nt)!==Wt&&(o.uniformBlockBinding(Nt,Wt,q.__bindingPointIndex),m.set(Nt,Wt))}function de(){o.disable(o.BLEND),o.disable(o.CULL_FACE),o.disable(o.DEPTH_TEST),o.disable(o.POLYGON_OFFSET_FILL),o.disable(o.SCISSOR_TEST),o.disable(o.STENCIL_TEST),o.disable(o.SAMPLE_ALPHA_TO_COVERAGE),o.blendEquation(o.FUNC_ADD),o.blendFunc(o.ONE,o.ZERO),o.blendFuncSeparate(o.ONE,o.ZERO,o.ONE,o.ZERO),o.blendColor(0,0,0,0),o.colorMask(!0,!0,!0,!0),o.clearColor(0,0,0,0),o.depthMask(!0),o.depthFunc(o.LESS),d.setReversed(!1),o.clearDepth(1),o.stencilMask(4294967295),o.stencilFunc(o.ALWAYS,0,4294967295),o.stencilOp(o.KEEP,o.KEEP,o.KEEP),o.clearStencil(0),o.cullFace(o.BACK),o.frontFace(o.CCW),o.polygonOffset(0,0),o.activeTexture(o.TEXTURE0),o.bindFramebuffer(o.FRAMEBUFFER,null),o.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),o.bindFramebuffer(o.READ_FRAMEBUFFER,null),o.useProgram(null),o.lineWidth(1),o.scissor(0,0,o.canvas.width,o.canvas.height),o.viewport(0,0,o.canvas.width,o.canvas.height),_={},bt=null,O={},x={},y=new WeakMap,v=[],T=null,b=!1,M=null,g=null,z=null,P=null,L=null,w=null,H=null,B=new xe(0,0,0),J=0,D=!1,U=null,X=null,ot=null,mt=null,ct=null,Ct.set(0,0,o.canvas.width,o.canvas.height),zt.set(0,0,o.canvas.width,o.canvas.height),u.reset(),d.reset(),h.reset()}return{buffers:{color:u,depth:d,stencil:h},enable:St,disable:Ot,bindFramebuffer:ne,drawBuffers:Zt,useProgram:he,setBlending:Ne,setMaterial:fe,setFlipSided:ae,setCullFace:N,setLineWidth:_t,setPolygonOffset:j,setScissorTest:vt,activeTexture:ft,bindTexture:Pt,unbindTexture:C,compressedTexImage2D:E,compressedTexImage3D:V,texImage2D:Xt,texImage3D:Rt,updateUBOMapping:Yt,uniformBlockBinding:It,texStorage2D:At,texStorage3D:kt,texSubImage2D:Y,texSubImage3D:dt,compressedTexSubImage2D:tt,compressedTexSubImage3D:wt,scissor:Ft,viewport:$t,reset:de}}function T1(o,t,i,r,l,u,d){const h=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),p=new Te,_=new WeakMap;let x;const y=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function T(C,E){return v?new OffscreenCanvas(C,E):kc("canvas")}function b(C,E,V){let Y=1;const dt=Pt(C);if((dt.width>V||dt.height>V)&&(Y=V/Math.max(dt.width,dt.height)),Y<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const tt=Math.floor(Y*dt.width),wt=Math.floor(Y*dt.height);x===void 0&&(x=T(tt,wt));const At=E?T(tt,wt):x;return At.width=tt,At.height=wt,At.getContext("2d").drawImage(C,0,0,tt,wt),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+dt.width+"x"+dt.height+") to ("+tt+"x"+wt+")."),At}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+dt.width+"x"+dt.height+")."),C;return C}function M(C){return C.generateMipmaps}function g(C){o.generateMipmap(C)}function z(C){return C.isWebGLCubeRenderTarget?o.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?o.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?o.TEXTURE_2D_ARRAY:o.TEXTURE_2D}function P(C,E,V,Y,dt=!1){if(C!==null){if(o[C]!==void 0)return o[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let tt=E;if(E===o.RED&&(V===o.FLOAT&&(tt=o.R32F),V===o.HALF_FLOAT&&(tt=o.R16F),V===o.UNSIGNED_BYTE&&(tt=o.R8)),E===o.RED_INTEGER&&(V===o.UNSIGNED_BYTE&&(tt=o.R8UI),V===o.UNSIGNED_SHORT&&(tt=o.R16UI),V===o.UNSIGNED_INT&&(tt=o.R32UI),V===o.BYTE&&(tt=o.R8I),V===o.SHORT&&(tt=o.R16I),V===o.INT&&(tt=o.R32I)),E===o.RG&&(V===o.FLOAT&&(tt=o.RG32F),V===o.HALF_FLOAT&&(tt=o.RG16F),V===o.UNSIGNED_BYTE&&(tt=o.RG8)),E===o.RG_INTEGER&&(V===o.UNSIGNED_BYTE&&(tt=o.RG8UI),V===o.UNSIGNED_SHORT&&(tt=o.RG16UI),V===o.UNSIGNED_INT&&(tt=o.RG32UI),V===o.BYTE&&(tt=o.RG8I),V===o.SHORT&&(tt=o.RG16I),V===o.INT&&(tt=o.RG32I)),E===o.RGB_INTEGER&&(V===o.UNSIGNED_BYTE&&(tt=o.RGB8UI),V===o.UNSIGNED_SHORT&&(tt=o.RGB16UI),V===o.UNSIGNED_INT&&(tt=o.RGB32UI),V===o.BYTE&&(tt=o.RGB8I),V===o.SHORT&&(tt=o.RGB16I),V===o.INT&&(tt=o.RGB32I)),E===o.RGBA_INTEGER&&(V===o.UNSIGNED_BYTE&&(tt=o.RGBA8UI),V===o.UNSIGNED_SHORT&&(tt=o.RGBA16UI),V===o.UNSIGNED_INT&&(tt=o.RGBA32UI),V===o.BYTE&&(tt=o.RGBA8I),V===o.SHORT&&(tt=o.RGBA16I),V===o.INT&&(tt=o.RGBA32I)),E===o.RGB&&(V===o.UNSIGNED_INT_5_9_9_9_REV&&(tt=o.RGB9_E5),V===o.UNSIGNED_INT_10F_11F_11F_REV&&(tt=o.R11F_G11F_B10F)),E===o.RGBA){const wt=dt?Gc:Ue.getTransfer(Y);V===o.FLOAT&&(tt=o.RGBA32F),V===o.HALF_FLOAT&&(tt=o.RGBA16F),V===o.UNSIGNED_BYTE&&(tt=wt===Ge?o.SRGB8_ALPHA8:o.RGBA8),V===o.UNSIGNED_SHORT_4_4_4_4&&(tt=o.RGBA4),V===o.UNSIGNED_SHORT_5_5_5_1&&(tt=o.RGB5_A1)}return(tt===o.R16F||tt===o.R32F||tt===o.RG16F||tt===o.RG32F||tt===o.RGBA16F||tt===o.RGBA32F)&&t.get("EXT_color_buffer_float"),tt}function L(C,E){let V;return C?E===null||E===Sr||E===qo?V=o.DEPTH24_STENCIL8:E===Bi?V=o.DEPTH32F_STENCIL8:E===Wo&&(V=o.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Sr||E===qo?V=o.DEPTH_COMPONENT24:E===Bi?V=o.DEPTH_COMPONENT32F:E===Wo&&(V=o.DEPTH_COMPONENT16),V}function w(C,E){return M(C)===!0||C.isFramebufferTexture&&C.minFilter!==ni&&C.minFilter!==Mi?Math.log2(Math.max(E.width,E.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?E.mipmaps.length:1}function H(C){const E=C.target;E.removeEventListener("dispose",H),J(E),E.isVideoTexture&&_.delete(E)}function B(C){const E=C.target;E.removeEventListener("dispose",B),U(E)}function J(C){const E=r.get(C);if(E.__webglInit===void 0)return;const V=C.source,Y=y.get(V);if(Y){const dt=Y[E.__cacheKey];dt.usedTimes--,dt.usedTimes===0&&D(C),Object.keys(Y).length===0&&y.delete(V)}r.remove(C)}function D(C){const E=r.get(C);o.deleteTexture(E.__webglTexture);const V=C.source,Y=y.get(V);delete Y[E.__cacheKey],d.memory.textures--}function U(C){const E=r.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),r.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(E.__webglFramebuffer[Y]))for(let dt=0;dt<E.__webglFramebuffer[Y].length;dt++)o.deleteFramebuffer(E.__webglFramebuffer[Y][dt]);else o.deleteFramebuffer(E.__webglFramebuffer[Y]);E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer[Y])}else{if(Array.isArray(E.__webglFramebuffer))for(let Y=0;Y<E.__webglFramebuffer.length;Y++)o.deleteFramebuffer(E.__webglFramebuffer[Y]);else o.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&o.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&o.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let Y=0;Y<E.__webglColorRenderbuffer.length;Y++)E.__webglColorRenderbuffer[Y]&&o.deleteRenderbuffer(E.__webglColorRenderbuffer[Y]);E.__webglDepthRenderbuffer&&o.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const V=C.textures;for(let Y=0,dt=V.length;Y<dt;Y++){const tt=r.get(V[Y]);tt.__webglTexture&&(o.deleteTexture(tt.__webglTexture),d.memory.textures--),r.remove(V[Y])}r.remove(C)}let X=0;function ot(){X=0}function mt(){const C=X;return C>=l.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+l.maxTextures),X+=1,C}function ct(C){const E=[];return E.push(C.wrapS),E.push(C.wrapT),E.push(C.wrapR||0),E.push(C.magFilter),E.push(C.minFilter),E.push(C.anisotropy),E.push(C.internalFormat),E.push(C.format),E.push(C.type),E.push(C.generateMipmaps),E.push(C.premultiplyAlpha),E.push(C.flipY),E.push(C.unpackAlignment),E.push(C.colorSpace),E.join()}function gt(C,E){const V=r.get(C);if(C.isVideoTexture&&vt(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&V.__version!==C.version){const Y=C.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{st(V,C,E);return}}else C.isExternalTexture&&(V.__webglTexture=C.sourceTexture?C.sourceTexture:null);i.bindTexture(o.TEXTURE_2D,V.__webglTexture,o.TEXTURE0+E)}function I(C,E){const V=r.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&V.__version!==C.version){st(V,C,E);return}i.bindTexture(o.TEXTURE_2D_ARRAY,V.__webglTexture,o.TEXTURE0+E)}function it(C,E){const V=r.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&V.__version!==C.version){st(V,C,E);return}i.bindTexture(o.TEXTURE_3D,V.__webglTexture,o.TEXTURE0+E)}function K(C,E){const V=r.get(C);if(C.version>0&&V.__version!==C.version){St(V,C,E);return}i.bindTexture(o.TEXTURE_CUBE_MAP,V.__webglTexture,o.TEXTURE0+E)}const bt={[jd]:o.REPEAT,[xr]:o.CLAMP_TO_EDGE,[Zd]:o.MIRRORED_REPEAT},O={[ni]:o.NEAREST,[$y]:o.NEAREST_MIPMAP_NEAREST,[cc]:o.NEAREST_MIPMAP_LINEAR,[Mi]:o.LINEAR,[ad]:o.LINEAR_MIPMAP_NEAREST,[yr]:o.LINEAR_MIPMAP_LINEAR},rt={[aS]:o.NEVER,[uS]:o.ALWAYS,[rS]:o.LESS,[H0]:o.LEQUAL,[sS]:o.EQUAL,[cS]:o.GEQUAL,[oS]:o.GREATER,[lS]:o.NOTEQUAL};function Tt(C,E){if(E.type===Bi&&t.has("OES_texture_float_linear")===!1&&(E.magFilter===Mi||E.magFilter===ad||E.magFilter===cc||E.magFilter===yr||E.minFilter===Mi||E.minFilter===ad||E.minFilter===cc||E.minFilter===yr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),o.texParameteri(C,o.TEXTURE_WRAP_S,bt[E.wrapS]),o.texParameteri(C,o.TEXTURE_WRAP_T,bt[E.wrapT]),(C===o.TEXTURE_3D||C===o.TEXTURE_2D_ARRAY)&&o.texParameteri(C,o.TEXTURE_WRAP_R,bt[E.wrapR]),o.texParameteri(C,o.TEXTURE_MAG_FILTER,O[E.magFilter]),o.texParameteri(C,o.TEXTURE_MIN_FILTER,O[E.minFilter]),E.compareFunction&&(o.texParameteri(C,o.TEXTURE_COMPARE_MODE,o.COMPARE_REF_TO_TEXTURE),o.texParameteri(C,o.TEXTURE_COMPARE_FUNC,rt[E.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===ni||E.minFilter!==cc&&E.minFilter!==yr||E.type===Bi&&t.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||r.get(E).__currentAnisotropy){const V=t.get("EXT_texture_filter_anisotropic");o.texParameterf(C,V.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,l.getMaxAnisotropy())),r.get(E).__currentAnisotropy=E.anisotropy}}}function Ct(C,E){let V=!1;C.__webglInit===void 0&&(C.__webglInit=!0,E.addEventListener("dispose",H));const Y=E.source;let dt=y.get(Y);dt===void 0&&(dt={},y.set(Y,dt));const tt=ct(E);if(tt!==C.__cacheKey){dt[tt]===void 0&&(dt[tt]={texture:o.createTexture(),usedTimes:0},d.memory.textures++,V=!0),dt[tt].usedTimes++;const wt=dt[C.__cacheKey];wt!==void 0&&(dt[C.__cacheKey].usedTimes--,wt.usedTimes===0&&D(E)),C.__cacheKey=tt,C.__webglTexture=dt[tt].texture}return V}function zt(C,E,V){return Math.floor(Math.floor(C/V)/E)}function qt(C,E,V,Y){const tt=C.updateRanges;if(tt.length===0)i.texSubImage2D(o.TEXTURE_2D,0,0,0,E.width,E.height,V,Y,E.data);else{tt.sort((Rt,Ft)=>Rt.start-Ft.start);let wt=0;for(let Rt=1;Rt<tt.length;Rt++){const Ft=tt[wt],$t=tt[Rt],Yt=Ft.start+Ft.count,It=zt($t.start,E.width,4),de=zt(Ft.start,E.width,4);$t.start<=Yt+1&&It===de&&zt($t.start+$t.count-1,E.width,4)===It?Ft.count=Math.max(Ft.count,$t.start+$t.count-Ft.start):(++wt,tt[wt]=$t)}tt.length=wt+1;const At=o.getParameter(o.UNPACK_ROW_LENGTH),kt=o.getParameter(o.UNPACK_SKIP_PIXELS),Xt=o.getParameter(o.UNPACK_SKIP_ROWS);o.pixelStorei(o.UNPACK_ROW_LENGTH,E.width);for(let Rt=0,Ft=tt.length;Rt<Ft;Rt++){const $t=tt[Rt],Yt=Math.floor($t.start/4),It=Math.ceil($t.count/4),de=Yt%E.width,q=Math.floor(Yt/E.width),Nt=It,Bt=1;o.pixelStorei(o.UNPACK_SKIP_PIXELS,de),o.pixelStorei(o.UNPACK_SKIP_ROWS,q),i.texSubImage2D(o.TEXTURE_2D,0,de,q,Nt,Bt,V,Y,E.data)}C.clearUpdateRanges(),o.pixelStorei(o.UNPACK_ROW_LENGTH,At),o.pixelStorei(o.UNPACK_SKIP_PIXELS,kt),o.pixelStorei(o.UNPACK_SKIP_ROWS,Xt)}}function st(C,E,V){let Y=o.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(Y=o.TEXTURE_2D_ARRAY),E.isData3DTexture&&(Y=o.TEXTURE_3D);const dt=Ct(C,E),tt=E.source;i.bindTexture(Y,C.__webglTexture,o.TEXTURE0+V);const wt=r.get(tt);if(tt.version!==wt.__version||dt===!0){i.activeTexture(o.TEXTURE0+V);const At=Ue.getPrimaries(Ue.workingColorSpace),kt=E.colorSpace===Fa?null:Ue.getPrimaries(E.colorSpace),Xt=E.colorSpace===Fa||At===kt?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,Xt);let Rt=b(E.image,!1,l.maxTextureSize);Rt=ft(E,Rt);const Ft=u.convert(E.format,E.colorSpace),$t=u.convert(E.type);let Yt=P(E.internalFormat,Ft,$t,E.colorSpace,E.isVideoTexture);Tt(Y,E);let It;const de=E.mipmaps,q=E.isVideoTexture!==!0,Nt=wt.__version===void 0||dt===!0,Bt=tt.dataReady,Wt=w(E,Rt);if(E.isDepthTexture)Yt=L(E.format===jo,E.type),Nt&&(q?i.texStorage2D(o.TEXTURE_2D,1,Yt,Rt.width,Rt.height):i.texImage2D(o.TEXTURE_2D,0,Yt,Rt.width,Rt.height,0,Ft,$t,null));else if(E.isDataTexture)if(de.length>0){q&&Nt&&i.texStorage2D(o.TEXTURE_2D,Wt,Yt,de[0].width,de[0].height);for(let Dt=0,Et=de.length;Dt<Et;Dt++)It=de[Dt],q?Bt&&i.texSubImage2D(o.TEXTURE_2D,Dt,0,0,It.width,It.height,Ft,$t,It.data):i.texImage2D(o.TEXTURE_2D,Dt,Yt,It.width,It.height,0,Ft,$t,It.data);E.generateMipmaps=!1}else q?(Nt&&i.texStorage2D(o.TEXTURE_2D,Wt,Yt,Rt.width,Rt.height),Bt&&qt(E,Rt,Ft,$t)):i.texImage2D(o.TEXTURE_2D,0,Yt,Rt.width,Rt.height,0,Ft,$t,Rt.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){q&&Nt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Wt,Yt,de[0].width,de[0].height,Rt.depth);for(let Dt=0,Et=de.length;Dt<Et;Dt++)if(It=de[Dt],E.format!==Ei)if(Ft!==null)if(q){if(Bt)if(E.layerUpdates.size>0){const Qt=i0(It.width,It.height,E.format,E.type);for(const ue of E.layerUpdates){const Oe=It.data.subarray(ue*Qt/It.data.BYTES_PER_ELEMENT,(ue+1)*Qt/It.data.BYTES_PER_ELEMENT);i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Dt,0,0,ue,It.width,It.height,1,Ft,Oe)}E.clearLayerUpdates()}else i.compressedTexSubImage3D(o.TEXTURE_2D_ARRAY,Dt,0,0,0,It.width,It.height,Rt.depth,Ft,It.data)}else i.compressedTexImage3D(o.TEXTURE_2D_ARRAY,Dt,Yt,It.width,It.height,Rt.depth,0,It.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else q?Bt&&i.texSubImage3D(o.TEXTURE_2D_ARRAY,Dt,0,0,0,It.width,It.height,Rt.depth,Ft,$t,It.data):i.texImage3D(o.TEXTURE_2D_ARRAY,Dt,Yt,It.width,It.height,Rt.depth,0,Ft,$t,It.data)}else{q&&Nt&&i.texStorage2D(o.TEXTURE_2D,Wt,Yt,de[0].width,de[0].height);for(let Dt=0,Et=de.length;Dt<Et;Dt++)It=de[Dt],E.format!==Ei?Ft!==null?q?Bt&&i.compressedTexSubImage2D(o.TEXTURE_2D,Dt,0,0,It.width,It.height,Ft,It.data):i.compressedTexImage2D(o.TEXTURE_2D,Dt,Yt,It.width,It.height,0,It.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):q?Bt&&i.texSubImage2D(o.TEXTURE_2D,Dt,0,0,It.width,It.height,Ft,$t,It.data):i.texImage2D(o.TEXTURE_2D,Dt,Yt,It.width,It.height,0,Ft,$t,It.data)}else if(E.isDataArrayTexture)if(q){if(Nt&&i.texStorage3D(o.TEXTURE_2D_ARRAY,Wt,Yt,Rt.width,Rt.height,Rt.depth),Bt)if(E.layerUpdates.size>0){const Dt=i0(Rt.width,Rt.height,E.format,E.type);for(const Et of E.layerUpdates){const Qt=Rt.data.subarray(Et*Dt/Rt.data.BYTES_PER_ELEMENT,(Et+1)*Dt/Rt.data.BYTES_PER_ELEMENT);i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,Et,Rt.width,Rt.height,1,Ft,$t,Qt)}E.clearLayerUpdates()}else i.texSubImage3D(o.TEXTURE_2D_ARRAY,0,0,0,0,Rt.width,Rt.height,Rt.depth,Ft,$t,Rt.data)}else i.texImage3D(o.TEXTURE_2D_ARRAY,0,Yt,Rt.width,Rt.height,Rt.depth,0,Ft,$t,Rt.data);else if(E.isData3DTexture)q?(Nt&&i.texStorage3D(o.TEXTURE_3D,Wt,Yt,Rt.width,Rt.height,Rt.depth),Bt&&i.texSubImage3D(o.TEXTURE_3D,0,0,0,0,Rt.width,Rt.height,Rt.depth,Ft,$t,Rt.data)):i.texImage3D(o.TEXTURE_3D,0,Yt,Rt.width,Rt.height,Rt.depth,0,Ft,$t,Rt.data);else if(E.isFramebufferTexture){if(Nt)if(q)i.texStorage2D(o.TEXTURE_2D,Wt,Yt,Rt.width,Rt.height);else{let Dt=Rt.width,Et=Rt.height;for(let Qt=0;Qt<Wt;Qt++)i.texImage2D(o.TEXTURE_2D,Qt,Yt,Dt,Et,0,Ft,$t,null),Dt>>=1,Et>>=1}}else if(de.length>0){if(q&&Nt){const Dt=Pt(de[0]);i.texStorage2D(o.TEXTURE_2D,Wt,Yt,Dt.width,Dt.height)}for(let Dt=0,Et=de.length;Dt<Et;Dt++)It=de[Dt],q?Bt&&i.texSubImage2D(o.TEXTURE_2D,Dt,0,0,Ft,$t,It):i.texImage2D(o.TEXTURE_2D,Dt,Yt,Ft,$t,It);E.generateMipmaps=!1}else if(q){if(Nt){const Dt=Pt(Rt);i.texStorage2D(o.TEXTURE_2D,Wt,Yt,Dt.width,Dt.height)}Bt&&i.texSubImage2D(o.TEXTURE_2D,0,0,0,Ft,$t,Rt)}else i.texImage2D(o.TEXTURE_2D,0,Yt,Ft,$t,Rt);M(E)&&g(Y),wt.__version=tt.version,E.onUpdate&&E.onUpdate(E)}C.__version=E.version}function St(C,E,V){if(E.image.length!==6)return;const Y=Ct(C,E),dt=E.source;i.bindTexture(o.TEXTURE_CUBE_MAP,C.__webglTexture,o.TEXTURE0+V);const tt=r.get(dt);if(dt.version!==tt.__version||Y===!0){i.activeTexture(o.TEXTURE0+V);const wt=Ue.getPrimaries(Ue.workingColorSpace),At=E.colorSpace===Fa?null:Ue.getPrimaries(E.colorSpace),kt=E.colorSpace===Fa||wt===At?o.NONE:o.BROWSER_DEFAULT_WEBGL;o.pixelStorei(o.UNPACK_FLIP_Y_WEBGL,E.flipY),o.pixelStorei(o.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),o.pixelStorei(o.UNPACK_ALIGNMENT,E.unpackAlignment),o.pixelStorei(o.UNPACK_COLORSPACE_CONVERSION_WEBGL,kt);const Xt=E.isCompressedTexture||E.image[0].isCompressedTexture,Rt=E.image[0]&&E.image[0].isDataTexture,Ft=[];for(let Et=0;Et<6;Et++)!Xt&&!Rt?Ft[Et]=b(E.image[Et],!0,l.maxCubemapSize):Ft[Et]=Rt?E.image[Et].image:E.image[Et],Ft[Et]=ft(E,Ft[Et]);const $t=Ft[0],Yt=u.convert(E.format,E.colorSpace),It=u.convert(E.type),de=P(E.internalFormat,Yt,It,E.colorSpace),q=E.isVideoTexture!==!0,Nt=tt.__version===void 0||Y===!0,Bt=dt.dataReady;let Wt=w(E,$t);Tt(o.TEXTURE_CUBE_MAP,E);let Dt;if(Xt){q&&Nt&&i.texStorage2D(o.TEXTURE_CUBE_MAP,Wt,de,$t.width,$t.height);for(let Et=0;Et<6;Et++){Dt=Ft[Et].mipmaps;for(let Qt=0;Qt<Dt.length;Qt++){const ue=Dt[Qt];E.format!==Ei?Yt!==null?q?Bt&&i.compressedTexSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,Qt,0,0,ue.width,ue.height,Yt,ue.data):i.compressedTexImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,Qt,de,ue.width,ue.height,0,ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):q?Bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,Qt,0,0,ue.width,ue.height,Yt,It,ue.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,Qt,de,ue.width,ue.height,0,Yt,It,ue.data)}}}else{if(Dt=E.mipmaps,q&&Nt){Dt.length>0&&Wt++;const Et=Pt(Ft[0]);i.texStorage2D(o.TEXTURE_CUBE_MAP,Wt,de,Et.width,Et.height)}for(let Et=0;Et<6;Et++)if(Rt){q?Bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,0,0,0,Ft[Et].width,Ft[Et].height,Yt,It,Ft[Et].data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,0,de,Ft[Et].width,Ft[Et].height,0,Yt,It,Ft[Et].data);for(let Qt=0;Qt<Dt.length;Qt++){const Oe=Dt[Qt].image[Et].image;q?Bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,Qt+1,0,0,Oe.width,Oe.height,Yt,It,Oe.data):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,Qt+1,de,Oe.width,Oe.height,0,Yt,It,Oe.data)}}else{q?Bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,0,0,0,Yt,It,Ft[Et]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,0,de,Yt,It,Ft[Et]);for(let Qt=0;Qt<Dt.length;Qt++){const ue=Dt[Qt];q?Bt&&i.texSubImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,Qt+1,0,0,Yt,It,ue.image[Et]):i.texImage2D(o.TEXTURE_CUBE_MAP_POSITIVE_X+Et,Qt+1,de,Yt,It,ue.image[Et])}}}M(E)&&g(o.TEXTURE_CUBE_MAP),tt.__version=dt.version,E.onUpdate&&E.onUpdate(E)}C.__version=E.version}function Ot(C,E,V,Y,dt,tt){const wt=u.convert(V.format,V.colorSpace),At=u.convert(V.type),kt=P(V.internalFormat,wt,At,V.colorSpace),Xt=r.get(E),Rt=r.get(V);if(Rt.__renderTarget=E,!Xt.__hasExternalTextures){const Ft=Math.max(1,E.width>>tt),$t=Math.max(1,E.height>>tt);dt===o.TEXTURE_3D||dt===o.TEXTURE_2D_ARRAY?i.texImage3D(dt,tt,kt,Ft,$t,E.depth,0,wt,At,null):i.texImage2D(dt,tt,kt,Ft,$t,0,wt,At,null)}i.bindFramebuffer(o.FRAMEBUFFER,C),j(E)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,Y,dt,Rt.__webglTexture,0,_t(E)):(dt===o.TEXTURE_2D||dt>=o.TEXTURE_CUBE_MAP_POSITIVE_X&&dt<=o.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&o.framebufferTexture2D(o.FRAMEBUFFER,Y,dt,Rt.__webglTexture,tt),i.bindFramebuffer(o.FRAMEBUFFER,null)}function ne(C,E,V){if(o.bindRenderbuffer(o.RENDERBUFFER,C),E.depthBuffer){const Y=E.depthTexture,dt=Y&&Y.isDepthTexture?Y.type:null,tt=L(E.stencilBuffer,dt),wt=E.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,At=_t(E);j(E)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,At,tt,E.width,E.height):V?o.renderbufferStorageMultisample(o.RENDERBUFFER,At,tt,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,tt,E.width,E.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,wt,o.RENDERBUFFER,C)}else{const Y=E.textures;for(let dt=0;dt<Y.length;dt++){const tt=Y[dt],wt=u.convert(tt.format,tt.colorSpace),At=u.convert(tt.type),kt=P(tt.internalFormat,wt,At,tt.colorSpace),Xt=_t(E);V&&j(E)===!1?o.renderbufferStorageMultisample(o.RENDERBUFFER,Xt,kt,E.width,E.height):j(E)?h.renderbufferStorageMultisampleEXT(o.RENDERBUFFER,Xt,kt,E.width,E.height):o.renderbufferStorage(o.RENDERBUFFER,kt,E.width,E.height)}}o.bindRenderbuffer(o.RENDERBUFFER,null)}function Zt(C,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(i.bindFramebuffer(o.FRAMEBUFFER,C),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=r.get(E.depthTexture);Y.__renderTarget=E,(!Y.__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),gt(E.depthTexture,0);const dt=Y.__webglTexture,tt=_t(E);if(E.depthTexture.format===Yo)j(E)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,dt,0,tt):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_ATTACHMENT,o.TEXTURE_2D,dt,0);else if(E.depthTexture.format===jo)j(E)?h.framebufferTexture2DMultisampleEXT(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,dt,0,tt):o.framebufferTexture2D(o.FRAMEBUFFER,o.DEPTH_STENCIL_ATTACHMENT,o.TEXTURE_2D,dt,0);else throw new Error("Unknown depthTexture format")}function he(C){const E=r.get(C),V=C.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==C.depthTexture){const Y=C.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),Y){const dt=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,Y.removeEventListener("dispose",dt)};Y.addEventListener("dispose",dt),E.__depthDisposeCallback=dt}E.__boundDepthTexture=Y}if(C.depthTexture&&!E.__autoAllocateDepthBuffer){if(V)throw new Error("target.depthTexture not supported in Cube render targets");const Y=C.texture.mipmaps;Y&&Y.length>0?Zt(E.__webglFramebuffer[0],C):Zt(E.__webglFramebuffer,C)}else if(V){E.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[Y]),E.__webglDepthbuffer[Y]===void 0)E.__webglDepthbuffer[Y]=o.createRenderbuffer(),ne(E.__webglDepthbuffer[Y],C,!1);else{const dt=C.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,tt=E.__webglDepthbuffer[Y];o.bindRenderbuffer(o.RENDERBUFFER,tt),o.framebufferRenderbuffer(o.FRAMEBUFFER,dt,o.RENDERBUFFER,tt)}}else{const Y=C.texture.mipmaps;if(Y&&Y.length>0?i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer[0]):i.bindFramebuffer(o.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=o.createRenderbuffer(),ne(E.__webglDepthbuffer,C,!1);else{const dt=C.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,tt=E.__webglDepthbuffer;o.bindRenderbuffer(o.RENDERBUFFER,tt),o.framebufferRenderbuffer(o.FRAMEBUFFER,dt,o.RENDERBUFFER,tt)}}i.bindFramebuffer(o.FRAMEBUFFER,null)}function Qe(C,E,V){const Y=r.get(C);E!==void 0&&Ot(Y.__webglFramebuffer,C,C.texture,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,0),V!==void 0&&he(C)}function G(C){const E=C.texture,V=r.get(C),Y=r.get(E);C.addEventListener("dispose",B);const dt=C.textures,tt=C.isWebGLCubeRenderTarget===!0,wt=dt.length>1;if(wt||(Y.__webglTexture===void 0&&(Y.__webglTexture=o.createTexture()),Y.__version=E.version,d.memory.textures++),tt){V.__webglFramebuffer=[];for(let At=0;At<6;At++)if(E.mipmaps&&E.mipmaps.length>0){V.__webglFramebuffer[At]=[];for(let kt=0;kt<E.mipmaps.length;kt++)V.__webglFramebuffer[At][kt]=o.createFramebuffer()}else V.__webglFramebuffer[At]=o.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){V.__webglFramebuffer=[];for(let At=0;At<E.mipmaps.length;At++)V.__webglFramebuffer[At]=o.createFramebuffer()}else V.__webglFramebuffer=o.createFramebuffer();if(wt)for(let At=0,kt=dt.length;At<kt;At++){const Xt=r.get(dt[At]);Xt.__webglTexture===void 0&&(Xt.__webglTexture=o.createTexture(),d.memory.textures++)}if(C.samples>0&&j(C)===!1){V.__webglMultisampledFramebuffer=o.createFramebuffer(),V.__webglColorRenderbuffer=[],i.bindFramebuffer(o.FRAMEBUFFER,V.__webglMultisampledFramebuffer);for(let At=0;At<dt.length;At++){const kt=dt[At];V.__webglColorRenderbuffer[At]=o.createRenderbuffer(),o.bindRenderbuffer(o.RENDERBUFFER,V.__webglColorRenderbuffer[At]);const Xt=u.convert(kt.format,kt.colorSpace),Rt=u.convert(kt.type),Ft=P(kt.internalFormat,Xt,Rt,kt.colorSpace,C.isXRRenderTarget===!0),$t=_t(C);o.renderbufferStorageMultisample(o.RENDERBUFFER,$t,Ft,C.width,C.height),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+At,o.RENDERBUFFER,V.__webglColorRenderbuffer[At])}o.bindRenderbuffer(o.RENDERBUFFER,null),C.depthBuffer&&(V.__webglDepthRenderbuffer=o.createRenderbuffer(),ne(V.__webglDepthRenderbuffer,C,!0)),i.bindFramebuffer(o.FRAMEBUFFER,null)}}if(tt){i.bindTexture(o.TEXTURE_CUBE_MAP,Y.__webglTexture),Tt(o.TEXTURE_CUBE_MAP,E);for(let At=0;At<6;At++)if(E.mipmaps&&E.mipmaps.length>0)for(let kt=0;kt<E.mipmaps.length;kt++)Ot(V.__webglFramebuffer[At][kt],C,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+At,kt);else Ot(V.__webglFramebuffer[At],C,E,o.COLOR_ATTACHMENT0,o.TEXTURE_CUBE_MAP_POSITIVE_X+At,0);M(E)&&g(o.TEXTURE_CUBE_MAP),i.unbindTexture()}else if(wt){for(let At=0,kt=dt.length;At<kt;At++){const Xt=dt[At],Rt=r.get(Xt);let Ft=o.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(Ft=C.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(Ft,Rt.__webglTexture),Tt(Ft,Xt),Ot(V.__webglFramebuffer,C,Xt,o.COLOR_ATTACHMENT0+At,Ft,0),M(Xt)&&g(Ft)}i.unbindTexture()}else{let At=o.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(At=C.isWebGL3DRenderTarget?o.TEXTURE_3D:o.TEXTURE_2D_ARRAY),i.bindTexture(At,Y.__webglTexture),Tt(At,E),E.mipmaps&&E.mipmaps.length>0)for(let kt=0;kt<E.mipmaps.length;kt++)Ot(V.__webglFramebuffer[kt],C,E,o.COLOR_ATTACHMENT0,At,kt);else Ot(V.__webglFramebuffer,C,E,o.COLOR_ATTACHMENT0,At,0);M(E)&&g(At),i.unbindTexture()}C.depthBuffer&&he(C)}function Ne(C){const E=C.textures;for(let V=0,Y=E.length;V<Y;V++){const dt=E[V];if(M(dt)){const tt=z(C),wt=r.get(dt).__webglTexture;i.bindTexture(tt,wt),g(tt),i.unbindTexture()}}}const fe=[],ae=[];function N(C){if(C.samples>0){if(j(C)===!1){const E=C.textures,V=C.width,Y=C.height;let dt=o.COLOR_BUFFER_BIT;const tt=C.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT,wt=r.get(C),At=E.length>1;if(At)for(let Xt=0;Xt<E.length;Xt++)i.bindFramebuffer(o.FRAMEBUFFER,wt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Xt,o.RENDERBUFFER,null),i.bindFramebuffer(o.FRAMEBUFFER,wt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Xt,o.TEXTURE_2D,null,0);i.bindFramebuffer(o.READ_FRAMEBUFFER,wt.__webglMultisampledFramebuffer);const kt=C.texture.mipmaps;kt&&kt.length>0?i.bindFramebuffer(o.DRAW_FRAMEBUFFER,wt.__webglFramebuffer[0]):i.bindFramebuffer(o.DRAW_FRAMEBUFFER,wt.__webglFramebuffer);for(let Xt=0;Xt<E.length;Xt++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(dt|=o.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(dt|=o.STENCIL_BUFFER_BIT)),At){o.framebufferRenderbuffer(o.READ_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.RENDERBUFFER,wt.__webglColorRenderbuffer[Xt]);const Rt=r.get(E[Xt]).__webglTexture;o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0,o.TEXTURE_2D,Rt,0)}o.blitFramebuffer(0,0,V,Y,0,0,V,Y,dt,o.NEAREST),m===!0&&(fe.length=0,ae.length=0,fe.push(o.COLOR_ATTACHMENT0+Xt),C.depthBuffer&&C.resolveDepthBuffer===!1&&(fe.push(tt),ae.push(tt),o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,ae)),o.invalidateFramebuffer(o.READ_FRAMEBUFFER,fe))}if(i.bindFramebuffer(o.READ_FRAMEBUFFER,null),i.bindFramebuffer(o.DRAW_FRAMEBUFFER,null),At)for(let Xt=0;Xt<E.length;Xt++){i.bindFramebuffer(o.FRAMEBUFFER,wt.__webglMultisampledFramebuffer),o.framebufferRenderbuffer(o.FRAMEBUFFER,o.COLOR_ATTACHMENT0+Xt,o.RENDERBUFFER,wt.__webglColorRenderbuffer[Xt]);const Rt=r.get(E[Xt]).__webglTexture;i.bindFramebuffer(o.FRAMEBUFFER,wt.__webglFramebuffer),o.framebufferTexture2D(o.DRAW_FRAMEBUFFER,o.COLOR_ATTACHMENT0+Xt,o.TEXTURE_2D,Rt,0)}i.bindFramebuffer(o.DRAW_FRAMEBUFFER,wt.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&m){const E=C.stencilBuffer?o.DEPTH_STENCIL_ATTACHMENT:o.DEPTH_ATTACHMENT;o.invalidateFramebuffer(o.DRAW_FRAMEBUFFER,[E])}}}function _t(C){return Math.min(l.maxSamples,C.samples)}function j(C){const E=r.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function vt(C){const E=d.render.frame;_.get(C)!==E&&(_.set(C,E),C.update())}function ft(C,E){const V=C.colorSpace,Y=C.format,dt=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||V!==Us&&V!==Fa&&(Ue.getTransfer(V)===Ge?(Y!==Ei||dt!==sa)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",V)),E}function Pt(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(p.width=C.naturalWidth||C.width,p.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(p.width=C.displayWidth,p.height=C.displayHeight):(p.width=C.width,p.height=C.height),p}this.allocateTextureUnit=mt,this.resetTextureUnits=ot,this.setTexture2D=gt,this.setTexture2DArray=I,this.setTexture3D=it,this.setTextureCube=K,this.rebindTextures=Qe,this.setupRenderTarget=G,this.updateRenderTargetMipmap=Ne,this.updateMultisampleRenderTarget=N,this.setupDepthRenderbuffer=he,this.setupFrameBufferTexture=Ot,this.useMultisampledRTT=j}function A1(o,t){function i(r,l=Fa){let u;const d=Ue.getTransfer(l);if(r===sa)return o.UNSIGNED_BYTE;if(r===Uh)return o.UNSIGNED_SHORT_4_4_4_4;if(r===Lh)return o.UNSIGNED_SHORT_5_5_5_1;if(r===P0)return o.UNSIGNED_INT_5_9_9_9_REV;if(r===B0)return o.UNSIGNED_INT_10F_11F_11F_REV;if(r===N0)return o.BYTE;if(r===O0)return o.SHORT;if(r===Wo)return o.UNSIGNED_SHORT;if(r===Dh)return o.INT;if(r===Sr)return o.UNSIGNED_INT;if(r===Bi)return o.FLOAT;if(r===Ko)return o.HALF_FLOAT;if(r===I0)return o.ALPHA;if(r===z0)return o.RGB;if(r===Ei)return o.RGBA;if(r===Yo)return o.DEPTH_COMPONENT;if(r===jo)return o.DEPTH_STENCIL;if(r===Nh)return o.RED;if(r===Oh)return o.RED_INTEGER;if(r===F0)return o.RG;if(r===Ph)return o.RG_INTEGER;if(r===Bh)return o.RGBA_INTEGER;if(r===Bc||r===Ic||r===zc||r===Fc)if(d===Ge)if(u=t.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(r===Bc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(r===Ic)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(r===zc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(r===Fc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=t.get("WEBGL_compressed_texture_s3tc"),u!==null){if(r===Bc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(r===Ic)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(r===zc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(r===Fc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(r===Kd||r===Qd||r===Jd||r===$d)if(u=t.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(r===Kd)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(r===Qd)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(r===Jd)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(r===$d)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(r===th||r===eh||r===nh)if(u=t.get("WEBGL_compressed_texture_etc"),u!==null){if(r===th||r===eh)return d===Ge?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(r===nh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(r===ih||r===ah||r===rh||r===sh||r===oh||r===lh||r===ch||r===uh||r===fh||r===dh||r===hh||r===ph||r===mh||r===gh)if(u=t.get("WEBGL_compressed_texture_astc"),u!==null){if(r===ih)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(r===ah)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(r===rh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(r===sh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(r===oh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(r===lh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(r===ch)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(r===uh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(r===fh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(r===dh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(r===hh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(r===ph)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(r===mh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(r===gh)return d===Ge?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(r===_h||r===vh||r===xh)if(u=t.get("EXT_texture_compression_bptc"),u!==null){if(r===_h)return d===Ge?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(r===vh)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(r===xh)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(r===yh||r===Sh||r===Mh||r===Eh)if(u=t.get("EXT_texture_compression_rgtc"),u!==null){if(r===yh)return u.COMPRESSED_RED_RGTC1_EXT;if(r===Sh)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(r===Mh)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(r===Eh)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return r===qo?o.UNSIGNED_INT_24_8:o[r]!==void 0?o[r]:null}return{convert:i}}const R1=`
void main() {
...
}`;class w1{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(t,i){if(this.texture===null){const r=new $0(t.texture);(t.depthNear!==i.depthNear||t.depthFar!==i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(t){if(this.texture!==null&&this.mesh===null){const i=t.cameras[0].viewport,r=new Xa({vertexShader:R1,fragmentShader:C1,uniforms:{depthColor:{value:this.texture},depthWidth:{value:i.z},depthHeight:{value:i.w}}});this.mesh=new Un(new $o(20,20),r)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class D1 extends Ns{constructor(t,i){super();const r=this;let l=null,u=1,d=null,h="local-floor",m=1,p=null,_=null,x=null,y=null,v=null,T=null;const b=typeof XRWebGLBinding<"u",M=new w1,g={},z=i.getContextAttributes();let P=null,L=null;const w=[],H=[],B=new Te;let J=null;const D=new Si;D.viewport=new rn;const U=new Si;U.viewport=new rn;const X=[D,U],ot=new KS;let mt=null,ct=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(st){let St=w[st];return St===void 0&&(St=new Rd,w[st]=St),St.getTargetRaySpace()},this.getControllerGrip=function(st){let St=w[st];return St===void 0&&(St=new Rd,w[st]=St),St.getGripSpace()},this.getHand=function(st){let St=w[st];return St===void 0&&(St=new Rd,w[st]=St),St.getHandSpace()};function gt(st){const St=H.indexOf(st.inputSource);if(St===-1)return;const Ot=w[St];Ot!==void 0&&(Ot.update(st.inputSource,st.frame,p||d),Ot.dispatchEvent({type:st.type,data:st.inputSource}))}function I(){l.removeEventListener("select",gt),l.removeEventListener("selectstart",gt),l.removeEventListener("selectend",gt),l.removeEventListener("squeeze",gt),l.removeEventListener("squeezestart",gt),l.removeEventListener("squeezeend",gt),l.removeEventListener("end",I),l.removeEventListener("inputsourceschange",it);for(let st=0;st<w.length;st++){const St=H[st];St!==null&&(H[st]=null,w[st].disconnect(St))}mt=null,ct=null,M.reset();for(const st in g)delete g[st];t.setRenderTarget(P),v=null,y=null,x=null,l=null,L=null,qt.stop(),r.isPresenting=!1,t.setPixelRatio(J),t.setSize(B.width,B.height,!1),r.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(st){u=st,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(st){h=st,r.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return p||d},this.setReferenceSpace=function(st){p=st},this.getBaseLayer=function(){return y!==null?y:v},this.getBinding=function(){return x===null&&b&&(x=new XRWebGLBinding(l,i)),x},this.getFrame=function(){return T},this.getSession=function(){return l},this.setSession=async function(st){if(l=st,l!==null){if(P=t.getRenderTarget(),l.addEventListener("select",gt),l.addEventListener("selectstart",gt),l.addEventListener("selectend",gt),l.addEventListener("squeeze",gt),l.addEventListener("squeezestart",gt),l.addEventListener("squeezeend",gt),l.addEventListener("end",I),l.addEventListener("inputsourceschange",it),z.xrCompatible!==!0&&await i.makeXRCompatible(),J=t.getPixelRatio(),t.getSize(B),b&&"createProjectionLayer"in XRWebGLBinding.prototype){let Ot=null,ne=null,Zt=null;z.depth&&(Zt=z.stencil?i.DEPTH24_STENCIL8:i.DEPTH_COMPONENT24,Ot=z.stencil?jo:Yo,ne=z.stencil?qo:Sr);const he={colorFormat:i.RGBA8,depthFormat:Zt,scaleFactor:u};x=this.getBinding(),y=x.createProjectionLayer(he),l.updateRenderState({layers:[y]}),t.setPixelRatio(1),t.setSize(y.textureWidth,y.textureHeight,!1),L=new Mr(y.textureWidth,y.textureHeight,{format:Ei,type:sa,depthTexture:new J0(y.textureWidth,y.textureHeight,ne,void 0,void 0,void 0,void 0,void 0,void 0,Ot),stencilBuffer:z.stencil,colorSpace:t.outputColorSpace,samples:z.antialias?4:0,resolveDepthBuffer:y.ignoreDepthValues===!1,resolveStencilBuffer:y.ignoreDepthValues===!1})}else{const Ot={antialias:z.antialias,alpha:!0,depth:z.depth,stencil:z.stencil,framebufferScaleFactor:u};v=new XRWebGLLayer(l,i,Ot),l.updateRenderState({baseLayer:v}),t.setPixelRatio(1),t.setSize(v.framebufferWidth,v.framebufferHeight,!1),L=new Mr(v.framebufferWidth,v.framebufferHeight,{format:Ei,type:sa,colorSpace:t.outputColorSpace,stencilBuffer:z.stencil,resolveDepthBuffer:v.ignoreDepthValues===!1,resolveStencilBuffer:v.ignoreDepthValues===!1})}L.isXRRenderTarget=!0,this.setFoveation(m),p=null,d=await l.requestReferenceSpace(h),qt.setContext(l),qt.start(),r.isPresenting=!0,r.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(l!==null)return l.environmentBlendMode},this.getDepthTexture=function(){return M.getDepthTexture()};function it(st){for(let St=0;St<st.removed.length;St++){const Ot=st.removed[St],ne=H.indexOf(Ot);ne>=0&&(H[ne]=null,w[ne].disconnect(Ot))}for(let St=0;St<st.added.length;St++){const Ot=st.added[St];let ne=H.indexOf(Ot);if(ne===-1){for(let he=0;he<w.length;he++)if(he>=H.length){H.push(Ot),ne=he;break}else if(H[he]===null){H[he]=Ot,ne=he;break}if(ne===-1)break}const Zt=w[ne];Zt&&Zt.connect(Ot)}}const K=new nt,bt=new nt;function O(st,St,Ot){K.setFromMatrixPosition(St.matrixWorld),bt.setFromMatrixPosition(Ot.matrixWorld);const ne=K.distanceTo(bt),Zt=St.projectionMatrix.elements,he=Ot.projectionMatrix.elements,Qe=Zt[14]/(Zt[10]-1),G=Zt[14]/(Zt[10]+1),Ne=(Zt[9]+1)/Zt[5],fe=(Zt[9]-1)/Zt[5],ae=(Zt[8]-1)/Zt[0],N=(he[8]+1)/he[0],_t=Qe*ae,j=Qe*N,vt=ne/(-ae+N),ft=vt*-ae;if(St.matrixWorld.decompose(st.position,st.quaternion,st.scale),st.translateX(ft),st.translateZ(vt),st.matrixWorld.compose(st.position,st.quaternion,st.scale),st.matrixWorldInverse.copy(st.matrixWorld).invert(),Zt[10]===-1)st.projectionMatrix.copy(St.projectionMatrix),st.projectionMatrixInverse.copy(St.projectionMatrixInverse);else{const Pt=Qe+vt,C=G+vt,E=_t-ft,V=j+(ne-ft),Y=Ne*G/C*Pt,dt=fe*G/C*Pt;st.projectionMatrix.makePerspective(E,V,Y,dt,Pt,C),st.projectionMatrixInverse.copy(st.projectionMatrix).invert()}}function rt(st,St){St===null?st.matrixWorld.copy(st.matrix):st.matrixWorld.multiplyMatrices(St.matrixWorld,st.matrix),st.matrixWorldInverse.copy(st.matrixWorld).invert()}this.updateCamera=function(st){if(l===null)return;let St=st.near,Ot=st.far;M.texture!==null&&(M.depthNear>0&&(St=M.depthNear),M.depthFar>0&&(Ot=M.depthFar)),ot.near=U.near=D.near=St,ot.far=U.far=D.far=Ot,(mt!==ot.near||ct!==ot.far)&&(l.updateRenderState({depthNear:ot.near,depthFar:ot.far}),mt=ot.near,ct=ot.far),ot.layers.mask=st.layers.mask|6,D.layers.mask=ot.layers.mask&3,U.layers.mask=ot.layers.mask&5;const ne=st.parent,Zt=ot.cameras;rt(ot,ne);for(let he=0;he<Zt.length;he++)rt(Zt[he],ne);Zt.length===2?O(ot,D,U):ot.projectionMatrix.copy(D.projectionMatrix),Tt(st,ot,ne)};function Tt(st,St,Ot){Ot===null?st.matrix.copy(St.matrixWorld):(st.matrix.copy(Ot.matrixWorld),st.matrix.invert(),st.matrix.multiply(St.matrixWorld)),st.matrix.decompose(st.position,st.quaternion,st.scale),st.updateMatrixWorld(!0),st.projectionMatrix.copy(St.projectionMatrix),st.projectionMatrixInverse.copy(St.projectionMatrixInverse),st.isPerspectiveCamera&&(st.fov=Th*2*Math.atan(1/st.projectionMatrix.elements[5]),st.zoom=1)}this.getCamera=function(){return ot},this.getFoveation=function(){if(!(y===null&&v===null))return m},this.setFoveation=function(st){m=st,y!==null&&(y.fixedFoveation=st),v!==null&&v.fixedFoveation!==void 0&&(v.fixedFoveation=st)},this.hasDepthSensing=function(){return M.texture!==null},this.getDepthSensingMesh=function(){return M.getMesh(ot)},this.getCameraTexture=function(st){return g[st]};let Ct=null;function zt(st,St){if(_=St.getViewerPose(p||d),T=St,_!==null){const Ot=_.views;v!==null&&(t.setRenderTargetFramebuffer(L,v.framebuffer),t.setRenderTarget(L));let ne=!1;Ot.length!==ot.cameras.length&&(ot.cameras.length=0,ne=!0);for(let G=0;G<Ot.length;G++){const Ne=Ot[G];let fe=null;if(v!==null)fe=v.getViewport(Ne);else{const N=x.getViewSubImage(y,Ne);fe=N.viewport,G===0&&(t.setRenderTargetTextures(L,N.colorTexture,N.depthStencilTexture),t.setRenderTarget(L))}let ae=X[G];ae===void 0&&(ae=new Si,ae.layers.enable(G),ae.viewport=new rn,X[G]=ae),ae.matrix.fromArray(Ne.transform.matrix),ae.matrix.decompose(ae.position,ae.quaternion,ae.scale),ae.projectionMatrix.fromArray(Ne.projectionMatrix),ae.projectionMatrixInverse.copy(ae.projectionMatrix).invert(),ae.viewport.set(fe.x,fe.y,fe.width,fe.height),G===0&&(ot.matrix.copy(ae.matrix),ot.matrix.decompose(ot.position,ot.quaternion,ot.scale)),ne===!0&&ot.cameras.push(ae)}const Zt=l.enabledFeatures;if(Zt&&Zt.includes("depth-sensing")&&l.depthUsage=="gpu-optimized"&&b){x=r.getBinding();const G=x.getDepthInformation(Ot[0]);G&&G.isValid&&G.texture&&M.init(G,l.renderState)}if(Zt&&Zt.includes("camera-access")&&b){t.state.unbindTexture(),x=r.getBinding();for(let G=0;G<Ot.length;G++){const Ne=Ot[G].camera;if(Ne){let fe=g[Ne];fe||(fe=new $0,g[Ne]=fe);const ae=x.getCameraImage(Ne);fe.sourceTexture=ae}}}}for(let Ot=0;Ot<w.length;Ot++){const ne=H[Ot],Zt=w[Ot];ne!==null&&Zt!==void 0&&Zt.update(ne,St,p||d)}Ct&&Ct(st,St),St.detectedPlanes&&r.dispatchEvent({type:"planesdetected",data:St}),T=null}const qt=new ev;qt.setAnimationLoop(zt),this.setAnimationLoop=function(st){Ct=st},this.dispose=function(){}}}const hr=new oa,U1=new Ye;function L1(o,t){function i(M,g){M.matrixAutoUpdate===!0&&M.updateMatrix(),g.value.copy(M.matrix)}function r(M,g){g.color.getRGB(M.fogColor.value,q0(o)),g.isFog?(M.fogNear.value=g.near,M.fogFar.value=g.far):g.isFogExp2&&(M.fogDensity.value=g.density)}function l(M,g,z,P,L){g.isMeshBasicMaterial||g.isMeshLambertMaterial?u(M,g):g.isMeshToonMaterial?(u(M,g),x(M,g)):g.isMeshPhongMaterial?(u(M,g),_(M,g)):g.isMeshStandardMaterial?(u(M,g),y(M,g),g.isMeshPhysicalMaterial&&v(M,g,L)):g.isMeshMatcapMaterial?(u(M,g),T(M,g)):g.isMeshDepthMaterial?u(M,g):g.isMeshDistanceMaterial?(u(M,g),b(M,g)):g.isMeshNormalMaterial?u(M,g):g.isLineBasicMaterial?(d(M,g),g.isLineDashedMaterial&&h(M,g)):g.isPointsMaterial?m(M,g,z,P):g.isSpriteMaterial?p(M,g):g.isShadowMaterial?(M.color.value.copy(g.color),M.opacity.value=g.opacity):g.isShaderMaterial&&(g.uniformsNeedUpdate=!1)}function u(M,g){M.opacity.value=g.opacity,g.color&&M.diffuse.value.copy(g.color),g.emissive&&M.emissive.value.copy(g.emissive).multiplyScalar(g.emissiveIntensity),g.map&&(M.map.value=g.map,i(g.map,M.mapTransform)),g.alphaMap&&(M.alphaMap.value=g.alphaMap,i(g.alphaMap,M.alphaMapTransform)),g.bumpMap&&(M.bumpMap.value=g.bumpMap,i(g.bumpMap,M.bumpMapTransform),M.bumpScale.value=g.bumpScale,g.side===qn&&(M.bumpScale.value*=-1)),g.normalMap&&(M.normalMap.value=g.normalMap,i(g.normalMap,M.normalMapTransform),M.normalScale.value.copy(g.normalScale),g.side===qn&&M.normalScale.value.negate()),g.displacementMap&&(M.displacementMap.value=g.displacementMap,i(g.displacementMap,M.displacementMapTransform),M.displacementScale.value=g.displacementScale,M.displacementBias.value=g.displacementBias),g.emissiveMap&&(M.emissiveMap.value=g.emissiveMap,i(g.emissiveMap,M.emissiveMapTransform)),g.specularMap&&(M.specularMap.value=g.specularMap,i(g.specularMap,M.specularMapTransform)),g.alphaTest>0&&(M.alphaTest.value=g.alphaTest);const z=t.get(g),P=z.envMap,L=z.envMapRotation;P&&(M.envMap.value=P,hr.copy(L),hr.x*=-1,hr.y*=-1,hr.z*=-1,P.isCubeTexture&&P.isRenderTargetTexture===!1&&(hr.y*=-1,hr.z*=-1),M.envMapRotation.value.setFromMatrix4(U1.makeRotationFromEuler(hr)),M.flipEnvMap.value=P.isCubeTexture&&P.isRenderTargetTexture===!1?-1:1,M.reflectivity.value=g.reflectivity,M.ior.value=g.ior,M.refractionRatio.value=g.refractionRatio),g.lightMap&&(M.lightMap.value=g.lightMap,M.lightMapIntensity.value=g.lightMapIntensity,i(g.lightMap,M.lightMapTransform)),g.aoMap&&(M.aoMap.value=g.aoMap,M.aoMapIntensity.value=g.aoMapIntensity,i(g.aoMap,M.aoMapTransform))}function d(M,g){M.diffuse.value.copy(g.color),M.opacity.value=g.opacity,g.map&&(M.map.value=g.map,i(g.map,M.mapTransform))}function h(M,g){M.dashSize.value=g.dashSize,M.totalSize.value=g.dashSize+g.gapSize,M.scale.value=g.scale}function m(M,g,z,P){M.diffuse.value.copy(g.color),M.opacity.value=g.opacity,M.size.value=g.size*z,M.scale.value=P*.5,g.map&&(M.map.value=g.map,i(g.map,M.uvTransform)),g.alphaMap&&(M.alphaMap.value=g.alphaMap,i(g.alphaMap,M.alphaMapTransform)),g.alphaTest>0&&(M.alphaTest.value=g.alphaTest)}function p(M,g){M.diffuse.value.copy(g.color),M.opacity.value=g.opacity,M.rotation.value=g.rotation,g.map&&(M.map.value=g.map,i(g.map,M.mapTransform)),g.alphaMap&&(M.alphaMap.value=g.alphaMap,i(g.alphaMap,M.alphaMapTransform)),g.alphaTest>0&&(M.alphaTest.value=g.alphaTest)}function _(M,g){M.specular.value.copy(g.specular),M.shininess.value=Math.max(g.shininess,1e-4)}function x(M,g){g.gradientMap&&(M.gradientMap.value=g.gradientMap)}function y(M,g){M.metalness.value=g.metalness,g.metalnessMap&&(M.metalnessMap.value=g.metalnessMap,i(g.metalnessMap,M.metalnessMapTransform)),M.roughness.value=g.roughness,g.roughnessMap&&(M.roughnessMap.value=g.roughnessMap,i(g.roughnessMap,M.roughnessMapTransform)),g.envMap&&(M.envMapIntensity.value=g.envMapIntensity)}function v(M,g,z){M.ior.value=g.ior,g.sheen>0&&(M.sheenColor.value.copy(g.sheenColor).multiplyScalar(g.sheen),M.sheenRoughness.value=g.sheenRoughness,g.sheenColorMap&&(M.sheenColorMap.value=g.sheenColorMap,i(g.sheenColorMap,M.sheenColorMapTransform)),g.sheenRoughnessMap&&(M.sheenRoughnessMap.value=g.sheenRoughnessMap,i(g.sheenRoughnessMap,M.sheenRoughnessMapTransform))),g.clearcoat>0&&(M.clearcoat.value=g.clearcoat,M.clearcoatRoughness.value=g.clearcoatRoughness,g.clearcoatMap&&(M.clearcoatMap.value=g.clearcoatMap,i(g.clearcoatMap,M.clearcoatMapTransform)),g.clearcoatRoughnessMap&&(M.clearcoatRoughnessMap.value=g.clearcoatRoughnessMap,i(g.clearcoatRoughnessMap,M.clearcoatRoughnessMapTransform)),g.clearcoatNormalMap&&(M.clearcoatNormalMap.value=g.clearcoatNormalMap,i(g.clearcoatNormalMap,M.clearcoatNormalMapTransform),M.clearcoatNormalScale.value.copy(g.clearcoatNormalScale),g.side===qn&&M.clearcoatNormalScale.value.negate())),g.dispersion>0&&(M.dispersion.value=g.dispersion),g.iridescence>0&&(M.iridescence.value=g.iridescence,M.iridescenceIOR.value=g.iridescenceIOR,M.iridescenceThicknessMinimum.value=g.iridescenceThicknessRange[0],M.iridescenceThicknessMaximum.value=g.iridescenceThicknessRange[1],g.iridescenceMap&&(M.iridescenceMap.value=g.iridescenceMap,i(g.iridescenceMap,M.iridescenceMapTransform)),g.iridescenceThicknessMap&&(M.iridescenceThicknessMap.value=g.iridescenceThicknessMap,i(g.iridescenceThicknessMap,M.iridescenceThicknessMapTransform))),g.transmission>0&&(M.transmission.value=g.transmission,M.transmissionSamplerMap.value=z.texture,M.transmissionSamplerSize.value.set(z.width,z.height),g.transmissionMap&&(M.transmissionMap.value=g.transmissionMap,i(g.transmissionMap,M.transmissionMapTransform)),M.thickness.value=g.thickness,g.thicknessMap&&(M.thicknessMap.value=g.thicknessMap,i(g.thicknessMap,M.thicknessMapTransform)),M.attenuationDistance.value=g.attenuationDistance,M.attenuationColor.value.copy(g.attenuationColor)),g.anisotropy>0&&(M.anisotropyVector.value.set(g.anisotropy*Math.cos(g.anisotropyRotation),g.anisotropy*Math.sin(g.anisotropyRotation)),g.anisotropyMap&&(M.anisotropyMap.value=g.anisotropyMap,i(g.anisotropyMap,M.anisotropyMapTransform))),M.specularIntensity.value=g.specularIntensity,M.specularColor.value.copy(g.specularColor),g.specularColorMap&&(M.specularColorMap.value=g.specularColorMap,i(g.specularColorMap,M.specularColorMapTransform)),g.specularIntensityMap&&(M.specularIntensityMap.value=g.specularIntensityMap,i(g.specularIntensityMap,M.specularIntensityMapTransform))}function T(M,g){g.matcap&&(M.matcap.value=g.matcap)}function b(M,g){const z=t.get(g).light;M.referencePosition.value.setFromMatrixPosition(z.matrixWorld),M.nearDistance.value=z.shadow.camera.near,M.farDistance.value=z.shadow.camera.far}return{refreshFogUniforms:r,refreshMaterialUniforms:l}}function N1(o,t,i,r){let l={},u={},d=[];const h=o.getParameter(o.MAX_UNIFORM_BUFFER_BINDINGS);function m(z,P){const L=P.program;r.uniformBlockBinding(z,L)}function p(z,P){let L=l[z.id];L===void 0&&(T(z),L=_(z),l[z.id]=L,z.addEventListener("dispose",M));const w=P.program;r.updateUBOMapping(z,w);const H=t.render.frame;u[z.id]!==H&&(y(z),u[z.id]=H)}function _(z){const P=x();z.__bindingPointIndex=P;const L=o.createBuffer(),w=z.__size,H=z.usage;return o.bindBuffer(o.UNIFORM_BUFFER,L),o.bufferData(o.UNIFORM_BUFFER,w,H),o.bindBuffer(o.UNIFORM_BUFFER,null),o.bindBufferBase(o.UNIFORM_BUFFER,P,L),L}function x(){for(let z=0;z<h;z++)if(d.indexOf(z)===-1)return d.push(z),z;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function y(z){const P=l[z.id],L=z.uniforms,w=z.__cache;o.bindBuffer(o.UNIFORM_BUFFER,P);for(let H=0,B=L.length;H<B;H++){const J=Array.isArray(L[H])?L[H]:[L[H]];for(let D=0,U=J.length;D<U;D++){const X=J[D];if(v(X,H,D,w)===!0){const ot=X.__offset,mt=Array.isArray(X.value)?X.value:[X.value];let ct=0;for(let gt=0;gt<mt.length;gt++){const I=mt[gt],it=b(I);typeof I=="number"||typeof I=="boolean"?(X.__data[0]=I,o.bufferSubData(o.UNIFORM_BUFFER,ot+ct,X.__data)):I.isMatrix3?(X.__data[0]=I.elements[0],X.__data[1]=I.elements[1],X.__data[2]=I.elements[2],X.__data[3]=0,X.__data[4]=I.elements[3],X.__data[5]=I.elements[4],X.__data[6]=I.elements[5],X.__data[7]=0,X.__data[8]=I.elements[6],X.__data[9]=I.elements[7],X.__data[10]=I.elements[8],X.__data[11]=0):(I.toArray(X.__data,ct),ct+=it.storage/Float32Array.BYTES_PER_ELEMENT)}o.bufferSubData(o.UNIFORM_BUFFER,ot,X.__data)}}}o.bindBuffer(o.UNIFORM_BUFFER,null)}function v(z,P,L,w){const H=z.value,B=P+"_"+L;if(w[B]===void 0)return typeof H=="number"||typeof H=="boolean"?w[B]=H:w[B]=H.clone(),!0;{const J=w[B];if(typeof H=="number"||typeof H=="boolean"){if(J!==H)return w[B]=H,!0}else if(J.equals(H)===!1)return J.copy(H),!0}return!1}function T(z){const P=z.uniforms;let L=0;const w=16;for(let B=0,J=P.length;B<J;B++){const D=Array.isArray(P[B])?P[B]:[P[B]];for(let U=0,X=D.length;U<X;U++){const ot=D[U],mt=Array.isArray(ot.value)?ot.value:[ot.value];for(let ct=0,gt=mt.length;ct<gt;ct++){const I=mt[ct],it=b(I),K=L%w,bt=K%it.boundary,O=K+bt;L+=bt,O!==0&&w-O<it.storage&&(L+=w-O),ot.__data=new Float32Array(it.storage/Float32Array.BYTES_PER_ELEMENT),ot.__offset=L,L+=it.storage}}}const H=L%w;return H>0&&(L+=w-H),z.__size=L,z.__cache={},this}function b(z){const P={boundary:0,storage:0};return typeof z=="number"||typeof z=="boolean"?(P.boundary=4,P.storage=4):z.isVector2?(P.boundary=8,P.storage=8):z.isVector3||z.isColor?(P.boundary=16,P.storage=12):z.isVector4?(P.boundary=16,P.storage=16):z.isMatrix3?(P.boundary=48,P.storage=48):z.isMatrix4?(P.boundary=64,P.storage=64):z.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",z),P}function M(z){const P=z.target;P.removeEventListener("dispose",M);const L=d.indexOf(P.__bindingPointIndex);d.splice(L,1),o.deleteBuffer(l[P.id]),delete l[P.id],delete u[P.id]}function g(){for(const z in l)o.deleteBuffer(l[z]);d=[],l={},u={}}return{bind:m,update:p,dispose:g}}class O1{constructor(t={}){const{canvas:i=dS(),context:r=null,depth:l=!0,stencil:u=!1,alpha:d=!1,antialias:h=!1,premultipliedAlpha:m=!0,preserveDrawingBuffer:p=!1,powerPreference:_="default",failIfMajorPerformanceCaveat:x=!1,reversedDepthBuffer:y=!1}=t;this.isWebGLRenderer=!0;let v;if(r!==null){if(typeof WebGLRenderingContext<"u"&&r instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=r.getContextAttributes().alpha}else v=d;const T=new Uint32Array(4),b=new Int32Array(4);let M=null,g=null;const z=[],P=[];this.domElement=i,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Ga,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const L=this;let w=!1;this._outputColorSpace=fi;let H=0,B=0,J=null,D=-1,U=null;const X=new rn,ot=new rn;let mt=null;const ct=new xe(0);let gt=0,I=i.width,it=i.height,K=1,bt=null,O=null;const rt=new rn(0,0,I,it),Tt=new rn(0,0,I,it);let Ct=!1;const zt=new Q0;let qt=!1,st=!1;const St=new Ye,Ot=new nt,ne=new rn,Zt={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let he=!1;function Qe(){return J===null?K:1}let G=r;function Ne(R,Z){return i.getContext(R,Z)}try{const R={alpha:!0,depth:l,stencil:u,antialias:h,premultipliedAlpha:m,preserveDrawingBuffer:p,powerPreference:_,failIfMajorPerformanceCaveat:x};if("setAttribute"in i&&i.setAttribute("data-engine",`three.js r${wh}`),i.addEventListener("webglcontextlost",Bt,!1),i.addEventListener("webglcontextrestored",Wt,!1),i.addEventListener("webglcontextcreationerror",Dt,!1),G===null){const Z="webgl2";if(G=Ne(Z,R),G===null)throw Ne(Z)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(R){throw console.error("THREE.WebGLRenderer: "+R.message),R}let fe,ae,N,_t,j,vt,ft,Pt,C,E,V,Y,dt,tt,wt,At,kt,Xt,Rt,Ft,$t,Yt,It,de;function q(){fe=new Xb(G),fe.init(),Yt=new A1(G,fe),ae=new Ib(G,fe,t,Yt),N=new b1(G,fe),ae.reversedDepthBuffer&&y&&N.buffers.depth.setReversed(!0),_t=new Yb(G),j=new f1,vt=new T1(G,fe,N,j,ae,Yt,_t),ft=new Fb(L),Pt=new kb(L),C=new $S(G),It=new Pb(G,C),E=new Wb(G,C,_t,It),V=new Zb(G,E,C,_t),Rt=new jb(G,ae,vt),At=new zb(j),Y=new u1(L,ft,Pt,fe,ae,It,At),dt=new L1(L,j),tt=new h1,wt=new x1(fe),Xt=new Ob(L,ft,Pt,N,V,v,m),kt=new M1(L,V,ae),de=new N1(G,_t,ae,N),Ft=new Bb(G,fe,_t),$t=new qb(G,fe,_t),_t.programs=Y.programs,L.capabilities=ae,L.extensions=fe,L.properties=j,L.renderLists=tt,L.shadowMap=kt,L.state=N,L.info=_t}q();const Nt=new D1(L,G);this.xr=Nt,this.getContext=function(){return G},this.getContextAttributes=function(){return G.getContextAttributes()},this.forceContextLoss=function(){const R=fe.get("WEBGL_lose_context");R&&R.loseContext()},this.forceContextRestore=function(){const R=fe.get("WEBGL_lose_context");R&&R.restoreContext()},this.getPixelRatio=function(){return K},this.setPixelRatio=function(R){R!==void 0&&(K=R,this.setSize(I,it,!1))},this.getSize=function(R){return R.set(I,it)},this.setSize=function(R,Z,ht=!0){if(Nt.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}I=R,it=Z,i.width=Math.floor(R*K),i.height=Math.floor(Z*K),ht===!0&&(i.style.width=R+"px",i.style.height=Z+"px"),this.setViewport(0,0,R,Z)},this.getDrawingBufferSize=function(R){return R.set(I*K,it*K).floor()},this.setDrawingBufferSize=function(R,Z,ht){I=R,it=Z,K=ht,i.width=Math.floor(R*ht),i.height=Math.floor(Z*ht),this.setViewport(0,0,R,Z)},this.getCurrentViewport=function(R){return R.copy(X)},this.getViewport=function(R){return R.copy(rt)},this.setViewport=function(R,Z,ht,pt){R.isVector4?rt.set(R.x,R.y,R.z,R.w):rt.set(R,Z,ht,pt),N.viewport(X.copy(rt).multiplyScalar(K).round())},this.getScissor=function(R){return R.copy(Tt)},this.setScissor=function(R,Z,ht,pt){R.isVector4?Tt.set(R.x,R.y,R.z,R.w):Tt.set(R,Z,ht,pt),N.scissor(ot.copy(Tt).multiplyScalar(K).round())},this.getScissorTest=function(){return Ct},this.setScissorTest=function(R){N.setScissorTest(Ct=R)},this.setOpaqueSort=function(R){bt=R},this.setTransparentSort=function(R){O=R},this.getClearColor=function(R){return R.copy(Xt.getClearColor())},this.setClearColor=function(){Xt.setClearColor(...arguments)},this.getClearAlpha=function(){return Xt.getClearAlpha()},this.setClearAlpha=function(){Xt.setClearAlpha(...arguments)},this.clear=function(R=!0,Z=!0,ht=!0){let pt=0;if(R){let $=!1;if(J!==null){const Ut=J.texture.format;$=Ut===Bh||Ut===Ph||Ut===Oh}if($){const Ut=J.texture.type,Ht=Ut===sa||Ut===Sr||Ut===Wo||Ut===qo||Ut===Uh||Ut===Lh,jt=Xt.getClearColor(),Gt=Xt.getClearAlpha(),re=jt.r,oe=jt.g,Jt=jt.b;Ht?(T[0]=re,T[1]=oe,T[2]=Jt,T[3]=Gt,G.clearBufferuiv(G.COLOR,0,T)):(b[0]=re,b[1]=oe,b[2]=Jt,b[3]=Gt,G.clearBufferiv(G.COLOR,0,b))}else pt|=G.COLOR_BUFFER_BIT}Z&&(pt|=G.DEPTH_BUFFER_BIT),ht&&(pt|=G.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),G.clear(pt)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){i.removeEventListener("webglcontextlost",Bt,!1),i.removeEventListener("webglcontextrestored",Wt,!1),i.removeEventListener("webglcontextcreationerror",Dt,!1),Xt.dispose(),tt.dispose(),wt.dispose(),j.dispose(),ft.dispose(),Pt.dispose(),V.dispose(),It.dispose(),de.dispose(),Y.dispose(),Nt.dispose(),Nt.removeEventListener("sessionstart",un),Nt.removeEventListener("sessionend",fn),Je.stop()};function Bt(R){R.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),w=!0}function Wt(){console.log("THREE.WebGLRenderer: Context Restored."),w=!1;const R=_t.autoReset,Z=kt.enabled,ht=kt.autoUpdate,pt=kt.needsUpdate,$=kt.type;q(),_t.autoReset=R,kt.enabled=Z,kt.autoUpdate=ht,kt.needsUpdate=pt,kt.type=$}function Dt(R){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",R.statusMessage)}function Et(R){const Z=R.target;Z.removeEventListener("dispose",Et),Qt(Z)}function Qt(R){ue(R),j.remove(R)}function ue(R){const Z=j.get(R).programs;Z!==void 0&&(Z.forEach(function(ht){Y.releaseProgram(ht)}),R.isShaderMaterial&&Y.releaseShaderCache(R))}this.renderBufferDirect=function(R,Z,ht,pt,$,Ut){Z===null&&(Z=Zt);const Ht=$.isMesh&&$.matrixWorld.determinant()<0,jt=la(R,Z,ht,pt,$);N.setMaterial(pt,Ht);let Gt=ht.index,re=1;if(pt.wireframe===!0){if(Gt=E.getWireframeAttribute(ht),Gt===void 0)return;re=2}const oe=ht.drawRange,Jt=ht.attributes.position;let ge=oe.start*re,we=(oe.start+oe.count)*re;Ut!==null&&(ge=Math.max(ge,Ut.start*re),we=Math.min(we,(Ut.start+Ut.count)*re)),Gt!==null?(ge=Math.max(ge,0),we=Math.min(we,Gt.count)):Jt!=null&&(ge=Math.max(ge,0),we=Math.min(we,Jt.count));const je=we-ge;if(je<0||je===1/0)return;It.setup($,pt,jt,ht,Gt);let Ie,_e=Ft;if(Gt!==null&&(Ie=C.get(Gt),_e=$t,_e.setIndex(Ie)),$.isMesh)pt.wireframe===!0?(N.setLineWidth(pt.wireframeLinewidth*Qe()),_e.setMode(G.LINES)):_e.setMode(G.TRIANGLES);else if($.isLine){let ie=pt.linewidth;ie===void 0&&(ie=1),N.setLineWidth(ie*Qe()),$.isLineSegments?_e.setMode(G.LINES):$.isLineLoop?_e.setMode(G.LINE_LOOP):_e.setMode(G.LINE_STRIP)}else $.isPoints?_e.setMode(G.POINTS):$.isSprite&&_e.setMode(G.TRIANGLES);if($.isBatchedMesh)if($._multiDrawInstances!==null)Zo("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),_e.renderMultiDrawInstances($._multiDrawStarts,$._multiDrawCounts,$._multiDrawCount,$._multiDrawInstances);else if(fe.get("WEBGL_multi_draw"))_e.renderMultiDraw($._multiDrawStarts,$._multiDrawCounts,$._multiDrawCount);else{const ie=$._multiDrawStarts,qe=$._multiDrawCounts,Me=$._multiDrawCount,Tn=Gt?C.get(Gt).bytesPerElement:1,pi=j.get(pt).currentProgram.getUniforms();for(let On=0;On<Me;On++)pi.setValue(G,"_gl_DrawID",On),_e.render(ie[On]/Tn,qe[On])}else if($.isInstancedMesh)_e.renderInstances(ge,je,$.count);else if(ht.isInstancedBufferGeometry){const ie=ht._maxInstanceCount!==void 0?ht._maxInstanceCount:1/0,qe=Math.min(ht.instanceCount,ie);_e.renderInstances(ge,je,qe)}else _e.render(ge,je)};function Oe(R,Z,ht){R.transparent===!0&&R.side===Oi&&R.forceSinglePass===!1?(R.side=qn,R.needsUpdate=!0,Ai(R,Z,ht),R.side=ka,R.needsUpdate=!0,Ai(R,Z,ht),R.side=Oi):Ai(R,Z,ht)}this.compile=function(R,Z,ht=null){ht===null&&(ht=R),g=wt.get(ht),g.init(Z),P.push(g),ht.traverseVisible(function($){$.isLight&&$.layers.test(Z.layers)&&(g.pushLight($),$.castShadow&&g.pushShadow($))}),R!==ht&&R.traverseVisible(function($){$.isLight&&$.layers.test(Z.layers)&&(g.pushLight($),$.castShadow&&g.pushShadow($))}),g.setupLights();const pt=new Set;return R.traverse(function($){if(!($.isMesh||$.isPoints||$.isLine||$.isSprite))return;const Ut=$.material;if(Ut)if(Array.isArray(Ut))for(let Ht=0;Ht<Ut.length;Ht++){const jt=Ut[Ht];Oe(jt,ht,$),pt.add(jt)}else Oe(Ut,ht,$),pt.add(Ut)}),g=P.pop(),pt},this.compileAsync=function(R,Z,ht=null){const pt=this.compile(R,Z,ht);return new Promise($=>{function Ut(){if(pt.forEach(function(Ht){j.get(Ht).currentProgram.isReady()&&pt.delete(Ht)}),pt.size===0){$(R);return}setTimeout(Ut,10)}fe.get("KHR_parallel_shader_compile")!==null?Ut():setTimeout(Ut,10)})};let Ce=null;function hi(R){Ce&&Ce(R)}function un(){Je.stop()}function fn(){Je.start()}const Je=new ev;Je.setAnimationLoop(hi),typeof self<"u"&&Je.setContext(self),this.setAnimationLoop=function(R){Ce=R,Nt.setAnimationLoop(R),R===null?Je.stop():Je.start()},Nt.addEventListener("sessionstart",un),Nt.addEventListener("sessionend",fn),this.render=function(R,Z){if(Z!==void 0&&Z.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;if(R.matrixWorldAutoUpdate===!0&&R.updateMatrixWorld(),Z.parent===null&&Z.matrixWorldAutoUpdate===!0&&Z.updateMatrixWorld(),Nt.enabled===!0&&Nt.isPresenting===!0&&(Nt.cameraAutoUpdate===!0&&Nt.updateCamera(Z),Z=Nt.getCamera()),R.isScene===!0&&R.onBeforeRender(L,R,Z,J),g=wt.get(R,P.length),g.init(Z),P.push(g),St.multiplyMatrices(Z.projectionMatrix,Z.matrixWorldInverse),zt.setFromProjectionMatrix(St,Ii,Z.reversedDepth),st=this.localClippingEnabled,qt=At.init(this.clippingPlanes,st),M=tt.get(R,z.length),M.init(),z.push(M),Nt.enabled===!0&&Nt.isPresenting===!0){const Ut=L.xr.getDepthSensingMesh();Ut!==null&&Ti(Ut,Z,-1/0,L.sortObjects)}Ti(R,Z,0,L.sortObjects),M.finish(),L.sortObjects===!0&&M.sort(bt,O),he=Nt.enabled===!1||Nt.isPresenting===!1||Nt.hasDepthSensing()===!1,he&&Xt.addToRenderList(M,R),this.info.render.frame++,qt===!0&&At.beginShadows();const ht=g.state.shadowsArray;kt.render(ht,R,Z),qt===!0&&At.endShadows(),this.info.autoReset===!0&&this.info.reset();const pt=M.opaque,$=M.transmissive;if(g.setupLights(),Z.isArrayCamera){const Ut=Z.cameras;if($.length>0)for(let Ht=0,jt=Ut.length;Ht<jt;Ht++){const Gt=Ut[Ht];tl(pt,$,R,Gt)}he&&Xt.render(R);for(let Ht=0,jt=Ut.length;Ht<jt;Ht++){const Gt=Ut[Ht];br(M,R,Gt,Gt.viewport)}}else $.length>0&&tl(pt,$,R,Z),he&&Xt.render(R),br(M,R,Z);J!==null&&B===0&&(vt.updateMultisampleRenderTarget(J),vt.updateRenderTargetMipmap(J)),R.isScene===!0&&R.onAfterRender(L,R,Z),It.resetDefaultState(),D=-1,U=null,P.pop(),P.length>0?(g=P[P.length-1],qt===!0&&At.setGlobalState(L.clippingPlanes,g.state.camera)):g=null,z.pop(),z.length>0?M=z[z.length-1]:M=null};function Ti(R,Z,ht,pt){if(R.visible===!1)return;if(R.layers.test(Z.layers)){if(R.isGroup)ht=R.renderOrder;else if(R.isLOD)R.autoUpdate===!0&&R.update(Z);else if(R.isLight)g.pushLight(R),R.castShadow&&g.pushShadow(R);else if(R.isSprite){if(!R.frustumCulled||zt.intersectsSprite(R)){pt&&ne.setFromMatrixPosition(R.matrixWorld).applyMatrix4(St);const Ht=V.update(R),jt=R.material;jt.visible&&M.push(R,Ht,jt,ht,ne.z,null)}}else if((R.isMesh||R.isLine||R.isPoints)&&(!R.frustumCulled||zt.intersectsObject(R))){const Ht=V.update(R),jt=R.material;if(pt&&(R.boundingSphere!==void 0?(R.boundingSphere===null&&R.computeBoundingSphere(),ne.copy(R.boundingSphere.center)):(Ht.boundingSphere===null&&Ht.computeBoundingSphere(),ne.copy(Ht.boundingSphere.center)),ne.applyMatrix4(R.matrixWorld).applyMatrix4(St)),Array.isArray(jt)){const Gt=Ht.groups;for(let re=0,oe=Gt.length;re<oe;re++){const Jt=Gt[re],ge=jt[Jt.materialIndex];ge&&ge.visible&&M.push(R,Ht,ge,ht,ne.z,Jt)}}else jt.visible&&M.push(R,Ht,jt,ht,ne.z,null)}}const Ut=R.children;for(let Ht=0,jt=Ut.length;Ht<jt;Ht++)Ti(Ut[Ht],Z,ht,pt)}function br(R,Z,ht,pt){const $=R.opaque,Ut=R.transmissive,Ht=R.transparent;g.setupLightsView(ht),qt===!0&&At.setGlobalState(L.clippingPlanes,ht),pt&&N.viewport(X.copy(pt)),$.length>0&&Tr($,Z,ht),Ut.length>0&&Tr(Ut,Z,ht),Ht.length>0&&Tr(Ht,Z,ht),N.buffers.depth.setTest(!0),N.buffers.depth.setMask(!0),N.buffers.color.setMask(!0),N.setPolygonOffset(!1)}function tl(R,Z,ht,pt){if((ht.isScene===!0?ht.overrideMaterial:null)!==null)return;g.state.transmissionRenderTarget[pt.id]===void 0&&(g.state.transmissionRenderTarget[pt.id]=new Mr(1,1,{generateMipmaps:!0,type:fe.has("EXT_color_buffer_half_float")||fe.has("EXT_color_buffer_float")?Ko:sa,minFilter:yr,samples:4,stencilBuffer:u,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ue.workingColorSpace}));const Ut=g.state.transmissionRenderTarget[pt.id],Ht=pt.viewport||X;Ut.setSize(Ht.z*L.transmissionResolutionScale,Ht.w*L.transmissionResolutionScale);const jt=L.getRenderTarget(),Gt=L.getActiveCubeFace(),re=L.getActiveMipmapLevel();L.setRenderTarget(Ut),L.getClearColor(ct),gt=L.getClearAlpha(),gt<1&&L.setClearColor(16777215,.5),L.clear(),he&&Xt.render(ht);const oe=L.toneMapping;L.toneMapping=Ga;const Jt=pt.viewport;if(pt.viewport!==void 0&&(pt.viewport=void 0),g.setupLightsView(pt),qt===!0&&At.setGlobalState(L.clippingPlanes,pt),Tr(R,ht,pt),vt.updateMultisampleRenderTarget(Ut),vt.updateRenderTargetMipmap(Ut),fe.has("WEBGL_multisampled_render_to_texture")===!1){let ge=!1;for(let we=0,je=Z.length;we<je;we++){const Ie=Z[we],_e=Ie.object,ie=Ie.geometry,qe=Ie.material,Me=Ie.group;if(qe.side===Oi&&_e.layers.test(pt.layers)){const Tn=qe.side;qe.side=qn,qe.needsUpdate=!0,Is(_e,ht,pt,ie,qe,Me),qe.side=Tn,qe.needsUpdate=!0,ge=!0}}ge===!0&&(vt.updateMultisampleRenderTarget(Ut),vt.updateRenderTargetMipmap(Ut))}L.setRenderTarget(jt,Gt,re),L.setClearColor(ct,gt),Jt!==void 0&&(pt.viewport=Jt),L.toneMapping=oe}function Tr(R,Z,ht){const pt=Z.isScene===!0?Z.overrideMaterial:null;for(let $=0,Ut=R.length;$<Ut;$++){const Ht=R[$],jt=Ht.object,Gt=Ht.geometry,re=Ht.group;let oe=Ht.material;oe.allowOverride===!0&&pt!==null&&(oe=pt),jt.layers.test(ht.layers)&&Is(jt,Z,ht,Gt,oe,re)}}function Is(R,Z,ht,pt,$,Ut){R.onBeforeRender(L,Z,ht,pt,$,Ut),R.modelViewMatrix.multiplyMatrices(ht.matrixWorldInverse,R.matrixWorld),R.normalMatrix.getNormalMatrix(R.modelViewMatrix),$.onBeforeRender(L,Z,ht,pt,R,Ut),$.transparent===!0&&$.side===Oi&&$.forceSinglePass===!1?($.side=qn,$.needsUpdate=!0,L.renderBufferDirect(ht,Z,pt,$,R,Ut),$.side=ka,$.needsUpdate=!0,L.renderBufferDirect(ht,Z,pt,$,R,Ut),$.side=Oi):L.renderBufferDirect(ht,Z,pt,$,R,Ut),R.onAfterRender(L,Z,ht,pt,$,Ut)}function Ai(R,Z,ht){Z.isScene!==!0&&(Z=Zt);const pt=j.get(R),$=g.state.lights,Ut=g.state.shadowsArray,Ht=$.state.version,jt=Y.getParameters(R,$.state,Ut,Z,ht),Gt=Y.getProgramCacheKey(jt);let re=pt.programs;pt.environment=R.isMeshStandardMaterial?Z.environment:null,pt.fog=Z.fog,pt.envMap=(R.isMeshStandardMaterial?Pt:ft).get(R.envMap||pt.environment),pt.envMapRotation=pt.environment!==null&&R.envMap===null?Z.environmentRotation:R.envMapRotation,re===void 0&&(R.addEventListener("dispose",Et),re=new Map,pt.programs=re);let oe=re.get(Gt);if(oe!==void 0){if(pt.currentProgram===oe&&pt.lightsStateVersion===Ht)return zi(R,jt),oe}else jt.uniforms=Y.getUniforms(R),R.onBeforeCompile(jt,L),oe=Y.acquireProgram(jt,Gt),re.set(Gt,oe),pt.uniforms=jt.uniforms;const Jt=pt.uniforms;return(!R.isShaderMaterial&&!R.isRawShaderMaterial||R.clipping===!0)&&(Jt.clippingPlanes=At.uniform),zi(R,jt),pt.needsLights=ca(R),pt.lightsStateVersion=Ht,pt.needsLights&&(Jt.ambientLightColor.value=$.state.ambient,Jt.lightProbe.value=$.state.probe,Jt.directionalLights.value=$.state.directional,Jt.directionalLightShadows.value=$.state.directionalShadow,Jt.spotLights.value=$.state.spot,Jt.spotLightShadows.value=$.state.spotShadow,Jt.rectAreaLights.value=$.state.rectArea,Jt.ltc_1.value=$.state.rectAreaLTC1,Jt.ltc_2.value=$.state.rectAreaLTC2,Jt.pointLights.value=$.state.point,Jt.pointLightShadows.value=$.state.pointShadow,Jt.hemisphereLights.value=$.state.hemi,Jt.directionalShadowMap.value=$.state.directionalShadowMap,Jt.directionalShadowMatrix.value=$.state.directionalShadowMatrix,Jt.spotShadowMap.value=$.state.spotShadowMap,Jt.spotLightMatrix.value=$.state.spotLightMatrix,Jt.spotLightMap.value=$.state.spotLightMap,Jt.pointShadowMap.value=$.state.pointShadowMap,Jt.pointShadowMatrix.value=$.state.pointShadowMatrix),pt.currentProgram=oe,pt.uniformsList=null,oe}function Ar(R){if(R.uniformsList===null){const Z=R.currentProgram.getUniforms();R.uniformsList=Hc.seqWithValue(Z.seq,R.uniforms)}return R.uniformsList}function zi(R,Z){const ht=j.get(R);ht.outputColorSpace=Z.outputColorSpace,ht.batching=Z.batching,ht.batchingColor=Z.batchingColor,ht.instancing=Z.instancing,ht.instancingColor=Z.instancingColor,ht.instancingMorph=Z.instancingMorph,ht.skinning=Z.skinning,ht.morphTargets=Z.morphTargets,ht.morphNormals=Z.morphNormals,ht.morphColors=Z.morphColors,ht.morphTargetsCount=Z.morphTargetsCount,ht.numClippingPlanes=Z.numClippingPlanes,ht.numIntersection=Z.numClipIntersection,ht.vertexAlphas=Z.vertexAlphas,ht.vertexTangents=Z.vertexTangents,ht.toneMapping=Z.toneMapping}function la(R,Z,ht,pt,$){Z.isScene!==!0&&(Z=Zt),vt.resetTextureUnits();const Ut=Z.fog,Ht=pt.isMeshStandardMaterial?Z.environment:null,jt=J===null?L.outputColorSpace:J.isXRRenderTarget===!0?J.texture.colorSpace:Us,Gt=(pt.isMeshStandardMaterial?Pt:ft).get(pt.envMap||Ht),re=pt.vertexColors===!0&&!!ht.attributes.color&&ht.attributes.color.itemSize===4,oe=!!ht.attributes.tangent&&(!!pt.normalMap||pt.anisotropy>0),Jt=!!ht.morphAttributes.position,ge=!!ht.morphAttributes.normal,we=!!ht.morphAttributes.color;let je=Ga;pt.toneMapped&&(J===null||J.isXRRenderTarget===!0)&&(je=L.toneMapping);const Ie=ht.morphAttributes.position||ht.morphAttributes.normal||ht.morphAttributes.color,_e=Ie!==void 0?Ie.length:0,ie=j.get(pt),qe=g.state.lights;if(qt===!0&&(st===!0||R!==U)){const $e=R===U&&pt.id===D;At.setState(pt,R,$e)}let Me=!1;pt.version===ie.__version?(ie.needsLights&&ie.lightsStateVersion!==qe.state.version||ie.outputColorSpace!==jt||$.isBatchedMesh&&ie.batching===!1||!$.isBatchedMesh&&ie.batching===!0||$.isBatchedMesh&&ie.batchingColor===!0&&$.colorTexture===null||$.isBatchedMesh&&ie.batchingColor===!1&&$.colorTexture!==null||$.isInstancedMesh&&ie.instancing===!1||!$.isInstancedMesh&&ie.instancing===!0||$.isSkinnedMesh&&ie.skinning===!1||!$.isSkinnedMesh&&ie.skinning===!0||$.isInstancedMesh&&ie.instancingColor===!0&&$.instanceColor===null||$.isInstancedMesh&&ie.instancingColor===!1&&$.instanceColor!==null||$.isInstancedMesh&&ie.instancingMorph===!0&&$.morphTexture===null||$.isInstancedMesh&&ie.instancingMorph===!1&&$.morphTexture!==null||ie.envMap!==Gt||pt.fog===!0&&ie.fog!==Ut||ie.numClippingPlanes!==void 0&&(ie.numClippingPlanes!==At.numPlanes||ie.numIntersection!==At.numIntersection)||ie.vertexAlphas!==re||ie.vertexTangents!==oe||ie.morphTargets!==Jt||ie.morphNormals!==ge||ie.morphColors!==we||ie.toneMapping!==je||ie.morphTargetsCount!==_e)&&(Me=!0):(Me=!0,ie.__version=pt.version);let Tn=ie.currentProgram;Me===!0&&(Tn=Ai(pt,Z,$));let pi=!1,On=!1,gn=!1;const ke=Tn.getUniforms(),Pn=ie.uniforms;if(N.useProgram(Tn.program)&&(pi=!0,On=!0,gn=!0),pt.id!==D&&(D=pt.id,On=!0),pi||U!==R){N.buffers.depth.getReversed()&&R.reversedDepth!==!0&&(R._reversedDepth=!0,R.updateProjectionMatrix()),ke.setValue(G,"projectionMatrix",R.projectionMatrix),ke.setValue(G,"viewMatrix",R.matrixWorldInverse);const Sn=ke.map.cameraPosition;Sn!==void 0&&Sn.setValue(G,Ot.setFromMatrixPosition(R.matrixWorld)),ae.logarithmicDepthBuffer&&ke.setValue(G,"logDepthBufFC",2/(Math.log(R.far+1)/Math.LN2)),(pt.isMeshPhongMaterial||pt.isMeshToonMaterial||pt.isMeshLambertMaterial||pt.isMeshBasicMaterial||pt.isMeshStandardMaterial||pt.isShaderMaterial)&&ke.setValue(G,"isOrthographic",R.isOrthographicCamera===!0),U!==R&&(U=R,On=!0,gn=!0)}if($.isSkinnedMesh){ke.setOptional(G,$,"bindMatrix"),ke.setOptional(G,$,"bindMatrixInverse");const $e=$.skeleton;$e&&($e.boneTexture===null&&$e.computeBoneTexture(),ke.setValue(G,"boneTexture",$e.boneTexture,vt))}$.isBatchedMesh&&(ke.setOptional(G,$,"batchingTexture"),ke.setValue(G,"batchingTexture",$._matricesTexture,vt),ke.setOptional(G,$,"batchingIdTexture"),ke.setValue(G,"batchingIdTexture",$._indirectTexture,vt),ke.setOptional(G,$,"batchingColorTexture"),$._colorsTexture!==null&&ke.setValue(G,"batchingColorTexture",$._colorsTexture,vt));const An=ht.morphAttributes;if((An.position!==void 0||An.normal!==void 0||An.color!==void 0)&&Rt.update($,ht,Tn),(On||ie.receiveShadow!==$.receiveShadow)&&(ie.receiveShadow=$.receiveShadow,ke.setValue(G,"receiveShadow",$.receiveShadow)),pt.isMeshGouraudMaterial&&pt.envMap!==null&&(Pn.envMap.value=Gt,Pn.flipEnvMap.value=Gt.isCubeTexture&&Gt.isRenderTargetTexture===!1?-1:1),pt.isMeshStandardMaterial&&pt.envMap===null&&Z.environment!==null&&(Pn.envMapIntensity.value=Z.environmentIntensity),On&&(ke.setValue(G,"toneMappingExposure",L.toneMappingExposure),ie.needsLights&&Wa(Pn,gn),Ut&&pt.fog===!0&&dt.refreshFogUniforms(Pn,Ut),dt.refreshMaterialUniforms(Pn,pt,K,it,g.state.transmissionRenderTarget[R.id]),Hc.upload(G,Ar(ie),Pn,vt)),pt.isShaderMaterial&&pt.uniformsNeedUpdate===!0&&(Hc.upload(G,Ar(ie),Pn,vt),pt.uniformsNeedUpdate=!1),pt.isSpriteMaterial&&ke.setValue(G,"center",$.center),ke.setValue(G,"modelViewMatrix",$.modelViewMatrix),ke.setValue(G,"normalMatrix",$.normalMatrix),ke.setValue(G,"modelMatrix",$.matrixWorld),pt.isShaderMaterial||pt.isRawShaderMaterial){const $e=pt.uniformsGroups;for(let Sn=0,Rr=$e.length;Sn<Rr;Sn++){const Gn=$e[Sn];de.update(Gn,Tn),de.bind(Gn,Tn)}}return Tn}function Wa(R,Z){R.ambientLightColor.needsUpdate=Z,R.lightProbe.needsUpdate=Z,R.directionalLights.needsUpdate=Z,R.directionalLightShadows.needsUpdate=Z,R.pointLights.needsUpdate=Z,R.pointLightShadows.needsUpdate=Z,R.spotLights.needsUpdate=Z,R.spotLightShadows.needsUpdate=Z,R.rectAreaLights.needsUpdate=Z,R.hemisphereLights.needsUpdate=Z}function ca(R){return R.isMeshLambertMaterial||R.isMeshToonMaterial||R.isMeshPhongMaterial||R.isMeshStandardMaterial||R.isShadowMaterial||R.isShaderMaterial&&R.lights===!0}this.getActiveCubeFace=function(){return H},this.getActiveMipmapLevel=function(){return B},this.getRenderTarget=function(){return J},this.setRenderTargetTextures=function(R,Z,ht){const pt=j.get(R);pt.__autoAllocateDepthBuffer=R.resolveDepthBuffer===!1,pt.__autoAllocateDepthBuffer===!1&&(pt.__useRenderToTexture=!1),j.get(R.texture).__webglTexture=Z,j.get(R.depthTexture).__webglTexture=pt.__autoAllocateDepthBuffer?void 0:ht,pt.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(R,Z){const ht=j.get(R);ht.__webglFramebuffer=Z,ht.__useDefaultFramebuffer=Z===void 0};const sn=G.createFramebuffer();this.setRenderTarget=function(R,Z=0,ht=0){J=R,H=Z,B=ht;let pt=!0,$=null,Ut=!1,Ht=!1;if(R){const Gt=j.get(R);if(Gt.__useDefaultFramebuffer!==void 0)N.bindFramebuffer(G.FRAMEBUFFER,null),pt=!1;else if(Gt.__webglFramebuffer===void 0)vt.setupRenderTarget(R);else if(Gt.__hasExternalTextures)vt.rebindTextures(R,j.get(R.texture).__webglTexture,j.get(R.depthTexture).__webglTexture);else if(R.depthBuffer){const Jt=R.depthTexture;if(Gt.__boundDepthTexture!==Jt){if(Jt!==null&&j.has(Jt)&&(R.width!==Jt.image.width||R.height!==Jt.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");vt.setupDepthRenderbuffer(R)}}const re=R.texture;(re.isData3DTexture||re.isDataArrayTexture||re.isCompressedArrayTexture)&&(Ht=!0);const oe=j.get(R).__webglFramebuffer;R.isWebGLCubeRenderTarget?(Array.isArray(oe[Z])?$=oe[Z][ht]:$=oe[Z],Ut=!0):R.samples>0&&vt.useMultisampledRTT(R)===!1?$=j.get(R).__webglMultisampledFramebuffer:Array.isArray(oe)?$=oe[ht]:$=oe,X.copy(R.viewport),ot.copy(R.scissor),mt=R.scissorTest}else X.copy(rt).multiplyScalar(K).floor(),ot.copy(Tt).multiplyScalar(K).floor(),mt=Ct;if(ht!==0&&($=sn),N.bindFramebuffer(G.FRAMEBUFFER,$)&&pt&&N.drawBuffers(R,$),N.viewport(X),N.scissor(ot),N.setScissorTest(mt),Ut){const Gt=j.get(R.texture);G.framebufferTexture2D(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_CUBE_MAP_POSITIVE_X+Z,Gt.__webglTexture,ht)}else if(Ht){const Gt=Z;for(let re=0;re<R.textures.length;re++){const oe=j.get(R.textures[re]);G.framebufferTextureLayer(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0+re,oe.__webglTexture,ht,Gt)}}else if(R!==null&&ht!==0){const Gt=j.get(R.texture);G.framebufferTexture2D(G.FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_2D,Gt.__webglTexture,ht)}D=-1},this.readRenderTargetPixels=function(R,Z,ht,pt,$,Ut,Ht,jt=0){if(!(R&&R.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Gt=j.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Ht!==void 0&&(Gt=Gt[Ht]),Gt){N.bindFramebuffer(G.FRAMEBUFFER,Gt);try{const re=R.textures[jt],oe=re.format,Jt=re.type;if(!ae.textureFormatReadable(oe)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!ae.textureTypeReadable(Jt)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}Z>=0&&Z<=R.width-pt&&ht>=0&&ht<=R.height-$&&(R.textures.length>1&&G.readBuffer(G.COLOR_ATTACHMENT0+jt),G.readPixels(Z,ht,pt,$,Yt.convert(oe),Yt.convert(Jt),Ut))}finally{const re=J!==null?j.get(J).__webglFramebuffer:null;N.bindFramebuffer(G.FRAMEBUFFER,re)}}},this.readRenderTargetPixelsAsync=async function(R,Z,ht,pt,$,Ut,Ht,jt=0){if(!(R&&R.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let Gt=j.get(R).__webglFramebuffer;if(R.isWebGLCubeRenderTarget&&Ht!==void 0&&(Gt=Gt[Ht]),Gt)if(Z>=0&&Z<=R.width-pt&&ht>=0&&ht<=R.height-$){N.bindFramebuffer(G.FRAMEBUFFER,Gt);const re=R.textures[jt],oe=re.format,Jt=re.type;if(!ae.textureFormatReadable(oe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!ae.textureTypeReadable(Jt))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const ge=G.createBuffer();G.bindBuffer(G.PIXEL_PACK_BUFFER,ge),G.bufferData(G.PIXEL_PACK_BUFFER,Ut.byteLength,G.STREAM_READ),R.textures.length>1&&G.readBuffer(G.COLOR_ATTACHMENT0+jt),G.readPixels(Z,ht,pt,$,Yt.convert(oe),Yt.convert(Jt),0);const we=J!==null?j.get(J).__webglFramebuffer:null;N.bindFramebuffer(G.FRAMEBUFFER,we);const je=G.fenceSync(G.SYNC_GPU_COMMANDS_COMPLETE,0);return G.flush(),await hS(G,je,4),G.bindBuffer(G.PIXEL_PACK_BUFFER,ge),G.getBufferSubData(G.PIXEL_PACK_BUFFER,0,Ut),G.deleteBuffer(ge),G.deleteSync(je),Ut}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(R,Z=null,ht=0){const pt=Math.pow(2,-ht),$=Math.floor(R.image.width*pt),Ut=Math.floor(R.image.height*pt),Ht=Z!==null?Z.x:0,jt=Z!==null?Z.y:0;vt.setTexture2D(R,0),G.copyTexSubImage2D(G.TEXTURE_2D,ht,0,0,Ht,jt,$,Ut),N.unbindTexture()};const el=G.createFramebuffer(),nl=G.createFramebuffer();this.copyTextureToTexture=function(R,Z,ht=null,pt=null,$=0,Ut=null){Ut===null&&($!==0?(Zo("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),Ut=$,$=0):Ut=0);let Ht,jt,Gt,re,oe,Jt,ge,we,je;const Ie=R.isCompressedTexture?R.mipmaps[Ut]:R.image;if(ht!==null)Ht=ht.max.x-ht.min.x,jt=ht.max.y-ht.min.y,Gt=ht.isBox3?ht.max.z-ht.min.z:1,re=ht.min.x,oe=ht.min.y,Jt=ht.isBox3?ht.min.z:0;else{const An=Math.pow(2,-$);Ht=Math.floor(Ie.width*An),jt=Math.floor(Ie.height*An),R.isDataArrayTexture?Gt=Ie.depth:R.isData3DTexture?Gt=Math.floor(Ie.depth*An):Gt=1,re=0,oe=0,Jt=0}pt!==null?(ge=pt.x,we=pt.y,je=pt.z):(ge=0,we=0,je=0);const _e=Yt.convert(Z.format),ie=Yt.convert(Z.type);let qe;Z.isData3DTexture?(vt.setTexture3D(Z,0),qe=G.TEXTURE_3D):Z.isDataArrayTexture||Z.isCompressedArrayTexture?(vt.setTexture2DArray(Z,0),qe=G.TEXTURE_2D_ARRAY):(vt.setTexture2D(Z,0),qe=G.TEXTURE_2D),G.pixelStorei(G.UNPACK_FLIP_Y_WEBGL,Z.flipY),G.pixelStorei(G.UNPACK_PREMULTIPLY_ALPHA_WEBGL,Z.premultiplyAlpha),G.pixelStorei(G.UNPACK_ALIGNMENT,Z.unpackAlignment);const Me=G.getParameter(G.UNPACK_ROW_LENGTH),Tn=G.getParameter(G.UNPACK_IMAGE_HEIGHT),pi=G.getParameter(G.UNPACK_SKIP_PIXELS),On=G.getParameter(G.UNPACK_SKIP_ROWS),gn=G.getParameter(G.UNPACK_SKIP_IMAGES);G.pixelStorei(G.UNPACK_ROW_LENGTH,Ie.width),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,Ie.height),G.pixelStorei(G.UNPACK_SKIP_PIXELS,re),G.pixelStorei(G.UNPACK_SKIP_ROWS,oe),G.pixelStorei(G.UNPACK_SKIP_IMAGES,Jt);const ke=R.isDataArrayTexture||R.isData3DTexture,Pn=Z.isDataArrayTexture||Z.isData3DTexture;if(R.isDepthTexture){const An=j.get(R),$e=j.get(Z),Sn=j.get(An.__renderTarget),Rr=j.get($e.__renderTarget);N.bindFramebuffer(G.READ_FRAMEBUFFER,Sn.__webglFramebuffer),N.bindFramebuffer(G.DRAW_FRAMEBUFFER,Rr.__webglFramebuffer);for(let Gn=0;Gn<Gt;Gn++)ke&&(G.framebufferTextureLayer(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,j.get(R).__webglTexture,$,Jt+Gn),G.framebufferTextureLayer(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,j.get(Z).__webglTexture,Ut,je+Gn)),G.blitFramebuffer(re,oe,Ht,jt,ge,we,Ht,jt,G.DEPTH_BUFFER_BIT,G.NEAREST);N.bindFramebuffer(G.READ_FRAMEBUFFER,null),N.bindFramebuffer(G.DRAW_FRAMEBUFFER,null)}else if($!==0||R.isRenderTargetTexture||j.has(R)){const An=j.get(R),$e=j.get(Z);N.bindFramebuffer(G.READ_FRAMEBUFFER,el),N.bindFramebuffer(G.DRAW_FRAMEBUFFER,nl);for(let Sn=0;Sn<Gt;Sn++)ke?G.framebufferTextureLayer(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,An.__webglTexture,$,Jt+Sn):G.framebufferTexture2D(G.READ_FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_2D,An.__webglTexture,$),Pn?G.framebufferTextureLayer(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,$e.__webglTexture,Ut,je+Sn):G.framebufferTexture2D(G.DRAW_FRAMEBUFFER,G.COLOR_ATTACHMENT0,G.TEXTURE_2D,$e.__webglTexture,Ut),$!==0?G.blitFramebuffer(re,oe,Ht,jt,ge,we,Ht,jt,G.COLOR_BUFFER_BIT,G.NEAREST):Pn?G.copyTexSubImage3D(qe,Ut,ge,we,je+Sn,re,oe,Ht,jt):G.copyTexSubImage2D(qe,Ut,ge,we,re,oe,Ht,jt);N.bindFramebuffer(G.READ_FRAMEBUFFER,null),N.bindFramebuffer(G.DRAW_FRAMEBUFFER,null)}else Pn?R.isDataTexture||R.isData3DTexture?G.texSubImage3D(qe,Ut,ge,we,je,Ht,jt,Gt,_e,ie,Ie.data):Z.isCompressedArrayTexture?G.compressedTexSubImage3D(qe,Ut,ge,we,je,Ht,jt,Gt,_e,Ie.data):G.texSubImage3D(qe,Ut,ge,we,je,Ht,jt,Gt,_e,ie,Ie):R.isDataTexture?G.texSubImage2D(G.TEXTURE_2D,Ut,ge,we,Ht,jt,_e,ie,Ie.data):R.isCompressedTexture?G.compressedTexSubImage2D(G.TEXTURE_2D,Ut,ge,we,Ie.width,Ie.height,_e,Ie.data):G.texSubImage2D(G.TEXTURE_2D,Ut,ge,we,Ht,jt,_e,ie,Ie);G.pixelStorei(G.UNPACK_ROW_LENGTH,Me),G.pixelStorei(G.UNPACK_IMAGE_HEIGHT,Tn),G.pixelStorei(G.UNPACK_SKIP_PIXELS,pi),G.pixelStorei(G.UNPACK_SKIP_ROWS,On),G.pixelStorei(G.UNPACK_SKIP_IMAGES,gn),Ut===0&&Z.generateMipmaps&&G.generateMipmap(qe),N.unbindTexture()},this.initRenderTarget=function(R){j.get(R).__webglFramebuffer===void 0&&vt.setupRenderTarget(R)},this.initTexture=function(R){R.isCubeTexture?vt.setTextureCube(R,0):R.isData3DTexture?vt.setTexture3D(R,0):R.isDataArrayTexture||R.isCompressedArrayTexture?vt.setTexture2DArray(R,0):vt.setTexture2D(R,0),N.unbindTexture()},this.resetState=function(){H=0,B=0,J=null,N.reset(),It.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Ii}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(t){this._outputColorSpace=t;const i=this.getContext();i.drawingBufferColorSpace=Ue._getDrawingBufferColorSpace(t),i.unpackColorSpace=Ue._getUnpackColorSpace()}}const sv={xRange:[-2,2],yRange:[-1.5,1.5],gridDivisions:8,axisColor:8947848,gridColor:3355443},C0=(o,t,i,r)=>({x:1-i*o*o+t,y:r*o}),w0=(o,t,i,r)=>({x:t,y:-r*o+i*t-t*t*t}),P1=o=>{const{xRange:t,yRange:i,gridDivisions:r,axisColor:l,gridColor:u}=sv,[d,h]=t,[m,p]=i,_=(h-d)/r,x=(p-m)/r,y=new ko;y.name="coordinate-system";for(let T=0;T<=r;T++){const b=d+T*_,M=Math.abs(b)<.01,g=[new nt(b,m,-.01),new nt(b,p,-.01)],z=new Hn().setFromPoints(g),P=new Rs({color:M?l:u,transparent:!0,opacity:M?1:.4}),L=new Yc(z,P);L.userData.isGrid=!0,y.add(L)}for(let T=0;T<=r;T++){const b=m+T*x,M=Math.abs(b)<.01,g=[new nt(d,b,-.01),new nt(h,b,-.01)],z=new Hn().setFromPoints(g),P=new Rs({color:M?l:u,transparent:!0,opacity:M?1:.4}),L=new Yc(z,P);L.userData.isGrid=!0,y.add(L)}const v=(T,b,M=.15)=>{const g=document.createElement("canvas"),z=g.getContext("2d");g.width=128,g.height=64,z.fillStyle="transparent",z.fillRect(0,0,g.width,g.height),z.font="Bold 32px Arial",z.fillStyle="#aaaaaa",z.textAlign="center",z.textBaseline="middle",z.fillText(T,g.width/2,g.height/2);const P=new YS(g);P.minFilter=Mi;const L=new Z0({map:P,transparent:!0,depthTest:!1}),w=new HS(L);return w.position.copy(b),w.scale.set(M*2,M,1),w.userData.isGrid=!0,w};for(let T=0;T<=r;T++){const b=d+T*_;Math.abs(b)>.01&&y.add(v(b.toFixed(1),new nt(b,m-.15,0),.12))}for(let T=0;T<=r;T++){const b=m+T*x;Math.abs(b)>.01&&y.add(v(b.toFixed(1),new nt(d-.2,b,0),.12))}return y.add(v("x",new nt(h+.2,0,0),.18)),y.add(v("y",new nt(0,p+.15,0),.18)),y.add(v("0",new nt(-.12,-.12,0),.1)),o.add(y),y},Li={period1:{stable:"#27ae60",unstable:"#e74c3c",saddle:"#eedf32"},period2:{stable:"#27ae60",unstable:"#e74c3c",saddle:"#eedf32"},period3:{stable:"#27ae60",unstable:"#e74c3c",saddle:"#eedf32"},period4:{stable:"#27ae60",unstable:"#e74c3c",saddle:"#eedf32"},period5:{stable:"#27ae60",unstable:"#e74c3c",saddle:"#eedf32"},period6plus:{stable:"#27ae60",unstable:"#e74c3c",saddle:"#eedf32"},trajectory:"#00ffff",manifold:"#1e90ff",attractor:"#27ae60",repeller:"#e74c3c",saddlePoint:"#eedf32",periodicBlue:"#3498db"},B1=()=>{const o=ee.useRef(null),t=ee.useRef(null),i=ee.useRef(null),r=ee.useRef(null),l=ee.useRef(null),u=ee.useRef(null),d=ee.useRef(null),[h,m]=ee.useState("manifold"),[p,_]=ee.useState("henon"),[x,y]=ee.useState(null),[v,T]=ee.useState({a:.4,b:.3,epsilon:.0625,startX:.1,startY:.1,maxIterations:1e3,maxPeriod:5}),[b,M]=ee.useState({orbits:[],trajectoryPoints:[],currentPoint:{x:.1,y:.1},iteration:0,isRunning:!1,isReady:!1,showOrbits:!1,showTrail:!0,showOrbitLines:!1,highlightedOrbitId:null,hasStarted:!1}),[g,z]=ee.useState({manifolds:[],fixedPoints:[],isComputing:!1,isReady:!1,showOrbits:!0,showOrbitLines:!1,highlightedOrbitId:null}),[P,L]=ee.useState({period1:!0,period2:!0,period3:!0,period4:!0,period5:!0,period6plus:!1}),[w,H]=ee.useState({gridBoxes:[],invariantMeasure:null,leftEigenvector:null,transitions:null,selectedBoxIndex:null,currentBoxIndex:-1,isComputing:!1,subdivisions:20,pointsPerBox:64,epsilon:.05,showUlamOverlay:!1,showTransitions:!0,showCurrentBox:!0,needsRecompute:!1}),[B,J]=ee.useState({isAnimating:!1,parameter:"a",rangeValue:.1,direction:1,steps:10,currentStep:0,baseValue:null,targetValue:null});ee.useRef(null);const[D,U]=ee.useState({isRecording:!1,isEncoding:!1,frameCount:0,recordingEnabled:!1,encodingProgress:0,error:null}),X=ee.useRef([]),ot=ee.useRef(null),mt=ee.useRef(null),[ct,gt]=ee.useState({visible:!1,x:0,y:0,data:null}),I=ee.useRef(new QS),it=ee.useRef(new Te);ee.useEffect(()=>{if(!o.current)return;const N=new zS;N.background=new xe(657930),i.current=N;const[_t,j]=sv.yRange,vt=j-_t,ft=.5,Pt=window.innerWidth*.75/window.innerHeight,C=vt+ft*2,E=C*Pt,V=new tv(-E/2,E/2,C/2,-C/2,.1,1e3);V.position.z=5,r.current=V;const Y=new O1({canvas:o.current,antialias:!0,alpha:!0,preserveDrawingBuffer:!0});Y.setSize(window.innerWidth*.75,window.innerHeight),Y.setPixelRatio(window.devicePixelRatio),t.current=Y,P1(N);const dt=()=>{const wt=window.innerWidth*.75/window.innerHeight,At=C*wt;V.left=-At/2,V.right=At/2,V.updateProjectionMatrix(),Y.setSize(window.innerWidth*.75,window.innerHeight)};window.addEventListener("resize",dt);const tt=()=>{l.current=requestAnimationFrame(tt),Y.render(N,V)};return tt(),()=>{window.removeEventListener("resize",dt),l.current&&cancelAnimationFrame(l.current),u.current&&cancelAnimationFrame(u.current),Y.dispose()}},[]),ee.useEffect(()=>{(async()=>{try{const _t=await My(()=>import("./henon_periodic_orbits-BGDblvTm.js"),[]);await _t.default(),y(_t),console.log("WASM module loaded successfully")}catch(_t){console.error("Failed to load WASM module:",_t)}})()},[]),ee.useEffect(()=>{T(p==="duffing"?N=>({...N,a:2.75,b:.2}):N=>({...N,a:.4,b:.3}))},[p]);const K=ee.useCallback((N,_t)=>{const j=v.a,vt=v.b,ft=-2*j*N,Pt=1,C=vt,E=0,V=ft+E,Y=ft*E-Pt*C;return{j11:ft,j12:Pt,j21:C,j22:E,trace:V,det:Y}},[v.a,v.b]),bt=ee.useCallback(N=>{if(!o.current||!i.current||!r.current)return;const _t=o.current.getBoundingClientRect();if(it.current.x=(N.clientX-_t.left)/_t.width*2-1,it.current.y=-((N.clientY-_t.top)/_t.height)*2+1,I.current.setFromCamera(it.current,r.current),w.showUlamOverlay&&w.gridBoxes.length>0){const ft=i.current.getObjectByName("ulam-grid");if(ft){const Pt=I.current.intersectObject(ft);if(Pt.length>0&&Pt[0].instanceId!==void 0){const C=Pt[0].instanceId,E=w.gridBoxes[C],V=w.invariantMeasure?w.invariantMeasure[C]:0,Y=w.invariantMeasure?Math.max(...w.invariantMeasure):1;let dt=0,tt=[];if(mt.current){const wt=mt.current.get_transitions(C);wt&&wt.length>0&&(dt=wt.length,tt=wt.sort((At,kt)=>kt.probability-At.probability).slice(0,3))}gt({visible:!0,x:N.clientX,y:N.clientY,data:{type:"Ulam Box",boxIndex:C,pos:{x:E.center[0],y:E.center[1]},measure:V,measurePercent:Y>0?V/Y*100:0,numTransitions:dt,topTransitions:tt,isCurrentBox:C===w.currentBoxIndex}});return}}}const j=[];i.current.traverse(ft=>{ft.isMesh&&(ft.userData.type==="orbit"||ft.userData.type==="fixedPoint")&&j.push(ft)});const vt=I.current.intersectObjects(j,!1);if(vt.length>0){const Pt=vt[0].object.userData,C=K(Pt.pos.x,Pt.pos.y);Pt.type==="orbit"&&Pt.orbitId&&(h==="periodic"&&b.showOrbitLines?M(E=>E.highlightedOrbitId!==Pt.orbitId?{...E,highlightedOrbitId:Pt.orbitId}:E):h==="manifold"&&g.showOrbitLines&&z(E=>E.highlightedOrbitId!==Pt.orbitId?{...E,highlightedOrbitId:Pt.orbitId}:E)),gt({visible:!0,x:N.clientX,y:N.clientY,data:{type:Pt.type==="fixedPoint"?"Fixed Point":"Periodic Point",period:Pt.period,stability:Pt.stability,pos:Pt.pos,eigenvalues:Pt.eigenvalues,jacobian:C,orbitSize:Pt.orbitPoints?.length||1}})}else gt(ft=>ft.visible?{...ft,visible:!1}:ft),h==="periodic"&&b.highlightedOrbitId!==null&&M(ft=>ft.highlightedOrbitId!==null?{...ft,highlightedOrbitId:null}:ft),h==="manifold"&&g.highlightedOrbitId!==null&&z(ft=>ft.highlightedOrbitId!==null?{...ft,highlightedOrbitId:null}:ft)},[K,w.showUlamOverlay,w.gridBoxes,w.invariantMeasure,w.currentBoxIndex,h,b.showOrbitLines,b.highlightedOrbitId,g.showOrbitLines,g.highlightedOrbitId]);ee.useEffect(()=>{!o.current||!i.current||!r.current||o.current.getBoundingClientRect()},[bt]);const O=ee.useCallback(N=>{if(!mt.current)return;const _t=mt.current.get_transitions(N);H(j=>({...j,selectedBoxIndex:N,transitions:_t}))},[]);ee.useEffect(()=>{const N=o.current;if(!N)return;const _t=j=>{if(!w.showUlamOverlay||!w.gridBoxes.length)return;const vt=N.getBoundingClientRect(),ft=(j.clientX-vt.left)/vt.width*2-1,Pt=-((j.clientY-vt.top)/vt.height)*2+1;I.current.setFromCamera(new Te(ft,Pt),r.current);const E=i.current.getObjectByName("ulam-grid");if(E){const V=I.current.intersectObject(E);if(V.length>0){const Y=V[0].instanceId;Y!==void 0&&O(Y)}else H(Y=>({...Y,selectedBoxIndex:null,transitions:null}))}};return N.addEventListener("mousemove",bt),N.addEventListener("click",_t),()=>{N.removeEventListener("mousemove",bt),N.removeEventListener("click",_t)}},[bt,w.showUlamOverlay,w.gridBoxes.length,O]),ee.useEffect(()=>{if(!x)return;let N=!1;return M(j=>({...j,isReady:!1,orbits:[],trajectoryPoints:[],iteration:0,hasStarted:!1,showOrbits:!1})),(()=>{try{if(N)return;const j=p==="duffing"?x.DuffingSystemWasm:x.HenonSystemWasm,vt=new j(v.a,v.b,v.maxPeriod);if(N){vt.free();return}const ft=vt.getPeriodicOrbits();vt.free(),M(Pt=>({...Pt,orbits:ft,isReady:!0,currentPoint:{x:v.startX,y:v.startY}}))}catch(j){console.error("Failed to compute periodic orbits:",j),M(vt=>({...vt,isReady:!0,orbits:[]}))}})(),()=>{N=!0}},[x,p,v.a,v.b,v.maxPeriod,v.startX,v.startY]),ee.useEffect(()=>{if(h==="manifold")return d.current&&clearTimeout(d.current),z(N=>({...N,isComputing:!0})),d.current=setTimeout(()=>{if(x)try{if(p==="duffing"){console.log("Computing Duffing manifold");const N=x.compute_duffing_manifold_simple(v.a,v.b,v.epsilon);z({manifolds:N.manifolds||[],fixedPoints:N.fixed_points||[],isComputing:!1,isReady:!0})}else if(b.orbits&&b.orbits.length>0){console.log("Using periodic orbits for manifold:",b.orbits.length,"orbits");const N=x.compute_manifold_from_orbits(v.a,v.b,v.epsilon,b.orbits);z({manifolds:N.manifolds||[],fixedPoints:N.fixed_points||[],isComputing:!1,isReady:!0})}else{console.log("No periodic orbits available, using simple computation");const N=x.compute_manifold_simple(v.a,v.b,v.epsilon);z({manifolds:N.manifolds||[],fixedPoints:N.fixed_points||[],isComputing:!1,isReady:!0})}}catch(N){console.error("Manifold computation error:",N),z(_t=>({..._t,isComputing:!1}))}},500),()=>{d.current&&clearTimeout(d.current)}},[h,p,v.a,v.b,v.epsilon,b.orbits,x]),ee.useEffect(()=>{if(!B.isAnimating||h!=="manifold"||g.isComputing)return;const{parameter:N,rangeValue:_t,direction:j,steps:vt,currentStep:ft,baseValue:Pt}=B;if(ft>=vt){J(Y=>({...Y,isAnimating:!1}));return}const C=_t/vt,E=ft+1,V=Pt+j*C*E;T(Y=>({...Y,[N]:parseFloat(V.toFixed(4))})),J(Y=>({...Y,currentStep:E}))},[B.isAnimating,B.currentStep,g.isComputing,h]);const rt=ee.useCallback(async()=>{const N=v[B.parameter],_t=N+B.direction*B.rangeValue;if(D.recordingEnabled&&o.current)try{const j=o.current,vt=1280,ft=720,Pt=new OffscreenCanvas(vt,ft),C=Pt.getContext("2d");C.drawImage(j,0,0,vt,ft);const E=`a = ${v.a.toFixed(4)}  b = ${v.b.toFixed(4)}  ε = ${v.epsilon.toFixed(4)}`;C.fillStyle="rgba(0, 0, 0, 0.7)",C.fillRect(10,ft-40,400,30),C.font="bold 16px monospace",C.fillStyle="#4CAF50",C.fillText(E,20,ft-18);const V=await createImageBitmap(Pt);X.current.push(V),U(Y=>({...Y,frameCount:1})),console.log("Initial frame captured")}catch(j){console.error("Initial frame capture error:",j)}J(j=>({...j,isAnimating:!0,baseValue:N,targetValue:_t,currentStep:0}))},[v,B.parameter,B.direction,B.rangeValue,D.recordingEnabled]),Tt=ee.useCallback(()=>{J(N=>({...N,isAnimating:!1,currentStep:0}))},[]),Ct=ee.useCallback(async()=>{if(!o.current||!D.recordingEnabled)return null;const N=o.current,_t=1280,j=720,vt=new OffscreenCanvas(_t,j),ft=vt.getContext("2d");ft.drawImage(N,0,0,_t,j);const Pt=`a = ${v.a.toFixed(4)}  b = ${v.b.toFixed(4)}  ε = ${v.epsilon.toFixed(4)}`;return ft.fillStyle="rgba(0, 0, 0, 0.7)",ft.fillRect(10,j-40,400,30),ft.font="bold 16px monospace",ft.fillStyle="#4CAF50",ft.fillText(Pt,20,j-18),await createImageBitmap(vt)},[v.a,v.b,v.epsilon,D.recordingEnabled]),zt=ee.useCallback(()=>{ot.current&&ot.current.terminate();const N=new Worker(new URL("/assets/videoEncoder.worker-7mA2J84V.js",import.meta.url),{type:"classic"});return N.onmessage=_t=>{const{type:j,blob:vt,frameCount:ft,error:Pt}=_t.data;switch(j){case"ready":console.log("Encoder ready");break;case"progress":U(Y=>({...Y,frameCount:ft}));break;case"complete":const C=URL.createObjectURL(vt),E=document.createElement("a"),V=qt();E.href=C,E.download=V,document.body.appendChild(E),E.click(),document.body.removeChild(E),URL.revokeObjectURL(C),U(Y=>({...Y,isEncoding:!1,isRecording:!1,recordingEnabled:!1})),X.current=[];break;case"error":console.error("Encoder error:",Pt),U(Y=>({...Y,error:Pt,isEncoding:!1}));break}},ot.current=N,N},[]),qt=ee.useCallback(()=>{const N=v.a.toFixed(3).replace(".","p"),_t=v.b.toFixed(3).replace(".","p"),j=v.epsilon.toFixed(4).replace(".","p"),vt=B.parameter,ft=(B.baseValue||0).toFixed(3).replace(".","p").replace("-","m"),Pt=(B.targetValue||0).toFixed(3).replace(".","p").replace("-","m");return`henon_${vt}_a${N}_b${_t}_eps${j}_${ft}_to_${Pt}.mp4`},[v.a,v.b,v.epsilon,B.parameter,B.baseValue,B.targetValue]),st=ee.useCallback(async()=>{if(!o.current||!t.current||!i.current||!r.current)return;t.current.render(i.current,r.current);const N=o.current,_t=1920,j=1080,vt=new OffscreenCanvas(_t,j),ft=vt.getContext("2d");if(ft.drawImage(N,0,0,_t,j),ft.fillStyle="rgba(0, 0, 0, 0.8)",ft.fillRect(10,j-80,500,70),ft.font="bold 18px monospace",ft.fillStyle="#4CAF50",h==="periodic")ft.fillText(`Periodic Orbits | Iteration: ${b.iteration}`,20,j-55),ft.font="14px monospace",ft.fillStyle="#aaa",ft.fillText(`Current: (${b.currentPoint.x.toFixed(6)}, ${b.currentPoint.y.toFixed(6)})`,20,j-32);else if(h==="manifold"){ft.fillText("Unstable Manifold",20,j-55),ft.font="14px monospace",ft.fillStyle="#aaa";const At=g.manifolds.reduce((kt,Xt)=>kt+(Xt.points_positive?.length||0)+(Xt.points_negative?.length||0),0);ft.fillText(`${g.fixedPoints.length} fixed points, ${At} manifold points`,20,j-32)}ft.font="bold 14px monospace",ft.fillStyle="#4CAF50",ft.fillText(`a = ${v.a.toFixed(4)}   b = ${v.b.toFixed(4)}   ε = ${v.epsilon.toFixed(4)}`,20,j-12);const Pt=await vt.convertToBlob({type:"image/png",quality:1}),C=URL.createObjectURL(Pt),E=document.createElement("a"),V=v.a.toFixed(3).replace(".","p"),Y=v.b.toFixed(3).replace(".","p"),dt=v.epsilon.toFixed(4).replace(".","p"),tt=h==="periodic"?"periodic":"manifold",wt=h==="periodic"?`_iter${b.iteration}`:"";E.href=C,E.download=`henon_${tt}_a${V}_b${Y}_eps${dt}${wt}.png`,document.body.appendChild(E),E.click(),document.body.removeChild(E),URL.revokeObjectURL(C)},[h,v,b.iteration,b.currentPoint,g.manifolds,g.fixedPoints]),St=ee.useCallback(async()=>{if(X.current.length===0){console.warn("No frames to encode");return}U(vt=>({...vt,isEncoding:!0,encodingProgress:0}));const N=zt();N.postMessage({type:"init",data:{width:1280,height:720,fps:2,filename:qt()}}),await new Promise(vt=>setTimeout(vt,100));const j=1e6/2;for(let vt=0;vt<X.current.length;vt++){const ft=X.current[vt];N.postMessage({type:"frame",data:{imageData:ft,timestamp:vt*j,duration:j}}),vt%5===0&&await new Promise(Pt=>setTimeout(Pt,10))}N.postMessage({type:"finish"})},[zt,qt]),Ot=ee.useRef(!1);ee.useEffect(()=>{const N=Ot.current,_t=g.isComputing;Ot.current=_t,!(!D.recordingEnabled||!B.isAnimating)&&N&&!_t&&(console.log(`[Recording] Manifold finished, capturing frame for step ${B.currentStep}...`),requestAnimationFrame(async()=>{try{const j=await Ct();j?(X.current.push(j),U(vt=>({...vt,frameCount:X.current.length})),console.log(`[Recording] Frame ${X.current.length} captured`)):console.log("[Recording] captureFrame returned null")}catch(j){console.error("[Recording] Frame capture error:",j)}}))},[g.isComputing,B.isAnimating,D.recordingEnabled,B.currentStep,Ct]),ee.useEffect(()=>{!B.isAnimating&&D.recordingEnabled&&X.current.length>0&&!D.isEncoding&&(console.log(`[Recording] Animation finished with ${X.current.length} frames, starting encoding...`),St())},[B.isAnimating,D.recordingEnabled,D.isEncoding,St]);const ne=ee.useCallback(()=>{D.recordingEnabled?(U(N=>({...N,recordingEnabled:!1})),X.current=[]):(U(N=>({...N,recordingEnabled:!0,frameCount:0,error:null})),X.current=[])},[D.recordingEnabled]);ee.useEffect(()=>{if(!i.current)return;const N=i.current,_t=[];if(N.traverse(j=>{(j.userData.type==="trajectory"||j.userData.type==="orbit"||j.userData.type==="orbitLine"||j.userData.type==="manifold"||j.userData.type==="fixedPoint")&&_t.push(j)}),_t.forEach(j=>{j.geometry&&j.geometry.dispose(),j.material&&j.material.dispose(),N.remove(j)}),h==="periodic"){if(b.showOrbits&&b.orbits.length>0){const j=b.orbits.filter(ft=>he(ft)),vt="#ff00ff";j.forEach((ft,Pt)=>{const C=`orbit-${ft.period}-${Pt}`,E=b.highlightedOrbitId===C,V=E?vt:Zt(ft);if(ft.points.forEach((Y,dt)=>{const tt=new _r(E?.06:.03,12,12),wt=new za({color:new xe(V)}),At=new Un(tt,wt);At.position.set(Y[0],Y[1],E?.15:.1),At.userData={type:"orbit",orbitId:C,period:ft.period,stability:ft.stability,pointIndex:dt,pos:{x:Y[0],y:Y[1]},orbitPoints:ft.points,eigenvalues:ft.eigenvalues||null},N.add(At)}),b.showOrbitLines&&ft.points.length>1){const Y=new Hn,dt=new Float32Array(ft.points.length*3);ft.points.forEach((Xt,Rt)=>{dt[Rt*3]=Xt[0],dt[Rt*3+1]=Xt[1],dt[Rt*3+2]=E?.15:.1}),Y.setAttribute("position",new Fn(dt,3));const tt=E?vt:Zt(ft),wt=E?1:.4,At=new Rs({color:new xe(tt),opacity:wt,transparent:!0,linewidth:E?3:1}),kt=new t0(Y,At);kt.userData={type:"orbitLine",orbitId:C},N.add(kt)}})}if(b.showTrail&&b.trajectoryPoints.length>0&&b.trajectoryPoints.forEach((j,vt)=>{const ft=vt/b.trajectoryPoints.length,Pt=.012*(.3+.7*ft),C=new _r(Pt,6,6),E=new za({color:new xe(Li.trajectory),opacity:.2+.6*ft,transparent:!0}),V=new Un(C,E);V.position.set(j.x,j.y,.05),V.userData.type="trajectory",N.add(V)}),b.hasStarted&&b.currentPoint){const j=new _r(.04,16,16),vt=new za({color:new xe("#ffffff")}),ft=new Un(j,vt);ft.position.set(b.currentPoint.x,b.currentPoint.y,.2),ft.userData.type="trajectory",N.add(ft)}}else if(g.manifolds.forEach(j=>{[j.plus,j.minus].forEach(vt=>{if(vt&&vt.points&&vt.points.length>1){const ft=new Hn,Pt=new Float32Array(vt.points.length*3);vt.points.forEach(([V,Y],dt)=>{Pt[dt*3]=V,Pt[dt*3+1]=Y,Pt[dt*3+2]=.1}),ft.setAttribute("position",new Fn(Pt,3));const C=new Rs({color:new xe(Li.manifold),linewidth:2}),E=new Yc(ft,C);E.userData.type="manifold",N.add(E)}})}),g.fixedPoints.forEach(j=>{const vt=(j.stability||"").toLowerCase(),ft=vt==="attractor"||vt==="stable",E=ft?Li.attractor:vt==="repeller"||vt==="unstable"||vt==="saddle"?Li.saddlePoint:Li.periodicBlue,V=ft?.03:.025,Y=new _r(V,12,12),dt=new za({color:new xe(E)}),tt=new Un(Y,dt);tt.position.set(j.x,j.y,.2),tt.userData={type:"fixedPoint",period:1,stability:j.stability,pos:{x:j.x,y:j.y},eigenvalues:j.eigenvalues||null},N.add(tt)}),g.showOrbits&&b.orbits.length>0){const j=b.orbits.filter(ft=>he(ft)),vt="#ff00ff";j.forEach((ft,Pt)=>{const C=`orbit-${ft.period}-${Pt}`,E=g.highlightedOrbitId===C,V=E?vt:Zt(ft);if(ft.points.forEach((Y,dt)=>{const tt=new _r(E?.04:.02,10,10),wt=new za({color:new xe(V)}),At=new Un(tt,wt);At.position.set(Y[0],Y[1],E?.15:.05),At.userData={type:"orbit",orbitId:C,period:ft.period,stability:ft.stability,pointIndex:dt,pos:{x:Y[0],y:Y[1]},orbitPoints:ft.points,eigenvalues:ft.eigenvalues||null},N.add(At)}),g.showOrbitLines&&ft.points.length>1){const Y=new Hn,dt=new Float32Array(ft.points.length*3);ft.points.forEach((Xt,Rt)=>{dt[Rt*3]=Xt[0],dt[Rt*3+1]=Xt[1],dt[Rt*3+2]=E?.15:.05}),Y.setAttribute("position",new Fn(dt,3));const tt=E?vt:Zt(ft),wt=E?1:.4,At=new Rs({color:new xe(tt),opacity:wt,transparent:!0,linewidth:E?3:1}),kt=new t0(Y,At);kt.userData={type:"orbitLine",orbitId:C},N.add(kt)}})}},[h,b,g,P]);const Zt=N=>{const{stability:_t}=N;return _t.toLowerCase()==="stable"?Li.attractor:_t.toLowerCase()==="saddle"?Li.saddlePoint:_t.toLowerCase()==="unstable"?Li.repeller:Li.periodicBlue},he=N=>N.period===1?P.period1:N.period===2?P.period2:N.period===3?P.period3:N.period===4?P.period4:N.period===5?P.period5:P.period6plus,Qe=ee.useCallback(()=>{if(!b.isReady||b.isRunning)return;const{x:N,y:_t}=b.currentPoint;if(!isFinite(N)||!isFinite(_t)||Math.abs(N)>10||Math.abs(_t)>10){M(ft=>({...ft,currentPoint:{x:v.startX,y:v.startY},trajectoryPoints:[],iteration:0,hasStarted:!1}));return}const vt=(p==="duffing"?w0:C0)(N,_t,v.a,v.b);M(ft=>({...ft,currentPoint:vt,trajectoryPoints:[...ft.trajectoryPoints,{x:N,y:_t}],iteration:ft.iteration+1,hasStarted:!0}))},[b.isReady,b.isRunning,b.currentPoint,v,p]),G=ee.useCallback(()=>{if(!b.isReady||b.isRunning)return;M(E=>({...E,isRunning:!0}));const N=p==="duffing"?w0:C0;let _t=b.currentPoint.x,j=b.currentPoint.y,vt=b.iteration;const ft=[...b.trajectoryPoints],Pt=5,C=()=>{for(let E=0;E<Pt&&vt<v.maxIterations;E++){if(!isFinite(_t)||!isFinite(j)||Math.abs(_t)>10||Math.abs(j)>10){M(Y=>({...Y,isRunning:!1,showOrbits:!0,hasStarted:!0,trajectoryPoints:ft,currentPoint:{x:_t,y:j},iteration:vt}));return}ft.push({x:_t,y:j});const V=N(_t,j,v.a,v.b);_t=V.x,j=V.y,vt++}M(E=>({...E,currentPoint:{x:_t,y:j},trajectoryPoints:[...ft],iteration:vt,hasStarted:!0})),vt<v.maxIterations?u.current=requestAnimationFrame(C):M(E=>({...E,isRunning:!1,showOrbits:!0}))};u.current=requestAnimationFrame(C)},[b,v,p]),Ne=ee.useCallback(()=>{u.current&&cancelAnimationFrame(u.current),M(N=>({...N,currentPoint:{x:v.startX,y:v.startY},trajectoryPoints:[],iteration:0,isRunning:!1,hasStarted:!1,showOrbits:!1}))},[v.startX,v.startY]),fe=ee.useMemo(()=>{let N=0;return g.manifolds.forEach(_t=>{_t.plus?.points&&(N+=_t.plus.points.length),_t.minus?.points&&(N+=_t.minus.points.length)}),N},[g.manifolds]),ae=ee.useCallback(async()=>{if(x){H(N=>({...N,isComputing:!0,needsRecompute:!1}));try{const{UlamComputer:N}=x;if(!N)throw console.error("UlamComputer export is missing from WASM module!"),new Error("UlamComputer definition missing");const _t=new N(v.a,v.b,w.subdivisions,w.pointsPerBox,w.epsilon);mt.current=_t;const j=_t.get_grid_boxes(),vt=_t.get_invariant_measure(),ft=_t.get_left_eigenvector();let Pt=-1;b.hasStarted&&b.currentPoint&&(Pt=_t.get_box_index(b.currentPoint.x,b.currentPoint.y)),H(C=>({...C,isComputing:!1,gridBoxes:j,invariantMeasure:vt,leftEigenvector:ft,currentBoxIndex:Pt,selectedBoxIndex:null,transitions:null}))}catch(N){console.error("Ulam computation failed:",N),H(_t=>({..._t,isComputing:!1}))}}},[x,v.a,v.b,w.subdivisions,w.pointsPerBox,w.epsilon,b.hasStarted,b.currentPoint]);return ee.useEffect(()=>{w.showUlamOverlay&&x&&w.gridBoxes.length===0&&!w.isComputing&&ae()},[w.showUlamOverlay,x,w.gridBoxes.length,w.isComputing,ae]),ee.useEffect(()=>{if(!(!mt.current||!w.showUlamOverlay)&&b.hasStarted&&b.currentPoint){const N=mt.current.get_box_index(b.currentPoint.x,b.currentPoint.y);if(N!==w.currentBoxIndex){const _t=N>=0?mt.current.get_transitions(N):null;H(j=>({...j,currentBoxIndex:N,transitions:j.showCurrentBox?_t:j.transitions,selectedBoxIndex:j.showCurrentBox?N:j.selectedBoxIndex}))}}},[b.currentPoint,b.hasStarted,w.showUlamOverlay,w.currentBoxIndex]),ee.useEffect(()=>{const N=i.current;if(!N)return;const _t=()=>{const tt=N.getObjectByName("ulam-grid");tt&&(tt.geometry.dispose(),tt.material.dispose(),N.remove(tt))};if(!w.showUlamOverlay||!w.gridBoxes.length){_t();return}_t();const j=w.gridBoxes,vt=j.length,ft=new $o(1,1),Pt=new za({color:16777215,transparent:!0,opacity:.5,side:Oi,depthWrite:!1}),C=new kS(ft,Pt,vt);C.name="ulam-grid",C.userData.type="ulamGrid";const E=new Nn,V=new xe,Y=new Map;w.selectedBoxIndex!==null&&w.transitions&&w.transitions.forEach(tt=>{Y.set(tt.index,tt.probability)});let dt=0;return w.invariantMeasure&&(dt=Math.max(...w.invariantMeasure)),j.forEach((tt,wt)=>{const At=tt.center[0],kt=tt.center[1],Xt=tt.radius[0],Rt=tt.radius[1];E.position.set(At,kt,-.05),E.scale.set(Xt*2*.95,Rt*2*.95,1),E.updateMatrix(),C.setMatrixAt(wt,E.matrix);const Ft=w.showCurrentBox&&wt===w.currentBoxIndex,$t=w.selectedBoxIndex!==null&&wt===w.selectedBoxIndex;if(Ft&&!$t)V.setHex(16711935),C.setColorAt(wt,V);else if(w.selectedBoxIndex!==null)if(wt===w.selectedBoxIndex)V.setHex(65535),C.setColorAt(wt,V);else if(Y.has(wt)){const Yt=Y.get(wt);V.setHSL(.7-Yt*.7,1,.5),C.setColorAt(wt,V)}else V.setHex(2236962),C.setColorAt(wt,V);else if(w.invariantMeasure&&w.invariantMeasure.length===vt){const Yt=w.invariantMeasure[wt];if(Yt>0){const de=.66-Yt/dt*.5;V.setHSL(de,1,.5),C.setColorAt(wt,V)}else V.setHex(1118481),C.setColorAt(wt,V)}else V.setHex(3355443),C.setColorAt(wt,V)}),C.instanceMatrix.needsUpdate=!0,C.instanceColor&&(C.instanceColor.needsUpdate=!0),N.add(C),_t},[w.showUlamOverlay,w.gridBoxes,w.selectedBoxIndex,w.transitions,w.invariantMeasure,w.currentBoxIndex,w.showCurrentBox]),ee.useEffect(()=>{if(!i.current)return;const N=i.current,_t=[];N.traverse(j=>{h!=="periodic"&&(j.userData.type==="orbit"||j.userData.type==="trajectory"||j.userData.type==="orbitLine")&&_t.push(j),h!=="manifold"&&(j.userData.type==="manifold"||j.userData.type==="fixedPoint")&&_t.push(j),h!=="ulam"&&j.userData.type}),_t.forEach(j=>{j.geometry&&j.geometry.dispose(),j.material&&j.material.dispose(),N.remove(j)})},[h]),k.jsxs("div",{style:Lt.container,children:[k.jsxs("div",{style:Lt.sidebar,children:[k.jsxs("div",{style:Lt.section,children:[k.jsx("h3",{style:Lt.sectionTitle,children:"Mode"}),k.jsxs("div",{style:Lt.toggleContainer,children:[k.jsx("button",{onClick:()=>m("periodic"),style:{...Lt.toggleButton,...h==="periodic"?Lt.toggleActive:{}},children:"Periodic Orbits"}),k.jsx("button",{onClick:()=>m("manifold"),style:{...Lt.toggleButton,...h==="manifold"?Lt.toggleActive:{}},children:"Unstable Manifold"})]})]}),k.jsxs("div",{style:Lt.section,children:[k.jsx("h3",{style:Lt.sectionTitle,children:"Dynamic System"}),k.jsxs("select",{value:p,onChange:N=>_(N.target.value),style:{width:"100%",padding:"8px 12px",backgroundColor:"#2d2d2d",color:"#fff",border:"1px solid #444",borderRadius:"6px",fontSize:"14px",cursor:"pointer"},disabled:b.isRunning||B.isAnimating,children:[k.jsx("option",{value:"henon",children:"Hénon Map"}),k.jsx("option",{value:"duffing",children:"Duffing Map"})]}),k.jsx("div",{style:{fontSize:"11px",color:"#666",marginTop:"4px"},children:p==="henon"?"x' = 1 - ax² + y, y' = bx":"x' = y, y' = -bx + ay - y³"})]}),k.jsxs("div",{style:Lt.section,children:[k.jsx("h3",{style:Lt.sectionTitle,children:"System Parameters"}),k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"a ="}),k.jsx("input",{type:"number",step:"0.01",value:v.a,onChange:N=>T({...v,a:parseFloat(N.target.value)||.1}),style:Lt.numberInput,disabled:b.isRunning})]}),k.jsx("input",{type:"range",min:"0.1",max:p==="duffing"?3:2,step:"0.01",value:v.a,onChange:N=>T({...v,a:parseFloat(N.target.value)}),style:Lt.slider,disabled:b.isRunning})]}),k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"b ="}),k.jsx("input",{type:"number",step:"0.01",value:v.b,onChange:N=>T({...v,b:parseFloat(N.target.value)||.1}),style:Lt.numberInput,disabled:b.isRunning})]}),k.jsx("input",{type:"range",min:"0.1",max:"0.5",step:"0.01",value:v.b,onChange:N=>T({...v,b:parseFloat(N.target.value)}),style:Lt.slider,disabled:b.isRunning})]}),h==="periodic"&&k.jsxs(k.Fragment,{children:[k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"Max Period ="}),k.jsx("input",{type:"number",step:"1",min:"1",max:"20",value:v.maxPeriod,onChange:N=>T({...v,maxPeriod:parseInt(N.target.value)||2}),style:Lt.numberInput,disabled:b.isRunning})]}),k.jsx("input",{type:"range",min:"2",max:"10",step:"1",value:v.maxPeriod,onChange:N=>T({...v,maxPeriod:parseInt(N.target.value)}),style:Lt.slider,disabled:b.isRunning})]}),k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"Max Iterations ="}),k.jsx("input",{type:"number",step:"100",min:"100",max:"10000",value:v.maxIterations,onChange:N=>T({...v,maxIterations:parseInt(N.target.value)||100}),style:Lt.numberInput,disabled:b.isRunning})]}),k.jsx("input",{type:"range",min:"100",max:"5000",step:"100",value:v.maxIterations,onChange:N=>T({...v,maxIterations:parseInt(N.target.value)}),style:Lt.slider,disabled:b.isRunning})]})]}),h==="manifold"&&k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"epsilon ="}),k.jsx("input",{type:"number",step:"0.001",value:v.epsilon,onChange:N=>T({...v,epsilon:parseFloat(N.target.value)||.01}),style:Lt.numberInput})]}),k.jsx("input",{type:"range",min:"0.001",max:"0.2",step:"0.001",value:v.epsilon,onChange:N=>T({...v,epsilon:parseFloat(N.target.value)}),style:Lt.slider})]})]}),k.jsx("button",{onClick:st,style:{...Lt.button,width:"100%",marginTop:"12px",backgroundColor:"#2d4a2d",borderColor:"#3a6a3a",display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},children:"Save as PNG"}),h==="manifold"&&k.jsxs("div",{style:{marginTop:"16px",borderTop:"1px solid #333",paddingTop:"16px"},children:[k.jsx("h4",{style:{fontSize:"12px",fontWeight:"600",marginBottom:"12px",color:"#888"},children:"Parameter Animation"}),k.jsx("label",{style:Lt.label,children:k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"Animate:"}),k.jsxs("select",{value:B.parameter,onChange:N=>J(_t=>({..._t,parameter:N.target.value})),style:{...Lt.numberInput,width:"100px"},disabled:B.isAnimating,children:[k.jsx("option",{value:"a",children:"a"}),k.jsx("option",{value:"b",children:"b"}),k.jsx("option",{value:"epsilon",children:"epsilon"})]})]})}),k.jsx("label",{style:Lt.label,children:k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"Direction:"}),k.jsxs("div",{style:{display:"flex",gap:"4px"},children:[k.jsx("button",{onClick:()=>J(N=>({...N,direction:-1})),style:{...Lt.button,width:"40px",padding:"4px",marginBottom:0,backgroundColor:B.direction===-1?"#3d5afe":"#2d2d2d"},disabled:B.isAnimating,children:"−"}),k.jsx("button",{onClick:()=>J(N=>({...N,direction:1})),style:{...Lt.button,width:"40px",padding:"4px",marginBottom:0,backgroundColor:B.direction===1?"#3d5afe":"#2d2d2d"},disabled:B.isAnimating,children:"+"})]})]})}),k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"Range:"}),k.jsx("input",{type:"number",step:"0.05",min:"0.01",max:"1.0",value:B.rangeValue,onChange:N=>J(_t=>({..._t,rangeValue:parseFloat(N.target.value)||.1})),style:Lt.numberInput,disabled:B.isAnimating})]}),k.jsx("input",{type:"range",min:"0.01",max:"0.5",step:"0.01",value:B.rangeValue,onChange:N=>J(_t=>({..._t,rangeValue:parseFloat(N.target.value)})),style:Lt.slider,disabled:B.isAnimating})]}),k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"Steps:"}),k.jsx("input",{type:"number",step:"1",min:"5",max:"30",value:B.steps,onChange:N=>J(_t=>({..._t,steps:parseInt(N.target.value)||10})),style:Lt.numberInput,disabled:B.isAnimating})]}),k.jsx("input",{type:"range",min:"5",max:"30",step:"1",value:B.steps,onChange:N=>J(_t=>({..._t,steps:parseInt(N.target.value)})),style:Lt.slider,disabled:B.isAnimating})]}),k.jsxs("div",{style:{display:"flex",gap:"8px",marginTop:"8px"},children:[k.jsxs("button",{onClick:B.isAnimating?Tt:rt,disabled:g.isComputing&&!B.isAnimating||D.isEncoding,style:{...Lt.button,flex:1,marginBottom:0,backgroundColor:B.isAnimating?"#8b0000":"#1a4a1a",borderColor:B.isAnimating?"#b22222":"#2a6a2a"},children:[B.isAnimating?"⏹ Stop":"▶ Play",D.recordingEnabled&&!B.isAnimating&&" & Rec"]}),k.jsx("button",{onClick:ne,disabled:B.isAnimating||D.isEncoding,style:{...Lt.button,width:"50px",marginBottom:0,backgroundColor:D.recordingEnabled?"#b22222":"#2d2d2d",borderColor:D.recordingEnabled?"#ff4444":"#444"},title:D.recordingEnabled?"Recording enabled - will record next animation":"Enable recording",children:D.recordingEnabled?"🔴":"⏺"})]}),D.recordingEnabled&&!B.isAnimating&&!D.isEncoding&&k.jsx("div",{style:{marginTop:"8px",padding:"6px",background:"#1a0a0a",borderRadius:"4px",border:"1px solid #b22222"},children:k.jsx("div",{style:{fontSize:"11px",color:"#ff6666"},children:"🔴 Recording armed - Press Play to start"})}),D.isEncoding&&k.jsxs("div",{style:{marginTop:"8px",padding:"8px",background:"#0a0a1a",borderRadius:"4px",border:"1px solid #3d5afe"},children:[k.jsxs("div",{style:{fontSize:"11px",color:"#7986cb",marginBottom:"4px"},children:["🔄 Encoding video... (",D.frameCount," frames)"]}),k.jsx("div",{style:{height:"4px",backgroundColor:"#1a1a2e",borderRadius:"2px",overflow:"hidden"},children:k.jsx("div",{style:{width:"100%",height:"100%",backgroundColor:"#3d5afe",animation:"pulse 1s infinite"}})})]}),D.error&&k.jsxs("div",{style:{marginTop:"8px",padding:"6px",background:"#1a0a0a",borderRadius:"4px",fontSize:"10px",color:"#ff6666"},children:["Error: ",D.error]}),B.isAnimating&&k.jsxs("div",{style:{marginTop:"8px",padding:"8px",background:"#0f0f0f",borderRadius:"4px"},children:[k.jsxs("div",{style:{fontSize:"11px",color:"#888",marginBottom:"4px"},children:[B.parameter,": ",B.baseValue?.toFixed(3)," → ",B.targetValue?.toFixed(3)]}),k.jsxs("div",{style:{fontSize:"11px",color:"#888"},children:["Current: ",k.jsx("span",{style:{color:"#4CAF50",fontWeight:"bold"},children:v[B.parameter].toFixed(4)}),D.recordingEnabled&&k.jsxs("span",{style:{color:"#ff6666",marginLeft:"8px"},children:["📹 ",D.frameCount," frames"]})]}),k.jsxs("div",{style:{fontSize:"10px",color:"#555",marginTop:"4px"},children:["Step ",B.currentStep," / ",B.steps,g.isComputing&&k.jsx("span",{style:{color:"#ff9800",marginLeft:"8px"},children:"Computing..."})]}),k.jsx("div",{style:{marginTop:"6px",height:"4px",backgroundColor:"#333",borderRadius:"2px",overflow:"hidden"},children:k.jsx("div",{style:{width:`${B.currentStep/B.steps*100}%`,height:"100%",backgroundColor:D.recordingEnabled?"#ff6666":"#4CAF50",transition:"width 0.3s ease"}})})]})]}),k.jsxs("div",{style:{marginTop:"16px",borderTop:"1px solid #333",paddingTop:"16px"},children:[k.jsxs("label",{style:Lt.checkboxLabel,children:[k.jsx("input",{type:"checkbox",checked:w.showUlamOverlay,onChange:N=>H({...w,showUlamOverlay:N.target.checked})}),"Show Ulam Grid"]}),w.showUlamOverlay&&k.jsxs(k.Fragment,{children:[k.jsxs("label",{style:Lt.checkboxLabel,children:[k.jsx("input",{type:"checkbox",checked:w.showTransitions,onChange:N=>H({...w,showTransitions:N.target.checked})}),"Show Transitions"]}),h==="periodic"&&k.jsxs("label",{style:Lt.checkboxLabel,children:[k.jsx("input",{type:"checkbox",checked:w.showCurrentBox,onChange:N=>H({...w,showCurrentBox:N.target.checked})}),"Track Current Position"]}),k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"Epsilon (ε) ="}),k.jsx("input",{type:"number",step:"0.01",min:"0.001",max:"0.5",value:w.epsilon,onChange:N=>H({...w,epsilon:parseFloat(N.target.value)||.05}),style:Lt.numberInput,disabled:w.isComputing})]}),k.jsx("input",{type:"range",min:"0.01",max:"0.3",step:"0.01",value:w.epsilon,onChange:N=>H({...w,epsilon:parseFloat(N.target.value)}),style:Lt.slider,disabled:w.isComputing}),k.jsx("span",{style:{fontSize:"10px",color:"#666"},children:"Ball radius for boundary detection"})]}),k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"Grid ="}),k.jsx("input",{type:"number",step:"1",min:"10",max:"80",value:w.subdivisions,onChange:N=>H({...w,subdivisions:parseInt(N.target.value)||10}),style:Lt.numberInput,disabled:w.isComputing})]}),k.jsx("input",{type:"range",min:"10",max:"60",step:"5",value:w.subdivisions,onChange:N=>H({...w,subdivisions:parseInt(N.target.value)}),style:Lt.slider,disabled:w.isComputing})]}),k.jsxs("label",{style:Lt.label,children:[k.jsxs("div",{style:Lt.paramRow,children:[k.jsx("span",{children:"Samples ="}),k.jsx("input",{type:"number",step:"16",min:"16",max:"256",value:w.pointsPerBox,onChange:N=>H({...w,pointsPerBox:parseInt(N.target.value)||64}),style:Lt.numberInput,disabled:w.isComputing})]}),k.jsx("input",{type:"range",min:"16",max:"256",step:"16",value:w.pointsPerBox,onChange:N=>H({...w,pointsPerBox:parseInt(N.target.value)}),style:Lt.slider,disabled:w.isComputing}),k.jsx("span",{style:{fontSize:"10px",color:"#666"},children:"Points per box (√n × √n grid)"})]}),k.jsx("button",{onClick:ae,disabled:w.isComputing,style:Lt.button,children:w.isComputing?"Computing...":"Recompute Ulam Grid"}),w.gridBoxes.length>0&&k.jsxs("div",{style:{marginTop:"12px",padding:"8px",background:"#0f0f0f",borderRadius:"4px"},children:[k.jsx("div",{style:{fontSize:"11px",fontWeight:"600",color:"#888",marginBottom:"6px"},children:"Invariant Measure"}),k.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"6px"},children:[k.jsx("span",{style:{fontSize:"10px",color:"#666"},children:"Low"}),k.jsx("div",{style:{flex:1,height:"12px",borderRadius:"2px",background:"linear-gradient(to right, hsl(238, 100%, 50%), hsl(180, 100%, 50%), hsl(100, 100%, 50%), hsl(60, 100%, 50%))"}}),k.jsx("span",{style:{fontSize:"10px",color:"#666"},children:"High"})]}),k.jsx("div",{style:{fontSize:"9px",color:"#555",marginTop:"4px"},children:"Probability of trajectory visiting each region"})]}),w.currentBoxIndex>=0&&k.jsxs("div",{style:{fontSize:"11px",color:"#888",marginTop:"4px"},children:["Current box: ",w.currentBoxIndex]})]})]}),h==="periodic"&&k.jsxs(k.Fragment,{children:[k.jsxs("div",{style:Lt.section,children:[k.jsx("h3",{style:Lt.sectionTitle,children:"Controls"}),k.jsx("button",{onClick:Qe,disabled:!b.isReady||b.isRunning,style:Lt.button,children:"Step Forward"}),k.jsx("button",{onClick:G,disabled:!b.isReady||b.isRunning,style:{...Lt.button,...Lt.runButton},children:b.isRunning?"Running...":"Run to Max Iterations"}),k.jsx("button",{onClick:Ne,disabled:b.isRunning,style:{...Lt.button,...Lt.resetButton},children:"Reset"})]}),k.jsxs("div",{style:Lt.section,children:[k.jsx("h3",{style:Lt.sectionTitle,children:"Periodic Orbits"}),[1,2,3,4,5].map(N=>k.jsxs("label",{style:Lt.checkboxLabel,children:[k.jsx("input",{type:"checkbox",checked:P[`period${N}`],onChange:_t=>L({...P,[`period${N}`]:_t.target.checked})}),k.jsx("span",{style:{...Lt.colorBox,backgroundColor:Li[`period${N}`].stable}}),"Period-",N," (",b.orbits.filter(_t=>_t.period===N).length,")"]},N)),k.jsxs("label",{style:Lt.checkboxLabel,children:[k.jsx("input",{type:"checkbox",checked:b.showOrbits,onChange:N=>M({...b,showOrbits:N.target.checked})}),"Show orbit markers"]}),k.jsxs("label",{style:Lt.checkboxLabel,children:[k.jsx("input",{type:"checkbox",checked:b.showTrail,onChange:N=>M({...b,showTrail:N.target.checked})}),"Show trajectory trail"]}),k.jsxs("label",{style:Lt.checkboxLabel,children:[k.jsx("input",{type:"checkbox",checked:b.showOrbitLines,onChange:N=>M({...b,showOrbitLines:N.target.checked})}),"Show orbit lines"]})]})]}),h==="manifold"&&k.jsxs(k.Fragment,{children:[k.jsxs("div",{style:Lt.section,children:[k.jsx("h3",{style:Lt.sectionTitle,children:"Periodic Orbits"}),k.jsxs("label",{style:Lt.checkboxLabel,children:[k.jsx("input",{type:"checkbox",checked:g.showOrbits,onChange:N=>z({...g,showOrbits:N.target.checked})}),"Show orbit markers"]}),k.jsxs("label",{style:Lt.checkboxLabel,children:[k.jsx("input",{type:"checkbox",checked:g.showOrbitLines,onChange:N=>z({...g,showOrbitLines:N.target.checked})}),"Show orbit lines"]})]}),g.fixedPoints.length>0&&k.jsxs("div",{style:Lt.section,children:[k.jsxs("h3",{style:Lt.sectionTitle,children:["Fixed Points (",g.fixedPoints.length,")"]}),g.fixedPoints.map((N,_t)=>k.jsxs("div",{style:Lt.fixedPointItem,children:[k.jsx("span",{style:{fontWeight:"bold",color:N.stability==="Attractor"?"#00ff00":N.stability==="Repeller"?"#ff4444":"#ffaa00"},children:N.stability}),k.jsxs("span",{children:[" (",N.x.toFixed(3),", ",N.y.toFixed(3),")"]})]},_t))]})]}),k.jsxs("div",{style:Lt.info,children:[k.jsx("div",{style:Lt.infoHeader,children:p==="henon"?"Hénon Map: x' = 1 - ax² + y, y' = bx":"Duffing Map: x' = y, y' = -bx + ay - y³"}),h==="periodic"?k.jsxs(k.Fragment,{children:[k.jsxs("div",{children:["Status: ",b.isReady?b.isRunning?"Running...":"Ready":"Loading..."]}),k.jsxs("div",{children:["Iteration: ",b.iteration," / ",v.maxIterations]}),b.hasStarted&&k.jsxs("div",{children:["Position: (",b.currentPoint.x.toFixed(4),", ",b.currentPoint.y.toFixed(4),")"]}),k.jsxs("div",{children:["Orbits found: ",b.orbits.length]})]}):k.jsxs(k.Fragment,{children:[k.jsxs("div",{children:["Status: ",g.isComputing?"Computing...":"Ready"]}),k.jsxs("div",{children:["Manifolds: ",g.manifolds.length]}),k.jsxs("div",{children:["Total Points: ",fe.toLocaleString()]})]})]})]}),k.jsxs("div",{style:Lt.viewport,children:[k.jsx("canvas",{ref:o,style:Lt.canvas}),ct.visible&&ct.data&&k.jsxs("div",{style:{position:"absolute",left:ct.x+15,top:ct.y+15,backgroundColor:"rgba(20, 20, 20, 0.95)",border:"1px solid #444",borderRadius:"4px",padding:"12px",zIndex:1e3,pointerEvents:"none",minWidth:"180px",maxWidth:"280px",boxShadow:"0 4px 12px rgba(0,0,0,0.5)",fontSize:"12px",fontFamily:"monospace"},children:[k.jsxs("div",{style:{fontWeight:"bold",color:"#fff",marginBottom:"8px",borderBottom:"1px solid #444",paddingBottom:"4px"},children:[ct.data.type,ct.data.isCurrentBox&&k.jsx("span",{style:{color:"#ff00ff",marginLeft:"8px"},children:"● Current"})]}),ct.data.type==="Ulam Box"?k.jsxs("div",{style:{display:"grid",gridTemplateColumns:"auto 1fr",gap:"6px 12px"},children:[k.jsx("span",{style:{color:"#888"},children:"Box #:"}),k.jsx("span",{style:{color:"#00ccff"},children:ct.data.boxIndex}),k.jsx("span",{style:{color:"#888"},children:"Center:"}),k.jsxs("span",{style:{color:"#ddd"},children:["(",ct.data.pos.x.toFixed(2),", ",ct.data.pos.y.toFixed(2),")"]}),k.jsx("span",{style:{color:"#888"},children:"Measure:"}),k.jsxs("span",{style:{color:"#4CAF50"},children:[(ct.data.measure*100).toFixed(2),"%",k.jsxs("span",{style:{color:"#666",marginLeft:"4px"},children:["(",ct.data.measurePercent.toFixed(0),"% of max)"]})]}),k.jsx("span",{style:{color:"#888"},children:"Transitions:"}),k.jsxs("span",{style:{color:"#ddd"},children:[ct.data.numTransitions," boxes"]}),ct.data.topTransitions&&ct.data.topTransitions.length>0&&k.jsxs(k.Fragment,{children:[k.jsx("span",{style:{color:"#888"},children:"Top targets:"}),k.jsx("div",{style:{fontSize:"10px"},children:ct.data.topTransitions.map((N,_t)=>k.jsxs("div",{style:{color:"#ff9800"},children:["→ Box ",N.index,": ",(N.probability*100).toFixed(1),"%"]},_t))})]})]}):k.jsxs("div",{style:{display:"grid",gridTemplateColumns:"auto 1fr",gap:"8px 16px"},children:[k.jsx("span",{style:{color:"#888"},children:"Position:"}),k.jsxs("span",{style:{color:"#00ccff"},children:["(",ct.data.pos.x.toFixed(4),", ",ct.data.pos.y.toFixed(4),")"]}),k.jsx("span",{style:{color:"#888"},children:"Stability:"}),k.jsx("span",{style:{color:ct.data.stability?.toLowerCase()==="attractor"||ct.data.stability?.toLowerCase()==="stable"?"#27ae60":(ct.data.stability?.toLowerCase()==="repeller"||ct.data.stability?.toLowerCase()==="unstable","#e74c3c")},children:ct.data.stability||"Unknown"}),k.jsx("span",{style:{color:"#888"},children:"Period:"}),k.jsx("span",{style:{color:"#ddd"},children:ct.data.period}),ct.data.jacobian&&k.jsxs(k.Fragment,{children:[k.jsx("span",{style:{color:"#888"},children:"Jacobian:"}),k.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"4px",background:"#333",padding:"4px",borderRadius:"2px"},children:[k.jsx("span",{children:ct.data.jacobian.j11?.toFixed(3)}),k.jsx("span",{children:ct.data.jacobian.j12?.toFixed(3)}),k.jsx("span",{children:ct.data.jacobian.j21?.toFixed(3)}),k.jsx("span",{children:ct.data.jacobian.j22?.toFixed(3)})]}),k.jsx("span",{style:{color:"#888"},children:"Det/Trace:"}),k.jsxs("span",{style:{color:"#ddd"},children:["D=",ct.data.jacobian.det?.toFixed(3),", Tr=",ct.data.jacobian.trace?.toFixed(3)]})]})]})]})]})]})},Lt={container:{display:"flex",height:"100vh",width:"100vw",backgroundColor:"#0a0a0a",fontFamily:"system-ui, -apple-system, sans-serif",color:"#e0e0e0",overflow:"hidden"},sidebar:{width:"320px",minWidth:"320px",padding:"20px",backgroundColor:"#1a1a1a",borderRight:"1px solid #333",overflowY:"auto"},section:{marginBottom:"24px"},sectionTitle:{fontSize:"14px",fontWeight:"600",marginBottom:"12px",color:"#fff",textTransform:"uppercase",letterSpacing:"0.5px"},toggleContainer:{display:"flex",gap:"4px"},toggleButton:{flex:1,padding:"10px",backgroundColor:"#2d2d2d",color:"#888",border:"1px solid #444",borderRadius:"4px",cursor:"pointer",fontSize:"12px",fontWeight:"500",transition:"all 0.2s"},toggleActive:{backgroundColor:"#3d5afe",color:"#fff",borderColor:"#3d5afe"},label:{display:"flex",flexDirection:"column",marginBottom:"12px",fontSize:"13px",color:"#b0b0b0"},paramRow:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"4px"},numberInput:{width:"80px",padding:"4px 8px",backgroundColor:"#2d2d2d",color:"#fff",border:"1px solid #444",borderRadius:"4px",fontSize:"13px",textAlign:"right"},slider:{marginTop:"6px",width:"100%"},checkboxLabel:{display:"flex",alignItems:"center",marginBottom:"10px",fontSize:"13px",cursor:"pointer",gap:"8px"},colorBox:{width:"14px",height:"14px",borderRadius:"2px",display:"inline-block"},button:{width:"100%",padding:"10px",marginBottom:"8px",backgroundColor:"#2d2d2d",color:"#fff",border:"1px solid #444",borderRadius:"4px",cursor:"pointer",fontSize:"13px",fontWeight:"500",transition:"all 0.2s"},runButton:{backgroundColor:"#1a4a1a",borderColor:"#2a6a2a"},resetButton:{backgroundColor:"#1a1a1a",borderColor:"#555"},fixedPointItem:{marginBottom:"6px",fontSize:"12px",padding:"6px",background:"#0f0f0f",borderRadius:"4px"},info:{marginTop:"16px",padding:"12px",backgroundColor:"#0f0f0f",borderRadius:"4px",fontSize:"11px",lineHeight:"1.6",color:"#888"},infoHeader:{fontSize:"12px",fontWeight:"600",color:"#4CAF50",marginBottom:"8px"},viewport:{flex:1,display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden"},canvas:{display:"block"}};xy.createRoot(document.getElementById("root")).render(k.jsx(ee.StrictMode,{children:k.jsx(B1,{})}));
